...
const peekOptions: PeekOptions = {
  ...
  co2emissionsMobility: o("MioTons", true),
  ...
  publicTransportPassengerKm: o("MioKm", false),
  publicTransportTrainPassengerKm: o("MioKm", true),
  publicTransportBusPassengerKm: o("MioKm", true),
  publicTransportMetroPassengerKm: o("MioKm", true),
  ...
  flightsPassengersDomestic: o("TsdPeople", true),
  flightsPassengersNonDomestic: o("TsdPeople", true),
