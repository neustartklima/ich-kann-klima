...
const peekOptions: PeekOptions = {
  ...
  shortdistanceTransportUsage: o("MioPsgrKm", true),
  shortdistanceTransportCapacity: o("MioPsgrKm", true),
  longdistanceTransportUsage: o("MioPsgrKm", true),
  longdistanceTransportCapacity: o("MioPsgrKm", true),
  flightsDomesticUsage: o("MioPsgrKm", true),
  flightsIntlUsage: o("MioPsgrKm", true),
  passengerTransportUsage: o("MioPsgrKm", false),
  publicTransportUsage: o("MioRides", true),
  publicTransportRidesPerCitizen: o("count", true),
  publicTransportRevenue: o("MrdEuro", true),
  publicTransportSubventions: o("MrdEuro", true),
  publicTransportInvestmentsPerCitizen: o("Euro", true),
  flightsDomesticPassengers: o("TsdPeople", true),
  flightsIntlPassengers: o("TsdPeople", true),
  flightsCargo: o("MioTons", true),
