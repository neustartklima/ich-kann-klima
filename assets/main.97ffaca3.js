...
Anfangswert ist die deutsche Staatsverschuldung 2019.
  ...
  `}}),jt={currentYear:2021,values:dt,acceptedLaws:[],proposedLaws:[],rejectedLaws:[]};function $t(e=jt,t=u()){return{id:t,currentYear:e.currentYear,acceptedLaws:e.acceptedLaws,proposedLaws:e.proposedLaws,rejectedLaws:e.rejectedLaws,values:ht(e.values),events:[],over:!1}}function Jt(e,t=Gt,i=Ht,n=Math.random){const r=function(e,t){for(const i of e)if((t-=i.prob)<0)return i;return}(function(e,t){const i=t.map((t=>o(l({},t),{prob:t.probability(e)}))).filter((e=>e.prob&&e.prob>0)),n=i.map((e=>e.prob)).reduce(((e,t)=>e+t),0)+.3;return i.map((e=>o(l({},e),{prob:e.prob/n})))}(e,i),n());r&&e.events.unshift(r);const a=function(e,t,i){const n=t=>{var i;return null==(i=e.acceptedLaws)?void 0:i.some((e=>e.lawId===t.id))},r=t=>{var i;return null==(i=e.rejectedLaws)?void 0:i.includes(t.id)},a=e=>{var t;return(null==(t=e.labels)?void 0:t.includes("hidden"))||!1},s=t=>({law:t,priority:t.priority(e)}),l=e=>({law:e.law,priority:e.priority+(i.includes(e.law.id)?100:0)});return t.filter(me(n)).filter(me(r)).filter(me(a)).map(s).filter((e=>e.priority>0)).map(l).sort(((e,t)=>t.priority-e.priority)).map((e=>e.law.id)).slice(0,6)}(e,t,(null==r?void 0:r.laws)?r.laws:[]);return e.proposedLaws=function(e,t){const i=[...e],n=t.filter((e=>i.includes(e))),r=t.filter((e=>!n.includes(e)));var a=0;for(;a<i.length;)n.includes(i[a])?a++:0!==r.length?(i[a]=r.shift(),a++):i.splice(a,1);return i.push(...r.slice(0,6-i.length)),i}(e.proposedLaws,a),r}function Zt(e){return Math.max(0,Math.min(100,e))}var Rt=d({props:{law:{type:Object,required:!0},selectable:{type:Boolean,required:!0},numCards:{type:Number,required:!0}},setup:()=>({store:Vn()}),data:()=>({accepted:!1}),computed:o(l({},h(["proposedLaws"])),{zIndex(){return this.law.zIndex},transform(){return`rotate(${2*(this.law.pos-this.numCards/2)}deg) translate(${20*Math.abs(this.numCards/2-this.law.pos)}px, -50%)`}}),methods:{select(){this.$emit("selected")},accept(){this.accepted=!0},sendAccept(e){e.animationName.match(/^twistOut-/)&&this.$emit("accepted",this.law.id)}}});const Qt=w("data-v-c57832f8");m("data-v-c57832f8");const Yt={key:0,type:"radio"},qt={key:0,class:"button-bar"};p();const Xt=Qt(((e,t,i,n,r,a)=>(y(),g("div",{class:["Law",{accepted:e.accepted}],style:{zIndex:e.zIndex},onClick:t[2]||(t[2]=(...t)=>e.select&&e.select(...t)),onAnimationend:t[3]||(t[3]=(...t)=>e.sendAccept&&e.sendAccept(...t))},[b("label",null,[e.selectable?(y(),g("input",Yt)):v("",!0),b("div",null,[b("h3",null,f(e.law.title),1),b("div",null,f(e.law.description),1),e.selectable?(y(),g("div",qt,[b("button",{class:"accept",onClick:t[1]||(t[1]=(...t)=>e.accept&&e.accept(...t))},"✓")])):v("",!0)])])],38))));Rt.render=Xt,Rt.__scopeId="data-v-c57832f8";var ei=d({components:{LawCard:Rt},setup:()=>({store:Vn()}),data:()=>({zIndexes:[],poppedUp:!1}),computed:o(l({},h(["proposedLaws"])),{lawsToShow(){return this.zIndexes.length||(this.zIndexes=de(this.proposedLaws.length,0)),this.proposedLaws.map(((e,t)=>o(l({},e),{zIndex:this.zIndexes[t],pos:t})))}}),methods:{accept(e){this.store.dispatch("acceptLaw",{lawId:e}),this.poppedUp=!1},select(e){this.zIndexes=de(this.proposedLaws.length,e)}}});const ti=w("data-v-edd9edfa")(((e,t,i,n,r,a)=>{const s=A("LawCard");return y(),g("div",{class:["ProposedLaws",{poppedUp:e.poppedUp}],onClick:t[1]||(t[1]=t=>e.poppedUp=!0)},[(y(!0),g(k,null,S(e.lawsToShow,((t,i)=>(y(),g(s,{key:i,law:t,selectable:e.poppedUp,numCards:e.lawsToShow.length,onAccepted:()=>e.accept(t.id),onSelected:()=>e.select(i)},null,8,["law","selectable","numCards","onAccepted","onSelected"])))),128))],2)}));ei.render=ti,ei.__scopeId="data-v-edd9edfa";var ii=d({props:{title:String,text:String},methods:{acknowledge(){this.$emit("acknowledge")}}});const ni=w("data-v-2df6be4d");m("data-v-2df6be4d");const ri={key:0};p();const ai=ni(((e,t,i,n,r,a)=>e.text?(y(),g("div",{key:0,onClick:t[1]||(t[1]=(...t)=>e.acknowledge&&e.acknowledge(...t))},[e.title?(y(),g("h2",ri,f(e.title),1)):v("",!0),b("p",null,f(e.text),1)])):v("",!0)));ii.render=ai,ii.__scopeId="data-v-2df6be4d";var si=d({props:{value:{type:Number,required:!0}},computed:{isShort(){return this.value<20},isLess(){return this.value>=20&&this.value<50},isMore(){return this.value>=50&&this.value<80},isMuch(){return this.value>=80}}});const li=w("data-v-df0e905e");m("data-v-df0e905e");const oi={id:"finances"},ci={key:0,src:"/assets/money-short.7ce9dbed.png",id:"short"},ui={key:1,src:"/assets/money-less.c10d45f8.png",id:"less"},di={key:2,src:"/assets/money-more.a1c17d8d.png",id:"more"},hi={key:3,src:"/assets/money-much.ad651475.png",id:"much"};p();const mi=li(((e,t,i,n,r,a)=>(y(),g("div",oi,[e.isShort?(y(),g("img",ci)):v("",!0),e.isLess?(y(),g("img",ui)):v("",!0),e.isMore?(y(),g("img",di)):v("",!0),e.isMuch?(y(),g("img",hi)):v("",!0)]))));si.render=mi,si.__scopeId="data-v-df0e905e";var pi=d({props:{value:{type:Number,required:!0}},computed:{areHappy(){return this.value>=50},areAngry(){return this.value<50}}});const gi=w("data-v-a375dc26");m("data-v-a375dc26");const bi={id:"popularity"},vi={key:0,src:"/assets/people-happy.1e9e529c.png",id:"happy"},fi={key:1,src:"/assets/people-angry.495e0425.png",id:"angry"};p();const wi=gi(((e,t,i,n,r,a)=>(y(),g("div",bi,[e.areHappy?(y(),g("img",vi)):v("",!0),e.areAngry?(y(),g("img",fi)):v("",!0)]))));pi.render=wi,pi.__scopeId="data-v-a375dc26";var yi=d({data:()=>({levels:{healthy:"/assets/plant-healthy.1c912fd2.png",sick:"/assets/plant-sick.05726ebf.png",withered:"/assets/plant-withered.2d8ffb21.png"}}),props:{value:{type:Number,required:!0}},computed:{status(){return this.value>66?"healthy":this.value>33?"sick":"withered"},imgSrc(){return this.levels[this.status]}}});const ki=w("data-v-c0f87ac2");m("data-v-c0f87ac2");const Si={id:"plant"};p();const Ai=ki(((e,t,i,n,r,a)=>(y(),g("div",Si,[b("img",{src:e.imgSrc,id:e.status},null,8,["src","id"])]))));yi.render=Ai,yi.__scopeId="data-v-c0f87ac2";var Di=d({props:{year:Number}});const Wi=w("data-v-38fe5c52");m("data-v-38fe5c52");const Ti={id:"calendar"};p();const zi=Wi(((e,t,i,n,r,a)=>(y(),g("div",Ti,f(e.year),1))));Di.render=zi,Di.__scopeId="data-v-38fe5c52";var Pi=d({});const Vi=w("data-v-5952ab5a");m("data-v-5952ab5a");const Li={id:"heater"},Ci=b("img",{src:"/assets/heater.5a77e425.png"},null,-1);p();const Mi=Vi(((e,t,i,n,r,a)=>(y(),g("div",Li,[Ci]))));Pi.render=Mi,Pi.__scopeId="data-v-5952ab5a";var Oi=d({});const Ui=w("data-v-3902beeb");m("data-v-3902beeb");const Bi={id:"table"},Ei=b("img",{src:"/assets/table-top.c87bd2fd.png",id:"table-top"},null,-1),Gi=b("img",{src:"/assets/table-front.78c0f8c6.png",id:"table-front"},null,-1),Ii=b("img",{src:"/assets/table-front.78c0f8c6.png",id:"table-back"},null,-1),_i=b("img",{src:"/assets/table-side.49774a53.png",id:"table-left-side"},null,-1),xi=b("img",{src:"/assets/table-side.49774a53.png",id:"table-right-side"},null,-1);p();const Ni=Ui(((e,t,i,n,r,a)=>(y(),g("div",Bi,[Ei,Gi,Ii,_i,xi]))));Oi.render=Ni,Oi.__scopeId="data-v-3902beeb";var Ki=d({props:{withNews:Boolean}}),Fi="/assets/board-side.d7181ded.png",Hi="/assets/tvset-legs.78b387df.png";const ji=w("data-v-118e7bdf");m("data-v-118e7bdf");const $i={id:"tvset"},Ji=b("div",{id:"board"},[b("img",{id:"board-front",src:"/assets/board-front.41330f02.png"}),b("img",{id:"board-left",src:Fi}),b("img",{id:"board-right",src:Fi}),b("div",{id:"board-top"})],-1),Zi={id:"tv"},Ri=b("img",{id:"tv-front",src:"/assets/tv-front.82df5c0c.png"},null,-1),Qi={key:0,id:"news",src:"/assets/news.c4bbc2d0.png"},Yi=b("div",{id:"legs"},[b("img",{id:"legs-front",src:Hi}),b("img",{id:"legs-back",src:Hi})],-1);p();const qi=ji(((e,t,i,n,r,a)=>(y(),g("div",$i,[Ji,b("div",Zi,[Ri,e.withNews?(y(),g("img",Qi)):v("",!0)]),Yi]))));Ki.render=qi,Ki.__scopeId="data-v-118e7bdf";const Xi=[{id:"start",title:"Stell dir vor...",text:he`
      ### ... du bist Politiker.
    ...
    `},{id:"room",title:"Dein Arbeitszimmer",text:"Dies ist das Zimmer, in dem Du arbeitest und Entscheidungen triffst."},{id:"desk",title:"Dein Schreibtisch",text:"Du sitzt an Deinem Schreibtisch und findest dort immer wieder Gesetzesvorhaben, unter denen du auswählen musst.",highlight:"table"},{id:"finances",title:"Die Staatsfinanzen",text:"Auf Deinem Schreibtisch siehst Du, wie viel Geld der Staat noch hat, um Deine Entscheidungen umzusetzen.",highlight:"finances"},{id:"popularity",title:"Die Wähler",text:"Wenn Du aus dem Fenster schaust, siehst Du, in welcher Stimmung Deine Wähler sind.",highlight:"popularity"},{id:"climate",title:"Das Klima",text:"Die Pflanze in der Ecke zeigt Dir, wie sich das Klima entwickelt.",highlight:"plant"}];var en={};const tn=w("data-v-2419943a");m("data-v-2419943a");const nn={class:"dialog"},rn={class:"buttons"};p();const an=tn(((e,t,i,n,r,a)=>(y(),g("div",nn,[D(e.$slots,"default",{},void 0,!0),b("div",rn,[D(e.$slots,"buttons",{},void 0,!0)])]))));en.render=an,en.__scopeId="data-v-2419943a";var sn=d({setup(){const e=Vn();return e.dispatch("setupTour"),{store:e}},components:{Dialog:en},mounted(){this.setHighlight(this.currentStep)},computed:{currentStep(){return Xi.find((e=>e.id===this.$store.state.tour.step))},title(){var e;return null==(e=this.currentStep)?void 0:e.title},text(){var e;return null==(e=this.currentStep)?void 0:e.text}},watch:{currentStep(e){this.setHighlight(e)}},methods:{setHighlight(e){var t;const i=document.querySelector(".highlighted");i&&i.classList.remove("highlighted"),e&&e.highlight&&(null==(t=document.querySelector(`#${e.highlight}`))||t.classList.add("highlighted"))},next(){this.$store.dispatch("nextTourStep")},stop(){this.$store.dispatch("stopTour")}}});sn.render=function(e,t,i,n,r,a){const s=A("Dialog");return e.title&&e.text?(y(),g(s,{key:0},{buttons:W((()=>[b("button",{onClick:t[1]||(t[1]=(...t)=>e.stop&&e.stop(...t))},"Tour beenden"),b("button",{onClick:t[2]||(t[2]=(...t)=>e.next&&e.next(...t))},"Weiter")])),default:W((()=>[b("h2",null,f(e.title),1),b("div",{innerHTML:e.text},null,8,["innerHTML"])])),_:1})):v("",!0)};var ln=d({components:{Calendar:Di,ClimateIndicator:yi,Heater:Pi,LawProposals:ei,SpeechBubble:ii,FinanceIndicator:si,PopularityIndicator:pi,Table:Oi,Tour:sn,TVSet:Ki},data:()=>({store:Vn()}),computed:{eventTitle(){var e;return(null==(e=this.eventToShow())?void 0:e.title)||""},eventText(){var e;return(null==(e=this.eventToShow())?void 0:e.description)||""},currentYear(){var e;return(null==(e=this.store.state.game)?void 0:e.currentYear)||2021},finance(){const e=this.store.state.game;return e?function(e){return Zt(100-e.values.stateDebt/dt.stateDebt*50)}(e):0},popularity(){var e;return(null==(e=this.store.state.game)?void 0:e.values.popularity)||100},climate(){const e=this.store.state.game;return e?function(e){return 0===e.values.co2emissions?100:Zt(e.values.co2budget*ht(dt).co2emissions/dt.co2budget/e.values.co2emissions*50)}(e):0}},methods:{eventToShow(){var e;const t=null==(e=this.$store.state.game)?void 0:e.events[0];return t&&!t.acknowledged?t:null},acknowledge(){this.$store.dispatch("acknowledgeEvent",this.eventToShow())}}});const on={class:"game-setup"},cn=b("h1",null,"#ich-kann-klima",-1),un=b("div",{id:"walls"},[b("div",{id:"wall-back"}),b("div",{id:"wall-left"}),b("div",{id:"wall-right"})],-1);ln.render=function(e,t,i,n,r,a){const s=A("Calendar"),l=A("Heater"),o=A("PopularityIndicator"),c=A("TVSet"),u=A("ClimateIndicator"),d=A("Table"),h=A("FinanceIndicator"),m=A("LawProposals"),p=A("SpeechBubble"),v=A("Tour");return y(),g("div",on,[cn,un,b(s,{year:e.currentYear},null,8,["year"]),b(l),b(o,{value:e.popularity},null,8,["value"]),b(c,{"with-news":!!e.eventText},null,8,["with-news"]),b(u,{value:e.climate},null,8,["value"]),b(d),b(h,{value:e.finance},null,8,["value"]),b(m),b(p,{title:e.eventTitle,text:e.eventText,onAcknowledge:e.acknowledge},null,8,["title","text","onAcknowledge"]),b(v)])};var dn=d({setup(){const e=Vn();return{store:e,acceptedLaws:T((()=>{var t;return null==(t=e.state.game)?void 0:t.acceptedLaws}))}},data:()=>({opened:void 0}),computed:{visibleAccepted(){return Gt.filter((e=>{var t,i;return(null==(t=this.acceptedLaws)?void 0:t.some((t=>t.lawId===e.id)))&&!(null==(i=e.labels)?void 0:i.includes("hidden"))}))}},methods:{toggleOpen(e){this.opened=this.opened===e?void 0:e}}});const hn=w("data-v-aace6332")(((e,t,i,n,r,a)=>(y(!0),g(k,null,S(e.visibleAccepted,((t,i)=>(y(),g("div",{key:i,class:["Law",{opened:i===e.opened}],onClick:t=>e.toggleOpen(i)},[b("h3",null,f(t.title),1),b("div",null,f(t.description),1)],10,["onClick"])))),128))));dn.render=hn,dn.__scopeId="data-v-aace6332";var mn=d({components:{GameSetup:ln,AcceptedLaws:dn},setup:()=>({store:Vn()}),methods:{startGame(e){e?this.store.dispatch("loadGame",{gameId:e}):this.store.dispatch("startGame",void 0)}},beforeRouteEnter(e,t,i){i((t=>t.startGame(e.params.id)))}});const pn=w("data-v-3637ce73")(((e,t,i,n,r,a)=>{const s=A("GameSetup");return y(),g(s)}));mn.render=pn,mn.__scopeId="data-v-3637ce73";var gn=d({components:{Dialog:en},setup:()=>({store:Vn()}),computed:{co2(){var e,t;const i=null==(e=this.store.state.game)?void 0:e.values.co2budget;return(null==(t=this.store.state.game)?void 0:t.values.co2emissions)>0?i>0?"sind weiterhin vorhanden, aber zumindest ist das Budget noch nicht aufgebraucht, dein:e Nachfolger:in hat vielleicht noch eine Chance.":"sind explodiert, das Budget ist aufgebraucht. Hätte die AfD nicht besser hinbekommen.":i>0?"hast du im Griff! Es verbleibt sogar noch ein Rest-CO2-Budget, Gratulation!":"hast du gerade noch rechtzeitig ausreichend senken können. Punktlandung."},debt(){var e;return(null==(e=this.store.state.game)?void 0:e.values.stateDebt)<1e3?"sind ausgeglichen. Die Stabilitätskriterien werden eingehalten.":"sind dir leider aus dem Ruder gelaufen."},popularity(){var e;const t=null==(e=this.store.state.game)?void 0:e.values.popularity;return t<20?"entspricht dem, was man von einem langhährigen Diktator erwarten kann.":t<50?"ist nicht berauschend, wiedergewählt würdest du wohl eher nicht.":t<80?"reicht aus, dass du noch länger am Ruder bleiben könntest. Gratulation!":"ist völlig unglaubwürdig - war das wirklich eine freie Wahl?"}},methods:{loadGame(e){this.store.dispatch("loadGame",{gameId:e})},newGame(){this.$router.push("/games")}},beforeRouteEnter(e,t,i){i((t=>{t.loadGame(e.params.id)}))}});const bn=b("h2",null,"Das Spiel ist leider zu Ende",-1),vn=b("p",null,"Deine Entscheidungen haben etwas verändert - soviel kann man sagen.",-1),fn=b("p",null,"Gar nicht so einfach, Politiker zu sein, oder?",-1),wn={class:"button-bar"};gn.render=function(e,t,i,n,r,a){const s=A("Dialog");return y(),g(s,null,{default:W((()=>[bn,vn,b("ul",null,[b("li",null,"Die CO2-Emmissionen "+f(e.co2),1),b("li",null,"Die Staatsfinanzen "+f(e.debt),1),b("li",null,"Deine Beliebtheit "+f(e.popularity),1)]),fn,b("div",wn,[b("button",{onClick:t[1]||(t[1]=(...t)=>e.newGame&&e.newGame(...t))},"Neuer Versuch")])])),_:1})};const yn=[{path:"/",redirect:"/games"},{path:"/games",component:mn},{path:"/games/:id",component:mn},{path:"/games/:id/over",component:gn}],kn=z({history:P(),routes:yn});const Sn=function(e,t){let i,n=[];async function r(){if(i&&(clearTimeout(i),i=void 0),n.length){const{method:s,path:l,data:o,retry:c,resolve:u,reject:d}=n[0];try{if((null==t?void 0:t.navigator)&&!(null==t?void 0:t.navigator.onLine))throw Error("Browser is offline");const i=await e(s,l,o);n.shift(),u(i)}catch(a){c?n[0].retry=Math.max(-1,c-1):(n.shift(),d(a))}n.length&&(i=setTimeout(r,(null==t?void 0:t.timeout)||1e4))}}return{add:(e,t,a,s=-1)=>new Promise(((l,o)=>{n.push({method:e,path:t,data:a,retry:s,resolve:l,reject:o}),i||r()})),remove(e,t){n=n.filter((i=>i.method.toLowerCase()!==e.toLowerCase()||i.path!==t))},callsPending:()=>n.length>0}}(function(e,t,i=console){return async function(n,r,a){var s;try{const i={method:n};["post","put","patch"].includes(n)&&(i.body=JSON.stringify(a),i.headers={"content-type":"application/json"});const l=await t(e+r,i),o=(null==(s=l.headers.get("Content-Type"))?void 0:s.match(/json/))?await l.json():await l.text();if(l.ok)return o;throw Error(o.message||o)}catch(l){throw i.error(l),l}}}("https://api.ich-kann-klima.de/api",fetch));var An;const Dn=function({api:e,logger:t=console,storage:i=localStorage}){return{async createGame(n){i.setItem("game",JSON.stringify(n));try{e.createGame(n)}catch(r){t.warn("Cannot save new game - trying again later",r)}return n},async loadGame(t){const n=i.getItem("game");if(n){const e=JSON.parse(n);if(e.id===t)return $t(e,t)}return $t(await e.loadGame(t),t)},async saveGame(n){i.setItem("game",JSON.stringify(n));try{e.saveGame(n)}catch(r){t.warn("save on server failed - at least the game is saved in localStorage, so you can save it maybe next time",r)}},async decisionMade(t,i,n){e.decisionMade(t.id,i.id,n)},async eventOccurred(t,i){e.eventOccurred(t.id,i.id)}}}({api:(An=Sn,{createGame:e=>An.add("post","/games",e),loadGame:e=>An.add("get","/games/"+e,void 0,0),saveGame:e=>(An.remove("put","/games/"+e.id),An.add("put","/games/"+e.id,e)),decisionMade:(e,t,i)=>An.add("post","/games/"+e+"/decisions/"+t,{accepted:i}),eventOccurred:(e,t)=>An.add("post","/games/"+e+"/events/"+t)})}),Wn={async startGame(e){const t=function(e=Gt,t=jt){const i=$t(t);return i.acceptedLaws=e.filter((e=>{var t;return null==(t=e.labels)?void 0:t.includes("initial")})).map((e=>({lawId:e.id,effectiveSince:i.currentYear}))),i}(),i=Jt(t);await Dn.createGame(t),e.commit("setGameState",{game:t}),e.dispatch("applyEvent",{event:i}),kn.push("/games/"+t.id)},async loadGame(e,t){try{const i=await Dn.loadGame(t.gameId);await Dn.saveGame(i),kn.push("/games/"+i.id),e.commit("setGameState",{game:i})}catch(i){e.dispatch("error",{error:i})}},gameOver(e){var t;e.commit("gameOver",void 0),kn.push("/games/"+(null==(t=e.state.game)?void 0:t.id)+"/over")},async acceptLaw(e,t){const i=l({},e.state.game),n={lawId:t.lawId,effectiveSince:i.currentYear+1},r=_t(n),a=r.removeLawsWithLabels,s=i.acceptedLaws.map(_t).filter((e=>!(null==a?void 0:a.some((t=>{var i;return null==(i=e.labels)?void 0:i.includes(t)}))))).map((e=>({lawId:e.id,effectiveSince:e.effectiveSince})));i.acceptedLaws=[...s,n];const o=Jt(i);await Dn.saveGame(i),e.commit("setGameState",{game:i}),e.dispatch("applyEvent",{event:o}),await Dn.decisionMade(i,r,!0)},async rejectLaw(e,t){const i=l({},e.state.game);i.rejectedLaws=[...i.rejectedLaws,t.lawId],await Dn.decisionMade(i,It(t.lawId),!1),await Dn.saveGame(i),e.commit("setGameState",{game:i})},async advanceYear(e){const t=l({},e.state.game),i=t.acceptedLaws.map(_t);t.currentYear++,t.values=function(e,t,i){const n=ht(e);return t.sort(((e,t)=>{var i,n;return(null==(i=e.treatAfterLabels)?void 0:i.some((e=>{var i;return null==(i=t.labels)?void 0:i.includes(e)})))?1:(null==(n=t.treatAfterLabels)?void 0:n.some((t=>{var i;return null==(i=e.labels)?void 0:i.includes(t)})))?-1:0})).forEach((e=>{const t=e.effects(n,e.effectiveSince,i);pt(n,t)})),n.co2budget-=n.co2emissions,n}(t.values,i,t.currentYear),await Dn.saveGame(t),e.commit("setGameState",{game:t})},async applyEvent(e,t){if(!t.event)return;const i=l({},e.state.game);await Dn.eventOccurred(i,t.event),t.event.apply(e)},acknowledgeEvent(e,t){const i=l({},e.state.game);i.events.find((e=>e.id===t.id)).acknowledged=!0,Dn.saveGame(i),e.commit("setGameState",{game:i})},applyEffects(e,t){var i;const n=pt(l({},null==(i=e.state.game)?void 0:i.values),t),r=o(l({},e.state.game),{values:n});Dn.saveGame(r),e.commit("setGameState",{game:r})},setupTour(e){const t=localStorage.getItem("tour")||Xi[0].id,i=Xi.find((e=>t===e.id));i?e.commit("setTour",{step:i.id,active:!0}):Wn.stopTour(e)},nextTourStep(e){const t=Xi.findIndex((t=>e.state.tour.step===t.id));if(t<0||t==Xi.length-1)Wn.stopTour(e);else{const i=Xi[t+1];e.commit("setTour",{step:i.id,active:!0}),localStorage.setItem("tour",i.id)}},stopTour(e){e.commit("setTour",{step:"",active:!1}),localStorage.setItem("tour","completed")},async error(e,t){e.commit("error",t)}},Tn={setGameState(e,t){e.game=t.game},gameOver(e){e.game=o(l({},e.game),{over:!0})},setTour(e,t){e.tour=t},error(e,t){console.error(t.error),alert(t.error.message)}},zn={proposedLaws:e=>e.game&&e.game.proposedLaws?xt(e.game.proposedLaws):[]},Pn=Symbol();function Vn(){return V(Pn)}const Ln=L({state:{game:void 0,tour:{active:!0,step:"start"}},mutations:Tn,actions:Wn,getters:zn});function Cn(e,t){return e<t?-1:e>t?1:0}function Mn(e,t){const i=ht(e);function n(e){return(e>0?"+":"")+e.toFixed(2)}function r(r){const a=function(e){const i=t.find((t=>t.name===e));return i&&i.condition?i.value:0}(r),s=i[r]-e[r];return a&&Math.abs(a-s)<.001?n(a):a?n(a)+" / "+n(s):0!=s?n(s):""}pt(i,t);return ut.map((t=>{return{id:t.name,unit:t.unit,value:(i=t.name,e[i].toFixed(2)),effect:r(t.name),class:t.writable?"writable":"calculated"};var i}))}var On=d({props:{citation:{type:Object,required:!0},showInternals:{type:Boolean,default:!1}},computed:{href(){return this.citation.url.toString()},title(){return this.citation.title||this.citation.url.toString()}}});const Un={key:0},Bn=C(". "),En={key:1},Gn={key:2},In=C("Bemerkung: "),_n=C(". "),xn={key:3},Nn=C("Internes: "),Kn=C(". "),Fn={key:4},Hn=C(". "),jn={key:5},$n=C(". "),Jn={key:6},Zn=C(". ");On.render=function(e,t,i,n,r,a){return y(),g("p",null,[e.citation.authors?(y(),g("span",Un,f(e.citation.authors+e.citation.dateString())+". ",1)):v("",!0),b("a",{target:"_blank",rel:"noreferrer noopener",href:e.href},'"'+f(e.title)+'"',9,["href"]),Bn,e.citation.publisher?(y(),g("span",En,f(e.citation.publisher)+". ",1)):v("",!0),e.citation.comment?(y(),g("span",Gn,[In,b("span",{innerHTML:e.citation.comment},null,8,["innerHTML"]),_n])):v("",!0),e.showInternals&&e.citation.internalComment?(y(),g("span",xn,[Nn,b("span",{innerHTML:e.citation.internalComment},null,8,["innerHTML"]),Kn])):v("",!0),e.citation.referringUrl?(y(),g("span",Fn,[b("a",{target:"_blank",rel:"noreferrer noopener",href:e.citation.referringUrl.toString()},"Hier gefunden",8,["href"]),Hn])):v("",!0),e.citation.archiveUrl?(y(),g("span",jn,[b("a",{target:"_blank",rel:"noreferrer noopener",href:e.citation.archiveUrl.toString()},"Web Archiv Kopie",8,["href"]),$n])):v("",!0),e.citation.localCopy?(y(),g("span",Jn,[b("a",{target:"_blank",rel:"noreferrer noopener",href:"/sources/"+e.citation.localCopy},"Kopie",8,["href"]),Zn])):v("",!0)])};var Rn=d({components:{Citation:On},setup(){const e=Vn();return{store:e,game:T((()=>e.state.game))}},data:()=>({selectedTable:"laws",lawsSortCol:"state",lawsSortDir:1,eventsSortCol:"probability",eventsSortDir:-1,lawSelected:void 0,eventSelected:void 0,paramSelected:void 0}),methods:{sortLaws(e){e===this.lawsSortCol?this.lawsSortDir=this.lawsSortDir>0?-1:1:this.lawsSortDir=1,this.lawsSortCol=e},sortEvents(e){e===this.eventsSortCol?this.eventsSortDir=this.eventsSortDir>0?-1:1:this.eventsSortDir=1,this.eventsSortCol=e},selectLaw(e){this.unselect(),this.lawSelected=e},selectEvent(e){this.unselect(),this.eventSelected=e},selectParam(e){this.unselect(),this.paramSelected=e},unselect(){this.lawSelected=void 0,this.eventSelected=void 0,this.paramSelected=void 0}},computed:{startYearOfSelected(){if(!this.lawSelected||!this.game)return 2021;const e=this.game.acceptedLaws.find((e=>e.lawId===this.lawSelected));return e?e.effectiveSince:2021},selectedLaw(){return Gt.find((e=>e.id===this.lawSelected))},selectedEvent(){return Ht.find((e=>e.id===this.eventSelected))},selectedParam(){return this.paramSelected?rt[this.paramSelected]:void 0},wParam(){const e=this.selectedParam;return e instanceof le?e:void 0},cParam(){const e=this.selectedParam;return e instanceof oe?e:void 0},citationsOfLaw(){return this.selectedLaw&&this.selectedLaw.citations?this.selectedLaw.citations:[]},effectsOfSelected(){if(!this.lawSelected||!this.game)return[];this.game;const e=this.selectedLaw;return e?e.effects(this.game.values,this.startYearOfSelected,this.game.currentYear):[]},sortedValues(){return this.game?Mn(this.game.values,this.effectsOfSelected):[]},sortedLaws(){return this.game?function(e,t,i,n){const r=e.proposedLaws,a=e.acceptedLaws.map((e=>e.lawId)),s=e.rejectedLaws;return n.map((t=>{return{id:t.id,priority:t.priority(e),state:(i=t.id,a.includes(i)?"a":r.includes(i)?"p":s.includes(i)?"r":"x")};var i})).sort(((e,n)=>Cn(e[t],n[t])*i)).map((e=>o(l({},e),{priority:e.priority.toFixed(2)})))}(this.game,this.lawsSortCol,this.lawsSortDir,Gt):[]},sortedEvents(){return this.game?(e=this.game,t=this.eventsSortCol,i=this.eventsSortDir,Ht.map((t=>({id:t.id,probability:t.probability(e)}))).sort(((e,n)=>Cn(e[t],n[t])*i)).map((e=>o(l({},e),{probability:(100*e.probability).toFixed(2)})))):[];var e,t,i}}});const Qn=w("data-v-da8c4d08");m("data-v-da8c4d08");const Yn={class:"peekData"},qn={key:0,class:"Details"},Xn={class:"Title"},er={class:"Description"},tr=b("div",{class:"SectionHead"},"Details:",-1),ir=b("div",{class:"SectionHead"},"Internes:",-1),nr=b("div",{class:"SectionHead"},"Referenzen:",-1),rr={key:1,class:"Details"},ar={class:"Title"},sr={class:"Description"},lr=b("div",{class:"SectionHead"},"Details:",-1),or=b("div",{class:"SectionHead"},"Internes:",-1),cr=b("div",{class:"SectionHead"},"Referenzen:",-1),ur={key:2,class:"Details"},dr={class:"Title"},hr={key:0},mr={key:1},pr={key:2},gr=b("div",{class:"SectionHead"},"Details:",-1),br=b("div",{class:"SectionHead"},"Internes:",-1),vr=b("div",{class:"SectionHead"},"Referenzen:",-1),fr={class:"paramsList"},wr={class:"numbercol"},yr={class:"effcol"},kr={class:"buttonlist"},Sr={key:0,class:"lawlist"},Ar={class:"priocol"},Dr={key:1,class:"lawlist"},Wr={class:"priocol"};p();const Tr=Qn(((e,t,i,n,r,a)=>{var s;const l=A("Citation");return y(),g("details",Yn,[b("summary",{onClick:t[1]||(t[1]=t=>e.unselect()),class:"clickable"},"Peek"),e.selectedLaw?(y(),g("div",qn,[b("div",Xn,f(e.selectedLaw.title),1),b("div",er,f(e.selectedLaw.description),1),tr,b("div",{class:"Section",innerHTML:e.selectedLaw.details},null,8,["innerHTML"]),ir,b("div",{class:"Section",innerHTML:e.selectedLaw.internals},null,8,["innerHTML"]),nr,(y(!0),g(k,null,S(e.citationsOfLaw,((e,t)=>(y(),g(l,{class:"Section",key:t,citation:e},null,8,["citation"])))),128))])):v("",!0),e.selectedEvent?(y(),g("div",rr,[b("div",ar,f(e.selectedEvent.title),1),b("div",sr,f(e.selectedEvent.description),1),lr,b("div",{class:"Section",innerHTML:e.selectedEvent.details},null,8,["innerHTML"]),or,b("div",{class:"Section",innerHTML:e.selectedEvent.internals},null,8,["innerHTML"]),cr,(y(!0),g(k,null,S(null==(s=e.selectedEvent)?void 0:s.citations,((e,t)=>(y(),g(l,{class:"Section",key:t,citation:e},null,8,["citation"])))),128))])):v("",!0),e.selectedParam?(y(),g("div",ur,[b("div",dr,f(e.paramSelected)+" ["+f(e.selectedParam.unit)+"]",1),e.wParam?(y(),g("div",hr,"Initial value: "+f(e.wParam.initialValue)+" "+f(e.wParam.unit),1)):v("",!0),e.cParam&&e.cParam.shouldInitiallyBe?(y(),g("div",mr," Should initially be: "+f(e.cParam.shouldInitiallyBe)+" "+f(e.cParam.unit),1)):v("",!0),e.cParam?(y(),g("div",pr," Calculation: "+f(e.cParam.valueGetter),1)):v("",!0),gr,b("div",{class:"Section",innerHTML:e.selectedParam.details},null,8,["innerHTML"]),br,b("div",{class:"Section",innerHTML:e.selectedParam.internals},null,8,["innerHTML"]),vr,(y(!0),g(k,null,S(e.selectedParam.citations,((e,t)=>(y(),g(l,{class:"Section",key:t,citation:e},null,8,["citation"])))),128))])):v("",!0),b("table",fr,[(y(!0),g(k,null,S(e.sortedValues,(t=>(y(),g("tr",{key:t.id,class:["clickable",t.class],onClick:i=>e.selectParam(t.id)},[b("td",null,f(t.id),1),b("td",wr,f(t.value),1),b("td",yr,f(t.effect),1),b("td",null,f(t.unit),1)],10,["onClick"])))),128))]),b("div",null,[b("table",kr,[b("tr",null,[b("td",{class:["clickable lawButton",e.selectedTable],onClick:t[2]||(t[2]=t=>e.selectedTable="laws")},"Laws",2),b("td",{class:["clickable eventButton",e.selectedTable],onClick:t[3]||(t[3]=t=>e.selectedTable="events")},"Events",2)])]),"laws"===e.selectedTable?(y(),g("table",Sr,[b("tr",null,[b("th",{onClick:t[4]||(t[4]=t=>e.sortLaws("state")),class:"clickable"},"S"),b("th",{onClick:t[5]||(t[5]=t=>e.sortLaws("id")),class:"clickable"},"ID"),b("th",{onClick:t[6]||(t[6]=t=>e.sortLaws("priority")),class:"clickable priocol"},"Priority")]),(y(!0),g(k,null,S(e.sortedLaws,(t=>(y(),g("tr",{key:t.id,class:["clickable",t.state],onClick:i=>e.selectLaw(t.id)},[b("td",null,f(t.state),1),b("td",null,f(t.id),1),b("td",Ar,f(t.priority),1)],10,["onClick"])))),128))])):v("",!0),"events"===e.selectedTable?(y(),g("table",Dr,[b("tr",null,[b("th",{onClick:t[7]||(t[7]=t=>e.sortEvents("id")),class:"clickable"},"ID"),b("th",{onClick:t[8]||(t[8]=t=>e.sortEvents("probability")),class:"clickable priocol"},"Probability")]),(y(!0),g(k,null,S(e.sortedEvents,(t=>(y(),g("tr",{key:t.id,class:"clickable",onClick:i=>e.selectEvent(t.id)},[b("td",null,f(t.id),1),b("td",Wr,f(t.probability),1)],8,["onClick"])))),128))])):v("",!0)])])}));Rn.render=Tr,Rn.__scopeId="data-v-da8c4d08";var zr=d({components:{PeekInside:Rn},setup:()=>({store:Vn(),devMode:"true"===localStorage.getItem("devMode")}),methods:{updateStyle(){const e=window.innerHeight,t=window.innerWidth,i=Math.min(e/800,t/1e3),n=(t-1e3*i)/2;document.documentElement.style.setProperty("--scale",`${i}`),document.documentElement.style.setProperty("--translateX",`${n}px`)}},mounted(){setTimeout(this.updateStyle,0),window.addEventListener("resize",this.updateStyle)}});const Pr={class:"perspective"},Vr={class:"peek"};zr.render=function(e,t,i,n,r,a){const s=A("router-view"),l=A("PeekInside");return y(),g(k,null,[b("div",Pr,[b(s)]),b("div",Vr,[e.devMode?(y(),g(l,{key:0})):v("",!0)])],64)};const Lr=M(zr);Lr.use(Ln,Pn),Lr.use(kn),Lr.mount("#app");
