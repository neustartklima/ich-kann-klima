...
Hier sind ein paar Referenzen gelistet, die interessant sind, und noch nicht verarbeitet wurden.
  ...
  `}),Be=new ve({unit:"Percent",initialValue:100,citations:[pe],details:x`
...
Anfangswert ist die deutsche Staatsverschuldung 2019.
  ...
  `},CO2PreisDebatte:{title:"Debatte über CO2-Preise",description:"Eine marktliberale Kampagne ist sehr erfolgreich darin, Dich als Verbots-Kanzler hinzustellen. Aus allen Richtungen prasseln Forderungen nach einem adäquaten CO2-Preis auf Dich ein. Nur leider gehen die Vorstellungen über den genauen Preis sehr weit auseinander.",laws:["CO2PreisErhoehen","WirksamerCO2Preis","VollerCO2Preis"],apply:()=>[],probability:e=>Ai(1,3,(zi(e,"AutosInInnenstaedtenVerbieten")?1:0)+(zi(e,"KohleverstromungEinstellen")?1:0)+(zi(e,"SolarAufAllenDaechernVerpflichtend")?1:0)+(zi(e,"Tempolimit130AufAutobahnen")?1:0)+(zi(e,"Tempolimit120AufAutobahnen")?1:0)+(zi(e,"Tempolimit100AufAutobahnen")?1:0))/100}}),Bi={currentYear:2021,values:vt,acceptedLaws:[],proposedLaws:[],rejectedLaws:[],events:[],actionCount:0,over:!1};function Mi(e=Bi,t=c()){return{id:t,currentYear:e.currentYear,acceptedLaws:e.acceptedLaws,proposedLaws:e.proposedLaws,rejectedLaws:e.rejectedLaws,values:wt(e.values),events:e.events,actionCount:e.actionCount,over:e.over}}function Ui(e,t=yi,i=Fi,n=Math.random){const r=function(e,t,i){const n=function(e,t){return t.map((t=>o(l({},t),{prob:t.probability(e)}))).filter((e=>e.prob>0))}(e,t),r=function(e){return e.filter((e=>e.prob>1)).reduce(((e,t)=>t.prob>((null==e?void 0:e.prob)||0)?t:e),void 0)}(n);if(r)return r;return function(e,t){for(const i of e)if((t-=i.prob)<0)return i;return}(function(e){const t=e.map((e=>e.prob)).reduce(((e,t)=>e+t),0),i=.6/t;return e.map((e=>o(l({},e),{prob:e.prob*i})))}(n),i())}(e,i,n);if(r){const t={id:r.id,occuredIn:e.currentYear,acknowledged:!1};e.events.unshift(t)}const a=function(e,t,i){const n=t=>{var i;return null==(i=e.acceptedLaws)?void 0:i.some((e=>e.lawId===t.id))},r=t=>{var i;return null==(i=e.rejectedLaws)?void 0:i.includes(t.id)},a=e=>{var t;return(null==(t=e.labels)?void 0:t.includes("hidden"))||!1},s=t=>({law:t,priority:t.priority(e)}),l=e=>({law:e.law,priority:e.priority+(i.includes(e.law.id)?100:0)});return t.filter(G(n)).filter(G(r)).filter(G(a)).map(s).filter((e=>e.priority>0)).map(l).sort(((e,t)=>t.priority-e.priority)).map((e=>e.law.id)).slice(0,6)}(e,t,(null==r?void 0:r.laws)?r.laws:[]);return e.proposedLaws=function(e,t){const i=[...e],n=t.filter((e=>i.includes(e))),r=t.filter((e=>!n.includes(e)));var a=0;for(;a<i.length;)n.includes(i[a])?a++:0!==r.length?(i[a]=r.shift(),a++):i.splice(a,1);return i.push(...r.slice(0,6-i.length)),i}(e.proposedLaws,a),e.actionCount++,r}function Ii(e){return Math.max(0,Math.min(100,e))}var xi=d({props:{law:{type:Object,required:!0},selectable:{type:Boolean,required:!0},numCards:{type:Number,required:!0}},setup:()=>({store:Ar()}),data:()=>({accepted:!1}),computed:o(l({},h(["proposedLaws"])),{zIndex(){return this.law.zIndex},transform(){return`rotate(${2*(this.law.pos-this.numCards/2)}deg) translate(${20*Math.abs(this.numCards/2-this.law.pos)}px, -50%)`}}),methods:{select(){this.$emit("selected")},accept(){this.accepted=!0},sendAccept(e){e.animationName.match(/^twistOut-/)&&this.$emit("accepted",this.law.id)}}});const Gi=w("data-v-c57832f8");g("data-v-c57832f8");const Ni={key:0,type:"radio"},_i={key:0,class:"button-bar"};m();const Ki=Gi(((e,t,i,n,r,a)=>(y(),p("div",{class:["Law",{accepted:e.accepted}],style:{zIndex:e.zIndex},onClick:t[2]||(t[2]=(...t)=>e.select&&e.select(...t)),onAnimationend:t[3]||(t[3]=(...t)=>e.sendAccept&&e.sendAccept(...t))},[b("label",null,[e.selectable?(y(),p("input",Ni)):f("",!0),b("div",null,[b("h3",null,v(e.law.title),1),b("div",null,v(e.law.description),1),e.selectable?(y(),p("div",_i,[b("button",{class:"accept",onClick:t[1]||(t[1]=(...t)=>e.accept&&e.accept(...t))},"✓")])):f("",!0)])])],38))));xi.render=Ki,xi.__scopeId="data-v-c57832f8";var ji=d({components:{LawCard:xi},setup:()=>({store:Ar()}),data:()=>({zIndexes:[],poppedUp:!1}),computed:o(l({},h(["proposedLaws"])),{lawsToShow(){return this.zIndexes.length||(this.zIndexes=I(this.proposedLaws.length,0)),this.proposedLaws.map(((e,t)=>o(l({},e),{zIndex:this.zIndexes[t],pos:t})))}}),methods:{accept(e){this.store.dispatch("acceptLaw",{lawId:e})},select(e){this.zIndexes=I(this.proposedLaws.length,e)},sitOut(){this.store.dispatch("sitOut")}}});const Hi=w("data-v-290d8620")(((e,t,i,n,r,a)=>{const s=A("LawCard");return y(),p(k,null,[b("div",{class:["ProposedLaws",{poppedUp:e.poppedUp}],onClick:t[1]||(t[1]=t=>e.poppedUp=!0)},[(y(!0),p(k,null,S(e.lawsToShow,((t,i)=>(y(),p(s,{key:t.id,law:t,selectable:e.poppedUp,numCards:e.lawsToShow.length,onAccepted:()=>e.accept(t.id),onSelected:()=>e.select(i)},null,8,["law","selectable","numCards","onAccepted","onSelected"])))),128))],2),b("div",{class:"sitOutButton",onClick:t[2]||(t[2]=()=>e.sitOut())},"Aussitzen")],64)}));ji.render=Hi,ji.__scopeId="data-v-290d8620";var Zi=d({props:{title:String,text:String},methods:{acknowledge(){this.$emit("acknowledge")}}});const Ji=w("data-v-2df6be4d");g("data-v-2df6be4d");const Ri={key:0};m();const $i=Ji(((e,t,i,n,r,a)=>e.text?(y(),p("div",{key:0,onClick:t[1]||(t[1]=(...t)=>e.acknowledge&&e.acknowledge(...t))},[e.title?(y(),p("h2",Ri,v(e.title),1)):f("",!0),b("p",null,v(e.text),1)])):f("",!0)));Zi.render=$i,Zi.__scopeId="data-v-2df6be4d";var Qi=d({props:{title:{type:String,required:!0},value:{type:Number,required:!0},zoom:{type:Number,default:1}},computed:{titleStyle(){return{fontSize:.5*this.zoom+"em"}},progressBarStyle(){return{width:50*this.zoom+"px",height:5*this.zoom+"px"}},indicatorStyle(){const e=this.value>40?"green":this.value>20?"goldenrod":"red";return{width:this.value+"%",backgroundColor:e}}}});const qi=w("data-v-37cfebf9");g("data-v-37cfebf9");const Yi={class:"container"};m();const Xi=qi(((e,t,i,n,r,a)=>(y(),p("div",Yi,[b("div",{class:"title",style:e.titleStyle},v(e.title),5),b("div",{class:"progress-bar",style:e.progressBarStyle},[b("div",{class:"indicator",style:e.indicatorStyle},null,4)],4)]))));Qi.render=Xi,Qi.__scopeId="data-v-37cfebf9";var en=d({props:{value:{type:Number,required:!0}},components:{IndicatorBar:Qi},computed:{isShort(){return this.value<20},isLess(){return this.value>=20&&this.value<50},isMore(){return this.value>=50&&this.value<80},isMuch(){return this.value>=80}}});const tn=w("data-v-791f01dd");g("data-v-791f01dd");const nn={id:"finances"},rn={key:0,src:"/assets/money-short.7ce9dbed.png",id:"short"},an={key:1,src:"/assets/money-less.c10d45f8.png",id:"less"},sn={key:2,src:"/assets/money-more.a1c17d8d.png",id:"more"},ln={key:3,src:"/assets/money-much.ad651475.png",id:"much"};m();const on=tn(((e,t,i,n,r,a)=>{const s=A("IndicatorBar");return y(),p("div",nn,[b(s,{title:"Finanzen",value:e.value,zoom:.9},null,8,["value","zoom"]),e.isShort?(y(),p("img",rn)):f("",!0),e.isLess?(y(),p("img",an)):f("",!0),e.isMore?(y(),p("img",sn)):f("",!0),e.isMuch?(y(),p("img",ln)):f("",!0)])}));en.render=on,en.__scopeId="data-v-791f01dd";var un=d({props:{value:{type:Number,required:!0}},components:{IndicatorBar:Qi},computed:{areHappy(){return this.value>=50},areAngry(){return this.value<50}}});const cn=w("data-v-e5acad4c");g("data-v-e5acad4c");const dn={id:"popularity"},hn={key:0,src:"/assets/people-happy.1e9e529c.png",id:"happy"},gn={key:1,src:"/assets/people-angry.495e0425.png",id:"angry"};m();const mn=cn(((e,t,i,n,r,a)=>{const s=A("IndicatorBar");return y(),p("div",dn,[b(s,{title:"Beliebtheit",value:e.value,zoom:2.8,style:{margin:"-80px 0 0 200px"}},null,8,["value","zoom"]),e.areHappy?(y(),p("img",hn)):f("",!0),e.areAngry?(y(),p("img",gn)):f("",!0)])}));un.render=mn,un.__scopeId="data-v-e5acad4c";var pn=d({data:()=>({levels:{healthy:"/assets/plant-healthy.1c912fd2.png",sick:"/assets/plant-sick.05726ebf.png",withered:"/assets/plant-withered.2d8ffb21.png"}}),props:{value:{type:Number,required:!0}},components:{IndicatorBar:Qi},computed:{status(){return this.value>66?"healthy":this.value>33?"sick":"withered"},imgSrc(){return this.levels[this.status]}}});const bn=w("data-v-8ae17ad2");g("data-v-8ae17ad2");const fn={id:"plant"};m();const vn=bn(((e,t,i,n,r,a)=>{const s=A("IndicatorBar");return y(),p("div",fn,[b(s,{title:"CO2-Budget",value:e.value,zoom:2.5,style:{margin:"-50px 0 0 60px"}},null,8,["value","zoom"]),b("img",{src:e.imgSrc,id:e.status},null,8,["src","id"])])}));pn.render=vn,pn.__scopeId="data-v-8ae17ad2";var wn=d({props:{year:Number}});const yn=w("data-v-38fe5c52");g("data-v-38fe5c52");const kn={id:"calendar"};m();const Sn=yn(((e,t,i,n,r,a)=>(y(),p("div",kn,v(e.year),1))));wn.render=Sn,wn.__scopeId="data-v-38fe5c52";var An=d({});const Pn=w("data-v-5952ab5a");g("data-v-5952ab5a");const zn={id:"heater"},Dn=b("img",{src:"/assets/heater.5a77e425.png"},null,-1);m();const Wn=Pn(((e,t,i,n,r,a)=>(y(),p("div",zn,[Dn]))));An.render=Wn,An.__scopeId="data-v-5952ab5a";var Vn=d({});const Tn=w("data-v-3902beeb");g("data-v-3902beeb");const Ln={id:"table"},On=b("img",{src:"/assets/table-top.c87bd2fd.png",id:"table-top"},null,-1),Cn=b("img",{src:"/assets/table-front.78c0f8c6.png",id:"table-front"},null,-1),En=b("img",{src:"/assets/table-front.78c0f8c6.png",id:"table-back"},null,-1),Fn=b("img",{src:"/assets/table-side.49774a53.png",id:"table-left-side"},null,-1),Bn=b("img",{src:"/assets/table-side.49774a53.png",id:"table-right-side"},null,-1);m();const Mn=Tn(((e,t,i,n,r,a)=>(y(),p("div",Ln,[On,Cn,En,Fn,Bn]))));Vn.render=Mn,Vn.__scopeId="data-v-3902beeb";var Un=d({props:{withNews:Boolean}}),In="/assets/board-side.d7181ded.png",xn="/assets/tvset-legs.78b387df.png";const Gn=w("data-v-118e7bdf");g("data-v-118e7bdf");const Nn={id:"tvset"},_n=b("div",{id:"board"},[b("img",{id:"board-front",src:"/assets/board-front.41330f02.png"}),b("img",{id:"board-left",src:In}),b("img",{id:"board-right",src:In}),b("div",{id:"board-top"})],-1),Kn={id:"tv"},jn=b("img",{id:"tv-front",src:"/assets/tv-front.82df5c0c.png"},null,-1),Hn={key:0,id:"news",src:"/assets/news.c4bbc2d0.png"},Zn=b("div",{id:"legs"},[b("img",{id:"legs-front",src:xn}),b("img",{id:"legs-back",src:xn})],-1);m();const Jn=Gn(((e,t,i,n,r,a)=>(y(),p("div",Nn,[_n,b("div",Kn,[jn,e.withNews?(y(),p("img",Hn)):f("",!0)]),Zn]))));Un.render=Jn,Un.__scopeId="data-v-118e7bdf";const Rn=[{id:"start",title:"Stell dir vor...",text:x`
      ### ... du bist Politiker.
    ...
    `},{id:"room",title:"Dein Arbeitszimmer",text:"Dies ist das Zimmer, in dem Du arbeitest und Entscheidungen triffst."},{id:"desk",title:"Dein Schreibtisch",text:"Du sitzt an Deinem Schreibtisch und findest dort immer wieder Gesetzesvorhaben, unter denen du auswählen musst.",highlight:"table"},{id:"finances",title:"Die Staatsfinanzen",text:"Auf Deinem Schreibtisch siehst Du, wie viel Geld der Staat noch hat, um Deine Entscheidungen umzusetzen.",highlight:"finances"},{id:"popularity",title:"Die Wähler",text:"Wenn Du aus dem Fenster schaust, siehst Du, in welcher Stimmung Deine Wähler sind.",highlight:"popularity"},{id:"climate",title:"Das Klima",text:"Die Pflanze in der Ecke zeigt Dir, wie sich das Klima entwickelt.",highlight:"plant"}];var $n={};const Qn=w("data-v-2419943a");g("data-v-2419943a");const qn={class:"dialog"},Yn={class:"buttons"};m();const Xn=Qn(((e,t,i,n,r,a)=>(y(),p("div",qn,[P(e.$slots,"default",{},void 0,!0),b("div",Yn,[P(e.$slots,"buttons",{},void 0,!0)])]))));$n.render=Xn,$n.__scopeId="data-v-2419943a";var er=d({setup(){const e=Ar();return e.dispatch("setupTour"),{store:e}},components:{Dialog:$n},mounted(){this.setHighlight(this.currentStep)},computed:{currentStep(){return Rn.find((e=>e.id===this.$store.state.tour.step))},title(){var e;return null==(e=this.currentStep)?void 0:e.title},text(){var e;return null==(e=this.currentStep)?void 0:e.text}},watch:{currentStep(e){this.setHighlight(e)}},methods:{setHighlight(e){var t;const i=document.querySelector(".highlighted");i&&i.classList.remove("highlighted"),e&&e.highlight&&(null==(t=document.querySelector(`#${e.highlight}`))||t.classList.add("highlighted"))},next(){this.$store.dispatch("nextTourStep")},stop(){this.$store.dispatch("stopTour")}}});er.render=function(e,t,i,n,r,a){const s=A("Dialog");return e.title&&e.text?(y(),p(s,{key:0},{buttons:z((()=>[b("button",{onClick:t[1]||(t[1]=(...t)=>e.stop&&e.stop(...t))},"Tour beenden"),b("button",{onClick:t[2]||(t[2]=(...t)=>e.next&&e.next(...t))},"Weiter")])),default:z((()=>[b("h2",null,v(e.title),1),b("div",{innerHTML:e.text},null,8,["innerHTML"])])),_:1})):f("",!0)};var tr=d({components:{Calendar:wn,ClimateIndicator:pn,Heater:An,LawProposals:ji,SpeechBubble:Zi,FinanceIndicator:en,PopularityIndicator:un,Table:Vn,Tour:er,TVSet:Un},data:()=>({store:Ar()}),computed:{eventToShow(){var e;const t=(null==(e=this.store.state.game)?void 0:e.events)||[];if(0===t.length)return;const i=t[0];return i.acknowledged?void 0:Fi.find((e=>e.id===i.id))},eventTitle(){var e;return(null==(e=this.eventToShow)?void 0:e.title)||""},eventText(){var e;return(null==(e=this.eventToShow)?void 0:e.description)||""},currentYear(){var e;return(null==(e=this.store.state.game)?void 0:e.currentYear)||2021},finance(){const e=this.store.state.game;return e?function(e){return Ii(100-e.values.stateDebt/vt.stateDebt*50)}(e):0},popularity(){var e;return(null==(e=this.store.state.game)?void 0:e.values.popularity)||100},climate(){const e=this.store.state.game;return e?function(e){return 0===e.values.co2emissions?100:Ii(e.values.co2budget*wt(vt).co2emissions/vt.co2budget/e.values.co2emissions*50)}(e):0}},methods:{acknowledge(){this.$store.dispatch("acknowledgeEvent",this.eventToShow)}}});const ir={class:"game-setup"},nr=b("h1",null,"#ich-kann-klima",-1),rr=b("div",{id:"walls"},[b("div",{id:"wall-back"}),b("div",{id:"wall-left"}),b("div",{id:"wall-right"})],-1);tr.render=function(e,t,i,n,r,a){const s=A("Calendar"),l=A("Heater"),o=A("PopularityIndicator"),u=A("TVSet"),c=A("ClimateIndicator"),d=A("Table"),h=A("FinanceIndicator"),g=A("LawProposals"),m=A("SpeechBubble"),f=A("Tour");return y(),p("div",ir,[nr,rr,b(s,{year:e.currentYear},null,8,["year"]),b(l),b(o,{value:e.popularity},null,8,["value"]),b(u,{"with-news":!!e.eventText},null,8,["with-news"]),b(c,{value:e.climate},null,8,["value"]),b(d),b(h,{value:e.finance},null,8,["value"]),b(g),b(m,{title:e.eventTitle,text:e.eventText,onAcknowledge:e.acknowledge},null,8,["title","text","onAcknowledge"]),b(f)])};var ar=d({setup(){const e=Ar();return{store:e,acceptedLaws:D((()=>{var t;return null==(t=e.state.game)?void 0:t.acceptedLaws}))}},data:()=>({opened:void 0}),computed:{visibleAccepted(){return yi.filter((e=>{var t,i;return(null==(t=this.acceptedLaws)?void 0:t.some((t=>t.lawId===e.id)))&&!(null==(i=e.labels)?void 0:i.includes("hidden"))}))}},methods:{toggleOpen(e){this.opened=this.opened===e?void 0:e}}});const sr=w("data-v-aace6332")(((e,t,i,n,r,a)=>(y(!0),p(k,null,S(e.visibleAccepted,((t,i)=>(y(),p("div",{key:i,class:["Law",{opened:i===e.opened}],onClick:t=>e.toggleOpen(i)},[b("h3",null,v(t.title),1),b("div",null,v(t.description),1)],10,["onClick"])))),128))));ar.render=sr,ar.__scopeId="data-v-aace6332";var lr=d({components:{GameSetup:tr,AcceptedLaws:ar},setup:()=>({store:Ar()}),methods:{startGame(e){e?this.store.dispatch("loadGame",{gameId:e}):this.store.dispatch("startGame",void 0)}},beforeRouteEnter(e,t,i){i((t=>t.startGame(e.params.id)))}});const or=w("data-v-3637ce73")(((e,t,i,n,r,a)=>{const s=A("GameSetup");return y(),p(s)}));lr.render=or,lr.__scopeId="data-v-3637ce73";var ur=d({components:{Dialog:$n},setup:()=>({store:Ar()}),computed:{co2(){var e,t;const i=null==(e=this.store.state.game)?void 0:e.values.co2budget;return(null==(t=this.store.state.game)?void 0:t.values.co2emissions)>0?i>0?"sind weiterhin vorhanden, aber zumindest ist das Budget noch nicht aufgebraucht, dein:e Nachfolger:in hat vielleicht noch eine Chance.":"sind explodiert, das Budget ist aufgebraucht. Hätte die AfD nicht besser hinbekommen.":i>0?"hast du im Griff! Es verbleibt sogar noch ein Rest-CO2-Budget, Gratulation!":"hast du gerade noch rechtzeitig ausreichend senken können. Punktlandung."},debt(){var e;return(null==(e=this.store.state.game)?void 0:e.values.stateDebt)<1e3?"sind ausgeglichen. Die Stabilitätskriterien werden eingehalten.":"sind dir leider aus dem Ruder gelaufen."},popularity(){var e;const t=null==(e=this.store.state.game)?void 0:e.values.popularity;return t<20?"entspricht dem, was man von einem langhährigen Diktator erwarten kann.":t<50?"ist nicht berauschend, wiedergewählt würdest du wohl eher nicht.":t<80?"reicht aus, dass du noch länger am Ruder bleiben könntest. Gratulation!":"ist völlig unglaubwürdig - war das wirklich eine freie Wahl?"}},methods:{loadGame(e){this.store.dispatch("loadGame",{gameId:e})},newGame(){this.$router.push("/games")}},beforeRouteEnter(e,t,i){i((t=>{t.loadGame(e.params.id)}))}});const cr=b("h2",null,"Das Spiel ist leider zu Ende",-1),dr=b("p",null,"Deine Entscheidungen haben etwas verändert - soviel kann man sagen.",-1),hr=b("p",null,"Gar nicht so einfach, Politiker zu sein, oder?",-1),gr={class:"button-bar"};ur.render=function(e,t,i,n,r,a){const s=A("Dialog");return y(),p(s,null,{default:z((()=>[cr,dr,b("ul",null,[b("li",null,"Die CO2-Emmissionen "+v(e.co2),1),b("li",null,"Die Staatsfinanzen "+v(e.debt),1),b("li",null,"Deine Beliebtheit "+v(e.popularity),1)]),hr,b("div",gr,[b("button",{onClick:t[1]||(t[1]=(...t)=>e.newGame&&e.newGame(...t))},"Neuer Versuch")])])),_:1})};const mr=[{path:"/",redirect:"/games"},{path:"/games",component:lr},{path:"/games/:id",component:lr},{path:"/games/:id/over",component:ur}],pr=W({history:V(),routes:mr});const br=function(e,t){let i,n=[];async function r(){if(i&&(clearTimeout(i),i=void 0),n.length){const{method:s,path:l,data:o,retry:u,resolve:c,reject:d}=n[0];try{if((null==t?void 0:t.navigator)&&!(null==t?void 0:t.navigator.onLine))throw Error("Browser is offline");const i=await e(s,l,o);n.shift(),c(i)}catch(a){u?n[0].retry=Math.max(-1,u-1):(n.shift(),d(a))}n.length&&(i=setTimeout(r,(null==t?void 0:t.timeout)||1e4))}}return{add:(e,t,a,s=-1)=>new Promise(((l,o)=>{n.push({method:e,path:t,data:a,retry:s,resolve:l,reject:o}),i||r()})),remove(e,t){n=n.filter((i=>i.method.toLowerCase()!==e.toLowerCase()||i.path!==t))},callsPending:()=>n.length>0}}(function(e,t,i=console){return async function(n,r,a){var s;try{const i={method:n};["post","put","patch"].includes(n)&&(i.body=JSON.stringify(a),i.headers={"content-type":"application/json"});const l=await t(e+r,i),o=(null==(s=l.headers.get("Content-Type"))?void 0:s.match(/json/))?await l.json():await l.text();if(l.ok)return o;throw Error(o.message||o)}catch(l){throw i.error(l),l}}}("https://api.ich-kann-klima.de/api",fetch));var fr;const vr=function({api:e,logger:t=console,storage:i=localStorage}){return{async createGame(n){i.setItem("game",JSON.stringify(n));try{e.createGame(n)}catch(r){t.warn("Cannot save new game - trying again later",r)}return n},async loadGame(t){const n=i.getItem("game");if(n){const e=JSON.parse(n);if(e.id===t)return Mi(e,t)}return Mi(await e.loadGame(t),t)},async saveGame(n){i.setItem("game",JSON.stringify(n));try{e.saveGame(n)}catch(r){t.warn("save on server failed - at least the game is saved in localStorage, so you can save it maybe next time",r)}},async decisionMade(t,i,n){e.decisionMade(t.id,i,n)},async eventOccurred(t,i){e.eventOccurred(t.id,i.id)}}}({api:(fr=br,{createGame:e=>fr.add("post","/games",e),loadGame:e=>fr.add("get","/games/"+e,void 0,0),saveGame:e=>(fr.remove("put","/games/"+e.id),fr.add("put","/games/"+e.id,e)),decisionMade:(e,t,i)=>fr.add("post","/games/"+e+"/decisions/"+t,{accepted:i}),eventOccurred:(e,t)=>fr.add("post","/games/"+e+"/events/"+t)})}),wr={async startGame(e){const t=function(e=yi,t=Bi){const i=Mi(t);return i.acceptedLaws=e.filter((e=>{var t;return null==(t=e.labels)?void 0:t.includes("initial")})).map((e=>({lawId:e.id,effectiveSince:i.currentYear}))),i}(),i=Ui(t);await vr.createGame(t),e.commit("setGameState",{game:t}),e.dispatch("applyEvent",{event:i}),pr.push("/games/"+t.id)},async loadGame(e,t){try{const i=await vr.loadGame(t.gameId);await vr.saveGame(i),pr.push("/games/"+i.id),e.commit("setGameState",{game:i})}catch(i){e.dispatch("error",{error:i})}},gameOver(e){var t;e.commit("gameOver",void 0),pr.push("/games/"+(null==(t=e.state.game)?void 0:t.id)+"/over")},async acceptLaw(e,t){const i=l({},e.state.game),n={lawId:t.lawId,effectiveSince:i.currentYear+1},r=ki(n),a=r.removeLawsWithLabels,s=i.acceptedLaws.map(ki).filter((e=>!(null==a?void 0:a.some((t=>{var i;return null==(i=e.labels)?void 0:i.includes(t)}))))).map((e=>({lawId:e.id,effectiveSince:e.effectiveSince})));i.acceptedLaws=[...s,n];const o=Ui(i);await vr.saveGame(i),e.commit("setGameState",{game:i}),e.dispatch("applyEvent",{event:o}),await vr.decisionMade(i,r.id,!0)},async rejectLaw(e,t){const i=l({},e.state.game);i.rejectedLaws=[...i.rejectedLaws,t.lawId],await vr.decisionMade(i,t.lawId,!1),await vr.saveGame(i),e.commit("setGameState",{game:i})},async sitOut(e){const t=l({},e.state.game);await vr.decisionMade(t,"sitOut",!0);const i=Ui(t);await vr.saveGame(t),e.commit("setGameState",{game:t}),e.dispatch("applyEvent",{event:i})},async advanceYear(e){const t=l({},e.state.game),i=t.acceptedLaws.map(ki);t.currentYear++,t.values=function(e,t,i){const n=wt(e.values);return t.sort(((e,t)=>{var i,n;return(null==(i=e.treatAfterLabels)?void 0:i.some((e=>{var i;return null==(i=t.labels)?void 0:i.includes(e)})))?1:(null==(n=t.treatAfterLabels)?void 0:n.some((t=>{var i;return null==(i=e.labels)?void 0:i.includes(t)})))?-1:0})).forEach((t=>{const r=t.effects(o(l({},e),{values:n}),t.effectiveSince,i);At({dispatch:()=>{},values:n},r)})),n.co2budget-=n.co2emissions,n}(t,i,t.currentYear),await vr.saveGame(t),e.commit("setGameState",{game:t})},async applyEvent(e,t){if(!t.event)return;const i=l({},e.state.game);await vr.eventOccurred(i,t.event);const n=t.event.apply(i);e.dispatch("applyEffects",{changes:n})},acknowledgeEvent(e,t){const i=l({},e.state.game);i.events.find((e=>e.id===t.id)).acknowledged=!0,vr.saveGame(i),e.commit("setGameState",{game:i})},applyEffects(e,t){const i={dispatch:e.dispatch,values:wt(e.state.game.values)};At(i,t.changes);const n=o(l({},e.state.game),{values:i.values});vr.saveGame(n),e.commit("setGameState",{game:n})},setupTour(e){const t=localStorage.getItem("tour")||Rn[0].id,i=Rn.find((e=>t===e.id));i?e.commit("setTour",{step:i.id,active:!0}):wr.stopTour(e)},nextTourStep(e){const t=Rn.findIndex((t=>e.state.tour.step===t.id));if(t<0||t==Rn.length-1)wr.stopTour(e);else{const i=Rn[t+1];e.commit("setTour",{step:i.id,active:!0}),localStorage.setItem("tour",i.id)}},stopTour(e){e.commit("setTour",{step:"",active:!1}),localStorage.setItem("tour","completed")},async error(e,t){e.commit("error",t)}},yr={setGameState(e,t){e.game=t.game},gameOver(e){e.game=o(l({},e.game),{over:!0})},setTour(e,t){e.tour=t},error(e,t){console.error(t.error),alert(t.error.message)}},kr={proposedLaws:e=>e.game&&e.game.proposedLaws?Si(e.game.proposedLaws):[]},Sr=Symbol();function Ar(){return T(Sr)}const Pr=L({state:{game:void 0,tour:{active:!0,step:"start"}},mutations:yr,actions:wr,getters:kr});function zr(e,t,...i){for(const n of i){if(e[n]<t[n])return-1;if(e[n]>t[n])return 1}return 0}function Dr(e,t){const i=wt(e.values);function n(e){return(e>0?"+":"")+e.toFixed(2)}function r(r){const a=function(e){const i=t.find((t=>"modify"===t.type&&t.name===e));return i&&i.condition?i.value:0}(r),s=i[r]-e.values[r];return a&&Math.abs(a-s)<.001?n(a):a?n(a)+" / "+n(s):0!=s?n(s):""}At({dispatch:()=>{},values:i},t);return ft.map((t=>{return{id:t.name,unit:t.unit,value:(i=t.name,e.values[i].toFixed(2)),effect:r(t.name),class:t.writable?"writable":"calculated"};var i}))}var Wr=d({props:{citation:{type:Object,required:!0},showInternals:{type:Boolean,default:!1}},computed:{href(){return this.citation.url.toString()},title(){return this.citation.title||this.citation.url.toString()}}});const Vr={key:0},Tr=O(". "),Lr={key:1},Or={key:2},Cr=O("Bemerkung: "),Er=O(". "),Fr={key:3},Br=O("Internes: "),Mr=O(". "),Ur={key:4},Ir=O(". "),xr={key:5},Gr=O(". "),Nr={key:6},_r=O(". ");Wr.render=function(e,t,i,n,r,a){return y(),p("p",null,[e.citation.authors?(y(),p("span",Vr,v(e.citation.authors+e.citation.dateString())+". ",1)):f("",!0),b("a",{target:"_blank",rel:"noreferrer noopener",href:e.href},'"'+v(e.title)+'"',9,["href"]),Tr,e.citation.publisher?(y(),p("span",Lr,v(e.citation.publisher)+". ",1)):f("",!0),e.citation.comment?(y(),p("span",Or,[Cr,b("span",{innerHTML:e.citation.comment},null,8,["innerHTML"]),Er])):f("",!0),e.showInternals&&e.citation.internalComment?(y(),p("span",Fr,[Br,b("span",{innerHTML:e.citation.internalComment},null,8,["innerHTML"]),Mr])):f("",!0),e.citation.referringUrl?(y(),p("span",Ur,[b("a",{target:"_blank",rel:"noreferrer noopener",href:e.citation.referringUrl.toString()},"Hier gefunden",8,["href"]),Ir])):f("",!0),e.citation.archiveUrl?(y(),p("span",xr,[b("a",{target:"_blank",rel:"noreferrer noopener",href:e.citation.archiveUrl.toString()},"Web Archiv Kopie",8,["href"]),Gr])):f("",!0),e.citation.localCopy?(y(),p("span",Nr,[b("a",{target:"_blank",rel:"noreferrer noopener",href:"/sources/"+e.citation.localCopy},"Kopie",8,["href"]),_r])):f("",!0)])};var Kr=d({components:{Citation:Wr},setup(){const e=Ar();return{store:e,game:D((()=>e.state.game))}},data:()=>({selectedTable:"laws",lawsSortCol:"state",lawsSortDir:1,eventsSortCol:"probability",eventsSortDir:-1,lawSelected:void 0,eventSelected:void 0,paramSelected:void 0}),methods:{sortLaws(e){e===this.lawsSortCol?this.lawsSortDir=this.lawsSortDir>0?-1:1:this.lawsSortDir=1,this.lawsSortCol=e},sortEvents(e){e===this.eventsSortCol?this.eventsSortDir=this.eventsSortDir>0?-1:1:this.eventsSortDir=1,this.eventsSortCol=e},selectLaw(e){this.unselect(),this.lawSelected=e},selectEvent(e){this.unselect(),this.eventSelected=e},selectParam(e){this.unselect(),this.paramSelected=e},unselect(){this.lawSelected=void 0,this.eventSelected=void 0,this.paramSelected=void 0}},computed:{startYearOfSelected(){if(!this.lawSelected||!this.game)return 2021;const e=this.game.acceptedLaws.find((e=>e.lawId===this.lawSelected));return e?e.effectiveSince:2021},selectedLaw(){return yi.find((e=>e.id===this.lawSelected))},selectedEvent(){return Fi.find((e=>e.id===this.eventSelected))},selectedParam(){return this.paramSelected?dt[this.paramSelected]:void 0},wParam(){const e=this.selectedParam;return e instanceof ve?e:void 0},cParam(){const e=this.selectedParam;return e instanceof we?e:void 0},citationsOfLaw(){return this.selectedLaw&&this.selectedLaw.citations?this.selectedLaw.citations:[]},effectsOfSelected(){if(!this.lawSelected||!this.game)return[];this.game;const e=this.selectedLaw;return e?e.effects(this.game,this.startYearOfSelected,this.game.currentYear):[]},sortedValues(){return this.game?Dr(this.game,this.effectsOfSelected):[]},sortedLaws(){return this.game?function(e,t,i,n){const r=e.proposedLaws,a=e.acceptedLaws.map((e=>e.lawId)),s=e.rejectedLaws;return n.map((t=>{return{id:t.id,priority:t.priority(e),state:(i=t.id,a.includes(i)?"a":r.includes(i)?"p":s.includes(i)?"r":"x")};var i})).sort(((e,n)=>zr(e,n,t,"id")*i)).map((e=>o(l({},e),{priority:e.priority.toFixed(2)})))}(this.game,this.lawsSortCol,this.lawsSortDir,yi):[]},sortedEvents(){return this.game?(e=this.game,t=this.eventsSortCol,i=this.eventsSortDir,Fi.map((t=>({id:t.id,probability:t.probability(e)}))).sort(((e,n)=>zr(e,n,t,"id")*i)).map((e=>o(l({},e),{probability:(100*e.probability).toFixed(2)})))):[];var e,t,i}}});const jr=w("data-v-7bb3c05c");g("data-v-7bb3c05c");const Hr={class:"peekData"},Zr={key:0,class:"Details"},Jr={class:"Title"},Rr={class:"Description"},$r=b("div",{class:"SectionHead"},"Details:",-1),Qr=b("div",{class:"SectionHead"},"Internes:",-1),qr=b("div",{class:"SectionHead"},"Referenzen:",-1),Yr={key:1,class:"Details"},Xr={class:"Title"},ea={class:"Description"},ta=b("div",{class:"SectionHead"},"Details:",-1),ia=b("div",{class:"SectionHead"},"Internes:",-1),na=b("div",{class:"SectionHead"},"Referenzen:",-1),ra={key:2,class:"Details"},aa={class:"Title"},sa={key:0},la={key:1},oa={key:2},ua=b("div",{class:"SectionHead"},"Details:",-1),ca=b("div",{class:"SectionHead"},"Internes:",-1),da=b("div",{class:"SectionHead"},"Referenzen:",-1),ha={class:"paramsList"},ga={class:"numbercol"},ma={class:"effcol"},pa={class:"buttonlist"},ba={class:"lawList"},fa={key:0},va={class:"priocol"},wa={class:"eventList"},ya={key:0},ka={class:"priocol"};m();const Sa=jr(((e,t,i,n,r,a)=>{var s;const l=A("Citation");return y(),p("details",Hr,[b("summary",{onClick:t[1]||(t[1]=t=>e.unselect()),class:"clickable"},"Peek"),e.selectedLaw?(y(),p("div",Zr,[b("div",Jr,v(e.selectedLaw.title),1),b("div",Rr,v(e.selectedLaw.description),1),$r,b("div",{class:"Section",innerHTML:e.selectedLaw.details},null,8,["innerHTML"]),Qr,b("div",{class:"Section",innerHTML:e.selectedLaw.internals},null,8,["innerHTML"]),qr,(y(!0),p(k,null,S(e.citationsOfLaw,((e,t)=>(y(),p(l,{class:"Section",key:t,citation:e},null,8,["citation"])))),128))])):f("",!0),e.selectedEvent?(y(),p("div",Yr,[b("div",Xr,v(e.selectedEvent.title),1),b("div",ea,v(e.selectedEvent.description),1),ta,b("div",{class:"Section",innerHTML:e.selectedEvent.details},null,8,["innerHTML"]),ia,b("div",{class:"Section",innerHTML:e.selectedEvent.internals},null,8,["innerHTML"]),na,(y(!0),p(k,null,S(null==(s=e.selectedEvent)?void 0:s.citations,((e,t)=>(y(),p(l,{class:"Section",key:t,citation:e},null,8,["citation"])))),128))])):f("",!0),e.selectedParam?(y(),p("div",ra,[b("div",aa,v(e.paramSelected)+" ["+v(e.selectedParam.unit)+"]",1),e.wParam?(y(),p("div",sa,"Initial value: "+v(e.wParam.initialValue)+" "+v(e.wParam.unit),1)):f("",!0),e.cParam&&e.cParam.shouldInitiallyBe?(y(),p("div",la," Should initially be: "+v(e.cParam.shouldInitiallyBe)+" "+v(e.cParam.unit),1)):f("",!0),e.cParam?(y(),p("div",oa," Calculation: "+v(e.cParam.valueGetter),1)):f("",!0),ua,b("div",{class:"Section",innerHTML:e.selectedParam.details},null,8,["innerHTML"]),ca,b("div",{class:"Section",innerHTML:e.selectedParam.internals},null,8,["innerHTML"]),da,(y(!0),p(k,null,S(e.selectedParam.citations,((e,t)=>(y(),p(l,{class:"Section",key:t,citation:e},null,8,["citation"])))),128))])):f("",!0),b("div",ha,[b("table",null,[(y(!0),p(k,null,S(e.sortedValues,(t=>(y(),p("tr",{key:t.id,class:["clickable",t.class],onClick:i=>e.selectParam(t.id)},[b("td",null,v(t.id),1),b("td",ga,v(t.value),1),b("td",ma,v(t.effect),1),b("td",null,v(t.unit),1)],10,["onClick"])))),128))])]),b("div",null,[b("table",pa,[b("tr",null,[b("td",{class:["clickable lawButton",e.selectedTable],onClick:t[2]||(t[2]=t=>e.selectedTable="laws")},"Laws",2),b("td",{class:["clickable eventButton",e.selectedTable],onClick:t[3]||(t[3]=t=>e.selectedTable="events")},"Events",2)])]),b("div",ba,["laws"===e.selectedTable?(y(),p("table",fa,[b("tr",null,[b("th",{onClick:t[4]||(t[4]=t=>e.sortLaws("state")),class:"clickable"},"S"),b("th",{onClick:t[5]||(t[5]=t=>e.sortLaws("id")),class:"clickable"},"ID"),b("th",{onClick:t[6]||(t[6]=t=>e.sortLaws("priority")),class:"clickable priocol"},"Priority")]),(y(!0),p(k,null,S(e.sortedLaws,(t=>(y(),p("tr",{key:t.id,class:["clickable",t.state],onClick:i=>e.selectLaw(t.id)},[b("td",null,v(t.state),1),b("td",null,v(t.id),1),b("td",va,v(t.priority),1)],10,["onClick"])))),128))])):f("",!0)]),b("div",wa,["events"===e.selectedTable?(y(),p("table",ya,[b("tr",null,[b("th",{onClick:t[7]||(t[7]=t=>e.sortEvents("id")),class:"clickable"},"ID"),b("th",{onClick:t[8]||(t[8]=t=>e.sortEvents("probability")),class:"clickable priocol"},"Probability")]),(y(!0),p(k,null,S(e.sortedEvents,(t=>(y(),p("tr",{key:t.id,class:"clickable",onClick:i=>e.selectEvent(t.id)},[b("td",null,v(t.id),1),b("td",ka,v(t.probability),1)],8,["onClick"])))),128))])):f("",!0)])])])}));Kr.render=Sa,Kr.__scopeId="data-v-7bb3c05c";var Aa=d({components:{PeekInside:Kr},setup:()=>({store:Ar(),devMode:"true"===localStorage.getItem("devMode")}),methods:{updateStyle(){const e=window.innerHeight,t=window.innerWidth,i=Math.min(e/800,t/1e3),n=(t-1e3*i)/2;document.documentElement.style.setProperty("--scale",`${i}`),document.documentElement.style.setProperty("--translateX",`${n}px`)}},mounted(){setTimeout(this.updateStyle,0),window.addEventListener("resize",this.updateStyle)}});const Pa={class:"perspective"},za={class:"peek"};Aa.render=function(e,t,i,n,r,a){const s=A("router-view"),l=A("PeekInside");return y(),p(k,null,[b("div",Pa,[b(s)]),b("div",za,[e.devMode?(y(),p(l,{key:0})):f("",!0)])],64)};const Da=C(Aa);Da.use(Pr,Sr),Da.use(pr),Da.mount("#app");
