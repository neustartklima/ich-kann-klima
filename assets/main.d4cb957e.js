...
Anfangswert ist die deutsche Staatsverschuldung 2019.
  ...
  `},CO2PreisDebatte:{title:"Debatte über CO2-Preise",description:"Eine marktliberale Kampagne ist sehr erfolgreich darin, Dich als Verbots-Kanzler hinzustellen. Aus allen Richtungen prasseln Forderungen nach einem adäquaten CO2-Preis auf Dich ein. Nur leider gehen die Vorstellungen über den genauen Preis sehr weit auseinander.",laws:["CO2PreisErhoehen","WirksamerCO2Preis","VollerCO2Preis"],apply:()=>[],probability:e=>Pi(1,3,(Di(e,"AutosInInnenstaedtenVerbieten")?1:0)+(Di(e,"KohleverstromungEinstellen")?1:0)+(Di(e,"SolarAufAllenDaechernVerpflichtend")?1:0)+(Di(e,"Tempolimit130AufAutobahnen")?1:0)+(Di(e,"Tempolimit120AufAutobahnen")?1:0)+(Di(e,"Tempolimit100AufAutobahnen")?1:0))/100}}),Mi={currentYear:2021,values:wt,acceptedLaws:[],proposedLaws:[],rejectedLaws:[],events:[],actionCount:0,over:!1};function Ui(e=Mi,t=c()){return{id:t,currentYear:e.currentYear,acceptedLaws:e.acceptedLaws,proposedLaws:e.proposedLaws,rejectedLaws:e.rejectedLaws,values:yt(e.values),events:e.events,actionCount:e.actionCount,over:e.over}}function Ii(e,t=ki,i=Bi,n=Math.random){const r=function(e,t,i){const n=function(e,t){return t.map((t=>o(l({},t),{prob:t.probability(e)}))).filter((e=>e.prob>0))}(e,t),r=function(e){return e.filter((e=>e.prob>1)).reduce(((e,t)=>t.prob>((null==e?void 0:e.prob)||0)?t:e),void 0)}(n);if(r)return r;return function(e,t){for(const i of e)if((t-=i.prob)<0)return i;return}(function(e){const t=e.map((e=>e.prob)).reduce(((e,t)=>e+t),0),i=.6/t;return e.map((e=>o(l({},e),{prob:e.prob*i})))}(n),i())}(e,i,n);if(r){const t={id:r.id,occuredIn:e.currentYear,acknowledged:!1};e.events.unshift(t)}const a=function(e,t,i){const n=t=>{var i;return null==(i=e.acceptedLaws)?void 0:i.some((e=>e.lawId===t.id))},r=t=>{var i;return null==(i=e.rejectedLaws)?void 0:i.includes(t.id)},a=e=>{var t;return(null==(t=e.labels)?void 0:t.includes("hidden"))||!1},s=t=>({law:t,priority:t.priority(e)}),l=e=>({law:e.law,priority:e.priority+(i.includes(e.law.id)?100:0)});return t.filter(x(n)).filter(x(r)).filter(x(a)).map(s).filter((e=>e.priority>0)).map(l).sort(((e,t)=>t.priority-e.priority)).map((e=>e.law.id)).slice(0,6)}(e,t,(null==r?void 0:r.laws)?r.laws:[]);return e.proposedLaws=function(e,t){const i=[...e],n=t.filter((e=>i.includes(e))),r=t.filter((e=>!n.includes(e)));var a=0;for(;a<i.length;)n.includes(i[a])?a++:0!==r.length?(i[a]=r.shift(),a++):i.splice(a,1);return i.push(...r.slice(0,6-i.length)),i}(e.proposedLaws,a),e.actionCount++,r}function Gi(e){return Math.max(0,Math.min(100,e))}var xi=d({props:{law:{type:Object,required:!0},selectable:{type:Boolean,required:!0},numCards:{type:Number,required:!0}},setup:()=>({store:Pr()}),data:()=>({accepted:!1}),computed:o(l({},h(["proposedLaws"])),{zIndex(){return this.law.zIndex},transform(){return`rotate(${2*(this.law.pos-this.numCards/2)}deg) translate(${20*Math.abs(this.numCards/2-this.law.pos)}px, -50%)`}}),methods:{select(){this.$emit("selected")},accept(){this.accepted=!0},sendAccept(e){e.animationName.match(/^twistOut-/)&&this.$emit("accepted",this.law.id)}}});const Ni=w("data-v-c57832f8");g("data-v-c57832f8");const _i={key:0,type:"radio"},Ki={key:0,class:"button-bar"};m();const ji=Ni(((e,t,i,n,r,a)=>(y(),b("div",{class:["Law",{accepted:e.accepted}],style:{zIndex:e.zIndex},onClick:t[2]||(t[2]=(...t)=>e.select&&e.select(...t)),onAnimationend:t[3]||(t[3]=(...t)=>e.sendAccept&&e.sendAccept(...t))},[p("label",null,[e.selectable?(y(),b("input",_i)):f("",!0),p("div",null,[p("h3",null,v(e.law.title),1),p("div",null,v(e.law.description),1),e.selectable?(y(),b("div",Ki,[p("button",{class:"accept",onClick:t[1]||(t[1]=(...t)=>e.accept&&e.accept(...t))},"✓")])):f("",!0)])])],38))));xi.render=ji,xi.__scopeId="data-v-c57832f8";var Hi=d({components:{LawCard:xi},setup:()=>({store:Pr()}),data:()=>({zIndexes:[],poppedUp:!1}),computed:o(l({},h(["proposedLaws"])),{lawsToShow(){return this.zIndexes.length||(this.zIndexes=I(this.proposedLaws.length,0)),this.proposedLaws.map(((e,t)=>o(l({},e),{zIndex:this.zIndexes[t],pos:t})))}}),methods:{accept(e){this.store.dispatch("acceptLaw",{lawId:e})},select(e){this.zIndexes=I(this.proposedLaws.length,e)},sitOut(){this.store.dispatch("sitOut")}}});const Ji=w("data-v-290d8620")(((e,t,i,n,r,a)=>{const s=A("LawCard");return y(),b(k,null,[p("div",{class:["ProposedLaws",{poppedUp:e.poppedUp}],onClick:t[1]||(t[1]=t=>e.poppedUp=!0)},[(y(!0),b(k,null,S(e.lawsToShow,((t,i)=>(y(),b(s,{key:t.id,law:t,selectable:e.poppedUp,numCards:e.lawsToShow.length,onAccepted:()=>e.accept(t.id),onSelected:()=>e.select(i)},null,8,["law","selectable","numCards","onAccepted","onSelected"])))),128))],2),p("div",{class:"sitOutButton",onClick:t[2]||(t[2]=()=>e.sitOut())},"Aussitzen")],64)}));Hi.render=Ji,Hi.__scopeId="data-v-290d8620";var Zi=d({props:{title:String,text:String},methods:{acknowledge(){this.$emit("acknowledge")}}});const Ri=w("data-v-2df6be4d");g("data-v-2df6be4d");const $i={key:0};m();const Qi=Ri(((e,t,i,n,r,a)=>e.text?(y(),b("div",{key:0,onClick:t[1]||(t[1]=(...t)=>e.acknowledge&&e.acknowledge(...t))},[e.title?(y(),b("h2",$i,v(e.title),1)):f("",!0),p("p",null,v(e.text),1)])):f("",!0)));Zi.render=Qi,Zi.__scopeId="data-v-2df6be4d";var qi=d({props:{title:{type:String,required:!0},value:{type:Number,required:!0},zoom:{type:Number,default:1}},computed:{titleStyle(){return{fontSize:.5*this.zoom+"em"}},progressBarStyle(){return{width:50*this.zoom+"px",height:5*this.zoom+"px"}},indicatorStyle(){const e=this.value>40?"green":this.value>20?"goldenrod":"red";return{width:this.value+"%",backgroundColor:e}}}});const Yi=w("data-v-37cfebf9");g("data-v-37cfebf9");const Xi={class:"container"};m();const en=Yi(((e,t,i,n,r,a)=>(y(),b("div",Xi,[p("div",{class:"title",style:e.titleStyle},v(e.title),5),p("div",{class:"progress-bar",style:e.progressBarStyle},[p("div",{class:"indicator",style:e.indicatorStyle},null,4)],4)]))));qi.render=en,qi.__scopeId="data-v-37cfebf9";var tn=d({props:{value:{type:Number,required:!0}},components:{IndicatorBar:qi},computed:{isShort(){return this.value<20},isLess(){return this.value>=20&&this.value<50},isMore(){return this.value>=50&&this.value<80},isMuch(){return this.value>=80}}});const nn=w("data-v-791f01dd");g("data-v-791f01dd");const rn={id:"finances"},an={key:0,src:"/assets/money-short.7ce9dbed.png",id:"short"},sn={key:1,src:"/assets/money-less.c10d45f8.png",id:"less"},ln={key:2,src:"/assets/money-more.a1c17d8d.png",id:"more"},on={key:3,src:"/assets/money-much.ad651475.png",id:"much"};m();const un=nn(((e,t,i,n,r,a)=>{const s=A("IndicatorBar");return y(),b("div",rn,[p(s,{title:"Finanzen",value:e.value,zoom:.9},null,8,["value","zoom"]),e.isShort?(y(),b("img",an)):f("",!0),e.isLess?(y(),b("img",sn)):f("",!0),e.isMore?(y(),b("img",ln)):f("",!0),e.isMuch?(y(),b("img",on)):f("",!0)])}));tn.render=un,tn.__scopeId="data-v-791f01dd";var cn=d({props:{value:{type:Number,required:!0}},components:{IndicatorBar:qi},computed:{areHappy(){return this.value>=50},areAngry(){return this.value<50}}});const dn=w("data-v-e5acad4c");g("data-v-e5acad4c");const hn={id:"popularity"},gn={key:0,src:"/assets/people-happy.1e9e529c.png",id:"happy"},mn={key:1,src:"/assets/people-angry.495e0425.png",id:"angry"};m();const bn=dn(((e,t,i,n,r,a)=>{const s=A("IndicatorBar");return y(),b("div",hn,[p(s,{title:"Beliebtheit",value:e.value,zoom:2.8,style:{margin:"-80px 0 0 200px"}},null,8,["value","zoom"]),e.areHappy?(y(),b("img",gn)):f("",!0),e.areAngry?(y(),b("img",mn)):f("",!0)])}));cn.render=bn,cn.__scopeId="data-v-e5acad4c";var pn=d({data:()=>({levels:{healthy:"/assets/plant-healthy.1c912fd2.png",sick:"/assets/plant-sick.05726ebf.png",withered:"/assets/plant-withered.2d8ffb21.png"}}),props:{value:{type:Number,required:!0}},components:{IndicatorBar:qi},computed:{status(){return this.value>66?"healthy":this.value>33?"sick":"withered"},imgSrc(){return this.levels[this.status]}}});const fn=w("data-v-8ae17ad2");g("data-v-8ae17ad2");const vn={id:"plant"};m();const wn=fn(((e,t,i,n,r,a)=>{const s=A("IndicatorBar");return y(),b("div",vn,[p(s,{title:"CO2-Budget",value:e.value,zoom:2.5,style:{margin:"-50px 0 0 60px"}},null,8,["value","zoom"]),p("img",{src:e.imgSrc,id:e.status},null,8,["src","id"])])}));pn.render=wn,pn.__scopeId="data-v-8ae17ad2";var yn=d({props:{year:Number}});const kn=w("data-v-38fe5c52");g("data-v-38fe5c52");const Sn={id:"calendar"};m();const An=kn(((e,t,i,n,r,a)=>(y(),b("div",Sn,v(e.year),1))));yn.render=An,yn.__scopeId="data-v-38fe5c52";var Pn=d({});const zn=w("data-v-5952ab5a");g("data-v-5952ab5a");const Dn={id:"heater"},Wn=p("img",{src:"/assets/heater.5a77e425.png"},null,-1);m();const Tn=zn(((e,t,i,n,r,a)=>(y(),b("div",Dn,[Wn]))));Pn.render=Tn,Pn.__scopeId="data-v-5952ab5a";var Vn=d({});const Ln=w("data-v-3902beeb");g("data-v-3902beeb");const On={id:"table"},Cn=p("img",{src:"/assets/table-top.c87bd2fd.png",id:"table-top"},null,-1),En=p("img",{src:"/assets/table-front.78c0f8c6.png",id:"table-front"},null,-1),Fn=p("img",{src:"/assets/table-front.78c0f8c6.png",id:"table-back"},null,-1),Bn=p("img",{src:"/assets/table-side.49774a53.png",id:"table-left-side"},null,-1),Mn=p("img",{src:"/assets/table-side.49774a53.png",id:"table-right-side"},null,-1);m();const Un=Ln(((e,t,i,n,r,a)=>(y(),b("div",On,[Cn,En,Fn,Bn,Mn]))));Vn.render=Un,Vn.__scopeId="data-v-3902beeb";var In=d({props:{withNews:Boolean}}),Gn="/assets/board-side.d7181ded.png",xn="/assets/tvset-legs.78b387df.png";const Nn=w("data-v-118e7bdf");g("data-v-118e7bdf");const _n={id:"tvset"},Kn=p("div",{id:"board"},[p("img",{id:"board-front",src:"/assets/board-front.41330f02.png"}),p("img",{id:"board-left",src:Gn}),p("img",{id:"board-right",src:Gn}),p("div",{id:"board-top"})],-1),jn={id:"tv"},Hn=p("img",{id:"tv-front",src:"/assets/tv-front.82df5c0c.png"},null,-1),Jn={key:0,id:"news",src:"/assets/news.c4bbc2d0.png"},Zn=p("div",{id:"legs"},[p("img",{id:"legs-front",src:xn}),p("img",{id:"legs-back",src:xn})],-1);m();const Rn=Nn(((e,t,i,n,r,a)=>(y(),b("div",_n,[Kn,p("div",jn,[Hn,e.withNews?(y(),b("img",Jn)):f("",!0)]),Zn]))));In.render=Rn,In.__scopeId="data-v-118e7bdf";const $n=[{id:"start",title:"Stell dir vor...",text:G`
      ### ... du bist Politiker.
    ...
    `},{id:"room",title:"Dein Arbeitszimmer",text:"Dies ist das Zimmer, in dem Du arbeitest und Entscheidungen triffst."},{id:"desk",title:"Dein Schreibtisch",text:"Du sitzt an Deinem Schreibtisch und findest dort immer wieder Gesetzesvorhaben, unter denen du auswählen musst.",highlight:"table"},{id:"finances",title:"Die Staatsfinanzen",text:"Auf Deinem Schreibtisch siehst Du, wie viel Geld der Staat noch hat, um Deine Entscheidungen umzusetzen.",highlight:"finances"},{id:"popularity",title:"Die Wähler",text:"Wenn Du aus dem Fenster schaust, siehst Du, in welcher Stimmung Deine Wähler sind.",highlight:"popularity"},{id:"climate",title:"Das Klima",text:"Die Pflanze in der Ecke zeigt Dir, wie sich das Klima entwickelt.",highlight:"plant"}];var Qn={};const qn=w("data-v-2419943a");g("data-v-2419943a");const Yn={class:"dialog"},Xn={class:"buttons"};m();const er=qn(((e,t,i,n,r,a)=>(y(),b("div",Yn,[P(e.$slots,"default",{},void 0,!0),p("div",Xn,[P(e.$slots,"buttons",{},void 0,!0)])]))));Qn.render=er,Qn.__scopeId="data-v-2419943a";var tr=d({setup(){const e=Pr();return e.dispatch("setupTour"),{store:e}},components:{Dialog:Qn},mounted(){this.setHighlight(this.currentStep)},computed:{currentStep(){return $n.find((e=>e.id===this.$store.state.tour.step))},title(){var e;return null==(e=this.currentStep)?void 0:e.title},text(){var e;return null==(e=this.currentStep)?void 0:e.text}},watch:{currentStep(e){this.setHighlight(e)}},methods:{setHighlight(e){var t;const i=document.querySelector(".highlighted");i&&i.classList.remove("highlighted"),e&&e.highlight&&(null==(t=document.querySelector(`#${e.highlight}`))||t.classList.add("highlighted"))},next(){this.$store.dispatch("nextTourStep")},stop(){this.$store.dispatch("stopTour")}}});tr.render=function(e,t,i,n,r,a){const s=A("Dialog");return e.title&&e.text?(y(),b(s,{key:0},{buttons:z((()=>[p("button",{onClick:t[1]||(t[1]=(...t)=>e.stop&&e.stop(...t))},"Tour beenden"),p("button",{onClick:t[2]||(t[2]=(...t)=>e.next&&e.next(...t))},"Weiter")])),default:z((()=>[p("h2",null,v(e.title),1),p("div",{innerHTML:e.text},null,8,["innerHTML"])])),_:1})):f("",!0)};var ir=d({components:{Calendar:yn,ClimateIndicator:pn,Heater:Pn,LawProposals:Hi,SpeechBubble:Zi,FinanceIndicator:tn,PopularityIndicator:cn,Table:Vn,Tour:tr,TVSet:In},data:()=>({store:Pr()}),computed:{eventToShow(){var e;const t=(null==(e=this.store.state.game)?void 0:e.events)||[];if(0===t.length)return;const i=t[0];return i.acknowledged?void 0:Bi.find((e=>e.id===i.id))},eventTitle(){var e;return(null==(e=this.eventToShow)?void 0:e.title)||""},eventText(){var e;return(null==(e=this.eventToShow)?void 0:e.description)||""},currentYear(){var e;return(null==(e=this.store.state.game)?void 0:e.currentYear)||2021},finance(){const e=this.store.state.game;return e?function(e){return Gi(100-e.values.stateDebt/wt.stateDebt*50)}(e):0},popularity(){var e;return(null==(e=this.store.state.game)?void 0:e.values.popularity)||100},climate(){const e=this.store.state.game;return e?function(e){return 0===e.values.co2emissions?100:Gi(e.values.co2budget*yt(wt).co2emissions/wt.co2budget/e.values.co2emissions*50)}(e):0}},methods:{acknowledge(){this.$store.dispatch("acknowledgeEvent",this.eventToShow)}}});const nr={class:"game-setup"},rr=p("h1",null,"#ich-kann-klima",-1),ar=p("div",{id:"walls"},[p("div",{id:"wall-back"}),p("div",{id:"wall-left"}),p("div",{id:"wall-right"})],-1);ir.render=function(e,t,i,n,r,a){const s=A("Calendar"),l=A("Heater"),o=A("PopularityIndicator"),u=A("TVSet"),c=A("ClimateIndicator"),d=A("Table"),h=A("FinanceIndicator"),g=A("LawProposals"),m=A("SpeechBubble"),f=A("Tour");return y(),b("div",nr,[rr,ar,p(s,{year:e.currentYear},null,8,["year"]),p(l),p(o,{value:e.popularity},null,8,["value"]),p(u,{"with-news":!!e.eventText},null,8,["with-news"]),p(c,{value:e.climate},null,8,["value"]),p(d),p(h,{value:e.finance},null,8,["value"]),p(g),p(m,{title:e.eventTitle,text:e.eventText,onAcknowledge:e.acknowledge},null,8,["title","text","onAcknowledge"]),p(f)])};var sr=d({setup(){const e=Pr();return{store:e,acceptedLaws:D((()=>{var t;return null==(t=e.state.game)?void 0:t.acceptedLaws}))}},data:()=>({opened:void 0}),computed:{visibleAccepted(){return ki.filter((e=>{var t,i;return(null==(t=this.acceptedLaws)?void 0:t.some((t=>t.lawId===e.id)))&&!(null==(i=e.labels)?void 0:i.includes("hidden"))}))}},methods:{toggleOpen(e){this.opened=this.opened===e?void 0:e}}});const lr=w("data-v-aace6332")(((e,t,i,n,r,a)=>(y(!0),b(k,null,S(e.visibleAccepted,((t,i)=>(y(),b("div",{key:i,class:["Law",{opened:i===e.opened}],onClick:t=>e.toggleOpen(i)},[p("h3",null,v(t.title),1),p("div",null,v(t.description),1)],10,["onClick"])))),128))));sr.render=lr,sr.__scopeId="data-v-aace6332";var or=d({components:{GameSetup:ir,AcceptedLaws:sr},setup:()=>({store:Pr()}),methods:{startGame(e){e?this.store.dispatch("loadGame",{gameId:e}):this.store.dispatch("startGame",void 0)}},beforeRouteEnter(e,t,i){i((t=>t.startGame(e.params.id)))}});const ur=w("data-v-3637ce73")(((e,t,i,n,r,a)=>{const s=A("GameSetup");return y(),b(s)}));or.render=ur,or.__scopeId="data-v-3637ce73";var cr=d({components:{Dialog:Qn},setup:()=>({store:Pr()}),computed:{co2(){var e,t;const i=null==(e=this.store.state.game)?void 0:e.values.co2budget;return(null==(t=this.store.state.game)?void 0:t.values.co2emissions)>0?i>0?"sind weiterhin vorhanden, aber zumindest ist das Budget noch nicht aufgebraucht, dein:e Nachfolger:in hat vielleicht noch eine Chance.":"sind explodiert, das Budget ist aufgebraucht. Hätte die AfD nicht besser hinbekommen.":i>0?"hast du im Griff! Es verbleibt sogar noch ein Rest-CO2-Budget, Gratulation!":"hast du gerade noch rechtzeitig ausreichend senken können. Punktlandung."},debt(){var e;return(null==(e=this.store.state.game)?void 0:e.values.stateDebt)<1e3?"sind ausgeglichen. Die Stabilitätskriterien werden eingehalten.":"sind dir leider aus dem Ruder gelaufen."},popularity(){var e;const t=null==(e=this.store.state.game)?void 0:e.values.popularity;return t<20?"entspricht dem, was man von einem langhährigen Diktator erwarten kann.":t<50?"ist nicht berauschend, wiedergewählt würdest du wohl eher nicht.":t<80?"reicht aus, dass du noch länger am Ruder bleiben könntest. Gratulation!":"ist völlig unglaubwürdig - war das wirklich eine freie Wahl?"}},methods:{loadGame(e){this.store.dispatch("loadGame",{gameId:e})},newGame(){this.$router.push("/games")}},beforeRouteEnter(e,t,i){i((t=>{t.loadGame(e.params.id)}))}});const dr=p("h2",null,"Das Spiel ist leider zu Ende",-1),hr=p("p",null,"Deine Entscheidungen haben etwas verändert - soviel kann man sagen.",-1),gr=p("p",null,"Gar nicht so einfach, Politiker zu sein, oder?",-1),mr={class:"button-bar"};cr.render=function(e,t,i,n,r,a){const s=A("Dialog");return y(),b(s,null,{default:z((()=>[dr,hr,p("ul",null,[p("li",null,"Die CO2-Emmissionen "+v(e.co2),1),p("li",null,"Die Staatsfinanzen "+v(e.debt),1),p("li",null,"Deine Beliebtheit "+v(e.popularity),1)]),gr,p("div",mr,[p("button",{onClick:t[1]||(t[1]=(...t)=>e.newGame&&e.newGame(...t))},"Neuer Versuch")])])),_:1})};const br=[{path:"/",redirect:"/games"},{path:"/games",component:or},{path:"/games/:id",component:or},{path:"/games/:id/over",component:cr}],pr=W({history:T(),routes:br});const fr=function(e,t){let i,n=[];async function r(){if(i&&(clearTimeout(i),i=void 0),n.length){const{method:s,path:l,data:o,retry:u,resolve:c,reject:d}=n[0];try{if((null==t?void 0:t.navigator)&&!(null==t?void 0:t.navigator.onLine))throw Error("Browser is offline");const i=await e(s,l,o);n.shift(),c(i)}catch(a){u?n[0].retry=Math.max(-1,u-1):(n.shift(),d(a))}n.length&&(i=setTimeout(r,(null==t?void 0:t.timeout)||1e4))}}return{add:(e,t,a,s=-1)=>new Promise(((l,o)=>{n.push({method:e,path:t,data:a,retry:s,resolve:l,reject:o}),i||r()})),remove(e,t){n=n.filter((i=>i.method.toLowerCase()!==e.toLowerCase()||i.path!==t))},callsPending:()=>n.length>0}}(function(e,t,i=console){return async function(n,r,a){var s;try{const i={method:n};["post","put","patch"].includes(n)&&(i.body=JSON.stringify(a),i.headers={"content-type":"application/json"});const l=await t(e+r,i),o=(null==(s=l.headers.get("Content-Type"))?void 0:s.match(/json/))?await l.json():await l.text();if(l.ok)return o;throw Error(o.message||o)}catch(l){throw i.error(l),l}}}("https://api.ich-kann-klima.de/api",fetch));var vr;const wr=function({api:e,logger:t=console,storage:i=localStorage}){return{async createGame(n){i.setItem("game",JSON.stringify(n));try{e.createGame(n)}catch(r){t.warn("Cannot save new game - trying again later",r)}return n},async loadGame(t){const n=i.getItem("game");if(n){const e=JSON.parse(n);if(e.id===t)return Ui(e,t)}return Ui(await e.loadGame(t),t)},async saveGame(n){i.setItem("game",JSON.stringify(n));try{e.saveGame(n)}catch(r){t.warn("save on server failed - at least the game is saved in localStorage, so you can save it maybe next time",r)}},async decisionMade(t,i,n){e.decisionMade(t.id,i,n)},async eventOccurred(t,i){e.eventOccurred(t.id,i.id)}}}({api:(vr=fr,{createGame:e=>vr.add("post","/games",e),loadGame:e=>vr.add("get","/games/"+e,void 0,0),saveGame:e=>(vr.remove("put","/games/"+e.id),vr.add("put","/games/"+e.id,e)),decisionMade:(e,t,i)=>vr.add("post","/games/"+e+"/decisions/"+t,{accepted:i}),eventOccurred:(e,t)=>vr.add("post","/games/"+e+"/events/"+t)})}),yr={async startGame(e){const t=function(e=ki,t=Mi){const i=Ui(t);return i.acceptedLaws=e.filter((e=>{var t;return null==(t=e.labels)?void 0:t.includes("initial")})).map((e=>({lawId:e.id,effectiveSince:i.currentYear}))),i}(),i=Ii(t);await wr.createGame(t),e.commit("setGameState",{game:t}),e.dispatch("applyEvent",{event:i}),pr.push("/games/"+t.id)},async loadGame(e,t){try{const i=await wr.loadGame(t.gameId);await wr.saveGame(i),pr.push("/games/"+i.id),e.commit("setGameState",{game:i})}catch(i){e.dispatch("error",{error:i})}},gameOver(e){var t;e.commit("gameOver",void 0),pr.push("/games/"+(null==(t=e.state.game)?void 0:t.id)+"/over")},async acceptLaw(e,t){const i=l({},e.state.game),n={lawId:t.lawId,effectiveSince:i.currentYear+1},r=Si(n),a=r.removeLawsWithLabels,s=i.acceptedLaws.map(Si).filter((e=>!(null==a?void 0:a.some((t=>{var i;return null==(i=e.labels)?void 0:i.includes(t)}))))).map((e=>({lawId:e.id,effectiveSince:e.effectiveSince})));i.acceptedLaws=[...s,n];const o=Ii(i);await wr.saveGame(i),e.commit("setGameState",{game:i}),e.dispatch("applyEvent",{event:o}),await wr.decisionMade(i,r.id,!0)},async rejectLaw(e,t){const i=l({},e.state.game);i.rejectedLaws=[...i.rejectedLaws,t.lawId],await wr.decisionMade(i,t.lawId,!1),await wr.saveGame(i),e.commit("setGameState",{game:i})},async sitOut(e){const t=l({},e.state.game);await wr.decisionMade(t,"sitOut",!0);const i=Ii(t);await wr.saveGame(t),e.commit("setGameState",{game:t}),e.dispatch("applyEvent",{event:i})},async advanceYear(e){const t=l({},e.state.game),i=t.acceptedLaws.map(Si);t.currentYear++,t.values=function(e,t,i){const n=yt(e.values);return t.sort(((e,t)=>{var i,n;return(null==(i=e.treatAfterLabels)?void 0:i.some((e=>{var i;return null==(i=t.labels)?void 0:i.includes(e)})))?1:(null==(n=t.treatAfterLabels)?void 0:n.some((t=>{var i;return null==(i=e.labels)?void 0:i.includes(t)})))?-1:0})).forEach((t=>{const r=t.effects(o(l({},e),{values:n}),t.effectiveSince,i);Pt({dispatch:()=>{},values:n},r)})),n.co2budget-=n.co2emissions,n}(t,i,t.currentYear),await wr.saveGame(t),e.commit("setGameState",{game:t})},async applyEvent(e,t){if(!t.event)return;const i=l({},e.state.game);await wr.eventOccurred(i,t.event);const n=t.event.apply(i);e.dispatch("applyEffects",{changes:n})},acknowledgeEvent(e,t){const i=l({},e.state.game);i.events.find((e=>e.id===t.id)).acknowledged=!0,wr.saveGame(i),e.commit("setGameState",{game:i})},applyEffects(e,t){const i={dispatch:e.dispatch,values:yt(e.state.game.values)};Pt(i,t.changes);const n=o(l({},e.state.game),{values:i.values});wr.saveGame(n),e.commit("setGameState",{game:n})},setupTour(e){const t=localStorage.getItem("tour")||$n[0].id,i=$n.find((e=>t===e.id));i?e.commit("setTour",{step:i.id,active:!0}):yr.stopTour(e)},nextTourStep(e){const t=$n.findIndex((t=>e.state.tour.step===t.id));if(t<0||t==$n.length-1)yr.stopTour(e);else{const i=$n[t+1];e.commit("setTour",{step:i.id,active:!0}),localStorage.setItem("tour",i.id)}},stopTour(e){e.commit("setTour",{step:"",active:!1}),localStorage.setItem("tour","completed")},async error(e,t){e.commit("error",t)}},kr={setGameState(e,t){e.game=t.game},gameOver(e){e.game=o(l({},e.game),{over:!0})},setTour(e,t){e.tour=t},error(e,t){console.error(t.error),alert(t.error.message)}},Sr={proposedLaws:e=>e.game&&e.game.proposedLaws?Ai(e.game.proposedLaws):[]},Ar=Symbol();function Pr(){return V(Ar)}const zr=L({state:{game:void 0,tour:{active:!0,step:"start"}},mutations:kr,actions:yr,getters:Sr});function Dr(e,t,...i){for(const n of i){if(e[n]<t[n])return-1;if(e[n]>t[n])return 1}return 0}function Wr(e,t){const i=yt(e.values);function n(e){return(e>0?"+":"")+e.toFixed(2)}function r(r){const a=function(e){const i=t.find((t=>"modify"===t.type&&t.name===e));return i&&i.condition?i.value:0}(r),s=i[r]-e.values[r];return a&&Math.abs(a-s)<.001?n(a):a?n(a)+" / "+n(s):0!=s?n(s):""}Pt({dispatch:()=>{},values:i},t);return vt.map((t=>{return{id:t.name,unit:t.unit,value:(i=t.name,e.values[i].toFixed(2)),effect:r(t.name),class:t.writable?"writable":"calculated"};var i}))}var Tr=d({props:{citation:{type:Object,required:!0},showInternals:{type:Boolean,default:!1}},computed:{href(){return this.citation.url.toString()},title(){return this.citation.title||this.citation.url.toString()}}});const Vr={key:0},Lr=O(". "),Or={key:1},Cr={key:2},Er=O("Bemerkung: "),Fr=O(". "),Br={key:3},Mr=O("Internes: "),Ur=O(". "),Ir={key:4},Gr=O(". "),xr={key:5},Nr=O(". "),_r={key:6},Kr=O(". ");Tr.render=function(e,t,i,n,r,a){return y(),b("p",null,[e.citation.authors?(y(),b("span",Vr,v(e.citation.authors+e.citation.dateString())+". ",1)):f("",!0),p("a",{target:"_blank",rel:"noreferrer noopener",href:e.href},'"'+v(e.title)+'"',9,["href"]),Lr,e.citation.publisher?(y(),b("span",Or,v(e.citation.publisher)+". ",1)):f("",!0),e.citation.comment?(y(),b("span",Cr,[Er,p("span",{innerHTML:e.citation.comment},null,8,["innerHTML"]),Fr])):f("",!0),e.showInternals&&e.citation.internalComment?(y(),b("span",Br,[Mr,p("span",{innerHTML:e.citation.internalComment},null,8,["innerHTML"]),Ur])):f("",!0),e.citation.referringUrl?(y(),b("span",Ir,[p("a",{target:"_blank",rel:"noreferrer noopener",href:e.citation.referringUrl.toString()},"Hier gefunden",8,["href"]),Gr])):f("",!0),e.citation.archiveUrl?(y(),b("span",xr,[p("a",{target:"_blank",rel:"noreferrer noopener",href:e.citation.archiveUrl.toString()},"Web Archiv Kopie",8,["href"]),Nr])):f("",!0),e.citation.localCopy?(y(),b("span",_r,[p("a",{target:"_blank",rel:"noreferrer noopener",href:"/sources/"+e.citation.localCopy},"Kopie",8,["href"]),Kr])):f("",!0)])};var jr=d({components:{Citation:Tr},setup(){const e=Pr();return{store:e,game:D((()=>e.state.game))}},data:()=>({selectedTable:"laws",lawsSortCol:"state",lawsSortDir:1,eventsSortCol:"probability",eventsSortDir:-1,lawSelected:void 0,eventSelected:void 0,paramSelected:void 0}),methods:{sortLaws(e){e===this.lawsSortCol?this.lawsSortDir=this.lawsSortDir>0?-1:1:this.lawsSortDir=1,this.lawsSortCol=e},sortEvents(e){e===this.eventsSortCol?this.eventsSortDir=this.eventsSortDir>0?-1:1:this.eventsSortDir=1,this.eventsSortCol=e},selectLaw(e){this.unselect(),this.lawSelected=e},selectEvent(e){this.unselect(),this.eventSelected=e},selectParam(e){this.unselect(),this.paramSelected=e},unselect(){this.lawSelected=void 0,this.eventSelected=void 0,this.paramSelected=void 0}},computed:{startYearOfSelected(){if(!this.lawSelected||!this.game)return 2021;const e=this.game.acceptedLaws.find((e=>e.lawId===this.lawSelected));return e?e.effectiveSince:2021},selectedLaw(){return ki.find((e=>e.id===this.lawSelected))},selectedEvent(){return Bi.find((e=>e.id===this.eventSelected))},selectedParam(){return this.paramSelected?ht[this.paramSelected]:void 0},wParam(){const e=this.selectedParam;return e instanceof we?e:void 0},cParam(){const e=this.selectedParam;return e instanceof ye?e:void 0},citationsOfLaw(){return this.selectedLaw&&this.selectedLaw.citations?this.selectedLaw.citations:[]},effectsOfSelected(){if(!this.lawSelected||!this.game)return[];this.game;const e=this.selectedLaw;return e?e.effects(this.game,this.startYearOfSelected,this.game.currentYear):[]},sortedValues(){return this.game?Wr(this.game,this.effectsOfSelected):[]},sortedLaws(){return this.game?function(e,t,i,n){const r=e.proposedLaws,a=e.acceptedLaws.map((e=>e.lawId)),s=e.rejectedLaws;return n.map((t=>{return{id:t.id,priority:t.priority(e),state:(i=t.id,a.includes(i)?"a":r.includes(i)?"p":s.includes(i)?"r":"x")};var i})).sort(((e,n)=>Dr(e,n,t,"id")*i)).map((e=>o(l({},e),{priority:e.priority.toFixed(2)})))}(this.game,this.lawsSortCol,this.lawsSortDir,ki):[]},sortedEvents(){return this.game?(e=this.game,t=this.eventsSortCol,i=this.eventsSortDir,Bi.map((t=>({id:t.id,probability:t.probability(e)}))).sort(((e,n)=>Dr(e,n,t,"id")*i)).map((e=>o(l({},e),{probability:(100*e.probability).toFixed(2)})))):[];var e,t,i}}});const Hr=w("data-v-7bb3c05c");g("data-v-7bb3c05c");const Jr={class:"peekData"},Zr={key:0,class:"Details"},Rr={class:"Title"},$r={class:"Description"},Qr=p("div",{class:"SectionHead"},"Details:",-1),qr=p("div",{class:"SectionHead"},"Internes:",-1),Yr=p("div",{class:"SectionHead"},"Referenzen:",-1),Xr={key:1,class:"Details"},ea={class:"Title"},ta={class:"Description"},ia=p("div",{class:"SectionHead"},"Details:",-1),na=p("div",{class:"SectionHead"},"Internes:",-1),ra=p("div",{class:"SectionHead"},"Referenzen:",-1),aa={key:2,class:"Details"},sa={class:"Title"},la={key:0},oa={key:1},ua={key:2},ca=p("div",{class:"SectionHead"},"Details:",-1),da=p("div",{class:"SectionHead"},"Internes:",-1),ha=p("div",{class:"SectionHead"},"Referenzen:",-1),ga={class:"paramsList"},ma={class:"numbercol"},ba={class:"effcol"},pa={class:"buttonlist"},fa={class:"lawList"},va={key:0},wa={class:"priocol"},ya={class:"eventList"},ka={key:0},Sa={class:"priocol"};m();const Aa=Hr(((e,t,i,n,r,a)=>{var s;const l=A("Citation");return y(),b("details",Jr,[p("summary",{onClick:t[1]||(t[1]=t=>e.unselect()),class:"clickable"},"Peek"),e.selectedLaw?(y(),b("div",Zr,[p("div",Rr,v(e.selectedLaw.title),1),p("div",$r,v(e.selectedLaw.description),1),Qr,p("div",{class:"Section",innerHTML:e.selectedLaw.details},null,8,["innerHTML"]),qr,p("div",{class:"Section",innerHTML:e.selectedLaw.internals},null,8,["innerHTML"]),Yr,(y(!0),b(k,null,S(e.citationsOfLaw,((e,t)=>(y(),b(l,{class:"Section",key:t,citation:e},null,8,["citation"])))),128))])):f("",!0),e.selectedEvent?(y(),b("div",Xr,[p("div",ea,v(e.selectedEvent.title),1),p("div",ta,v(e.selectedEvent.description),1),ia,p("div",{class:"Section",innerHTML:e.selectedEvent.details},null,8,["innerHTML"]),na,p("div",{class:"Section",innerHTML:e.selectedEvent.internals},null,8,["innerHTML"]),ra,(y(!0),b(k,null,S(null==(s=e.selectedEvent)?void 0:s.citations,((e,t)=>(y(),b(l,{class:"Section",key:t,citation:e},null,8,["citation"])))),128))])):f("",!0),e.selectedParam?(y(),b("div",aa,[p("div",sa,v(e.paramSelected)+" ["+v(e.selectedParam.unit)+"]",1),e.wParam?(y(),b("div",la,"Initial value: "+v(e.wParam.initialValue)+" "+v(e.wParam.unit),1)):f("",!0),e.cParam&&e.cParam.shouldInitiallyBe?(y(),b("div",oa," Should initially be: "+v(e.cParam.shouldInitiallyBe)+" "+v(e.cParam.unit),1)):f("",!0),e.cParam?(y(),b("div",ua," Calculation: "+v(e.cParam.valueGetter),1)):f("",!0),ca,p("div",{class:"Section",innerHTML:e.selectedParam.details},null,8,["innerHTML"]),da,p("div",{class:"Section",innerHTML:e.selectedParam.internals},null,8,["innerHTML"]),ha,(y(!0),b(k,null,S(e.selectedParam.citations,((e,t)=>(y(),b(l,{class:"Section",key:t,citation:e},null,8,["citation"])))),128))])):f("",!0),p("div",ga,[p("table",null,[(y(!0),b(k,null,S(e.sortedValues,(t=>(y(),b("tr",{key:t.id,class:["clickable",t.class],onClick:i=>e.selectParam(t.id)},[p("td",null,v(t.id),1),p("td",ma,v(t.value),1),p("td",ba,v(t.effect),1),p("td",null,v(t.unit),1)],10,["onClick"])))),128))])]),p("div",null,[p("table",pa,[p("tr",null,[p("td",{class:["clickable lawButton",e.selectedTable],onClick:t[2]||(t[2]=t=>e.selectedTable="laws")},"Laws",2),p("td",{class:["clickable eventButton",e.selectedTable],onClick:t[3]||(t[3]=t=>e.selectedTable="events")},"Events",2)])]),p("div",fa,["laws"===e.selectedTable?(y(),b("table",va,[p("tr",null,[p("th",{onClick:t[4]||(t[4]=t=>e.sortLaws("state")),class:"clickable"},"S"),p("th",{onClick:t[5]||(t[5]=t=>e.sortLaws("id")),class:"clickable"},"ID"),p("th",{onClick:t[6]||(t[6]=t=>e.sortLaws("priority")),class:"clickable priocol"},"Priority")]),(y(!0),b(k,null,S(e.sortedLaws,(t=>(y(),b("tr",{key:t.id,class:["clickable",t.state],onClick:i=>e.selectLaw(t.id)},[p("td",null,v(t.state),1),p("td",null,v(t.id),1),p("td",wa,v(t.priority),1)],10,["onClick"])))),128))])):f("",!0)]),p("div",ya,["events"===e.selectedTable?(y(),b("table",ka,[p("tr",null,[p("th",{onClick:t[7]||(t[7]=t=>e.sortEvents("id")),class:"clickable"},"ID"),p("th",{onClick:t[8]||(t[8]=t=>e.sortEvents("probability")),class:"clickable priocol"},"Probability")]),(y(!0),b(k,null,S(e.sortedEvents,(t=>(y(),b("tr",{key:t.id,class:"clickable",onClick:i=>e.selectEvent(t.id)},[p("td",null,v(t.id),1),p("td",Sa,v(t.probability),1)],8,["onClick"])))),128))])):f("",!0)])])])}));jr.render=Aa,jr.__scopeId="data-v-7bb3c05c";var Pa=d({components:{PeekInside:jr},setup:()=>({store:Pr(),devMode:"true"===localStorage.getItem("devMode")}),methods:{updateStyle(){const e=window.innerHeight,t=window.innerWidth,i=Math.min(e/800,t/1e3),n=(t-1e3*i)/2;document.documentElement.style.setProperty("--scale",`${i}`),document.documentElement.style.setProperty("--translateX",`${n}px`)}},mounted(){setTimeout(this.updateStyle,0),window.addEventListener("resize",this.updateStyle)}});const za={class:"perspective"},Da={class:"peek"};Pa.render=function(e,t,i,n,r,a){const s=A("router-view"),l=A("PeekInside");return y(),b(k,null,[p("div",za,[p(s)]),p("div",Da,[e.devMode?(y(),b(l,{key:0})):f("",!0)])],64)};const Wa=C(Pa);Wa.use(zr,Ar),Wa.use(pr),Wa.mount("#app");
