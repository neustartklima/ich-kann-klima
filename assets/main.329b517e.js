...
Anfangswert ist die deutsche Staatsverschuldung 2019.
  ...
  `};const cn=()=>.5,dn=E({AbstandsregelnWindkraft:B,Altbausanierung:Ui,Bestechung:Gi,EnergieStrategie:Ni,FinanzKollaps:Zi,Hitzehoelle:Ri,NewYear:$i,SocialMedia:Qi,TempolimitAufAutobahnen:qi,TimesUp:Yi,WahlVerloren:Xi,WindkraftAusschreibung:en,SolarstromFoerderung:tn,AtomKatastrophe:nn,BSE:rn,Duerrewelle:an,PRKohleindustrie:sn,PRInnenminister:ln,Klimafluechtlinge:on,Plagiatsaffaere:un,CO2PreisDebatte:{title:"Debatte über CO2-Preise",description:"Eine marktliberale Kampagne ist sehr erfolgreich darin, Dich als Verbots-Kanzler hinzustellen. Aus allen Richtungen prasseln Forderungen nach einem adäquaten CO2-Preis auf Dich ein. Nur leider gehen die Vorstellungen über den genauen Preis sehr weit auseinander.",laws:["CO2PreisErhoehen","WirksamerCO2Preis","VollerCO2Preis"],apply:()=>[],probability:e=>Fi(1,3,(Bi(e,"AutosInInnenstaedtenVerbieten")?1:0)+(Bi(e,"KohleverstromungEinstellen")?1:0)+(Bi(e,"SolarAufAllenDaechernVerpflichtend")?1:0)+(Bi(e,"Tempolimit130AufAutobahnen")?1:0)+(Bi(e,"Tempolimit120AufAutobahnen")?1:0)+(Bi(e,"Tempolimit100AufAutobahnen")?1:0))/100}}).map((e=>o(l({},e),{probability:e.probability||cn}))),hn={currentYear:2021,values:Pt,acceptedLaws:[],proposedLaws:[],rejectedLaws:[],events:[],actionCount:0,over:!1,prngState:{}};function gn(e=hn,t=d()){return{id:t,currentYear:e.currentYear,acceptedLaws:e.acceptedLaws,proposedLaws:e.proposedLaws,rejectedLaws:e.rejectedLaws,values:At(e.values),events:e.events,actionCount:e.actionCount,over:e.over,prngState:{}}}function mn(e,t=Li,i=dn,n=I){const r=function(e,t,i){const n=function(e,t){return t.map((t=>o(l({},t),{prob:t.probability(e)}))).filter((e=>e.prob>0))}(e,t),r=function(e){return e.filter((e=>e.prob>1)).reduce(((e,t)=>t.prob>((null==e?void 0:e.prob)||0)?t:e),void 0)}(n);if(r)return r;return function(e,t){for(const i of e)if((t-=i.prob)<0)return i;return}(function(e){const t=e.map((e=>e.prob)).reduce(((e,t)=>e+t),0),i=.6/t;return e.map((e=>o(l({},e),{prob:e.prob*i})))}(n),i())}(e,i,n);if(r){const t={id:r.id,occuredIn:e.currentYear,acknowledged:!1};e.events.unshift(t)}const a=function(e,t,i){const n=t=>{var i;return null==(i=e.acceptedLaws)?void 0:i.some((e=>e.lawId===t.id))},r=t=>{var i;return null==(i=e.rejectedLaws)?void 0:i.includes(t.id)},a=e=>{var t;return(null==(t=e.labels)?void 0:t.includes("hidden"))||!1},s=t=>({law:t,priority:t.priority(e)}),l=e=>({law:e.law,priority:e.priority+(i.includes(e.law.id)?100:0)});return t.filter(j(n)).filter(j(r)).filter(j(a)).map(s).filter((e=>e.priority>0)).map(l).sort(((e,t)=>t.priority-e.priority)).map((e=>e.law.id)).slice(0,6)}(e,t,(null==r?void 0:r.laws)?r.laws:[]);return e.proposedLaws=function(e,t){const i=[...e],n=t.filter((e=>i.includes(e))),r=t.filter((e=>!n.includes(e)));var a=0;for(;a<i.length;)n.includes(i[a])?a++:0!==r.length?(i[a]=r.shift(),a++):i.splice(a,1);return i.push(...r.slice(0,6-i.length)),i}(e.proposedLaws,a),e.actionCount++,r}function pn(e){return Math.max(0,Math.min(100,e))}const bn=[{id:"start",title:"Stell dir vor...",text:J`
    ...
    `},{id:"room",title:"Dein Arbeitszimmer",text:"Dies ist das Zimmer, in dem Du arbeitest und Entscheidungen triffst."},{id:"desk",title:"Dein Schreibtisch",text:"Du sitzt an Deinem Schreibtisch und findest dort immer wieder Gesetzesvorhaben, unter denen du auswählen musst.",highlight:"table"},{id:"finances",title:"Die Staatsfinanzen",text:"Auf Deinem Schreibtisch siehst Du, wie viel Geld der Staat noch hat, um Deine Entscheidungen umzusetzen.",highlight:"finances"},{id:"popularity",title:"Die Wähler",text:"Wenn Du aus dem Fenster schaust, siehst Du, in welcher Stimmung Deine Wähler sind.",highlight:"popularity"},{id:"climate",title:"Das Klima",text:"Die Pflanze in der Ecke zeigt Dir, wie sich das Klima entwickelt.",highlight:"plant"}];const fn={setGameState(e,t){e.game=t.game},gameOver(e){e.game=o(l({},e.game),{over:!0})},setTour(e,t){e.tour=t},error(e,t){console.error(t.error),alert(t.error.message)}},vn={proposedLaws:e=>e.game&&e.game.proposedLaws?Ci(e.game.proposedLaws):[]};var wn=h({props:{law:{type:Object,required:!0},selectable:{type:Boolean,required:!0},numCards:{type:Number,required:!0}},setup:()=>({store:ta()}),data:()=>({accepted:!1}),computed:o(l({},g(["proposedLaws"])),{zIndex(){return this.law.zIndex},transform(){return`rotate(${2*(this.law.pos-this.numCards/2)}deg) translate(${20*Math.abs(this.numCards/2-this.law.pos)}px, -50%)`}}),methods:{select(){this.$emit("selected")},accept(){this.accepted=!0},sendAccept(e){e.animationName.match(/^twistOut-/)&&this.$emit("accepted",this.law.id)}}});const yn=y("data-v-c57832f8");m("data-v-c57832f8");const kn={key:0,type:"radio"},Sn={key:0,class:"button-bar"};p();const zn=yn(((e,t,i,n,r,a)=>(k(),b("div",{class:["Law",{accepted:e.accepted}],style:{zIndex:e.zIndex},onClick:t[2]||(t[2]=(...t)=>e.select&&e.select(...t)),onAnimationend:t[3]||(t[3]=(...t)=>e.sendAccept&&e.sendAccept(...t))},[f("label",null,[e.selectable?(k(),b("input",kn)):v("",!0),f("div",null,[f("h3",null,w(e.law.title),1),f("div",null,w(e.law.description),1),e.selectable?(k(),b("div",Sn,[f("button",{class:"accept",onClick:t[1]||(t[1]=(...t)=>e.accept&&e.accept(...t))},"✓")])):v("",!0)])])],38))));wn.render=zn,wn.__scopeId="data-v-c57832f8";var Pn=h({components:{LawCard:wn},setup:()=>({store:ta()}),data:()=>({zIndexes:[],poppedUp:!1}),computed:o(l({},g(["proposedLaws"])),{lawsToShow(){return this.zIndexes.length||(this.zIndexes=K(this.proposedLaws.length,0)),this.proposedLaws.map(((e,t)=>o(l({},e),{zIndex:this.zIndexes[t],pos:t})))}}),methods:{accept(e){this.store.dispatch("acceptLaw",{lawId:e})},select(e){this.zIndexes=K(this.proposedLaws.length,e)},sitOut(){this.store.dispatch("sitOut")}}});const An=y("data-v-290d8620")(((e,t,i,n,r,a)=>{const s=P("LawCard");return k(),b(S,null,[f("div",{class:["ProposedLaws",{poppedUp:e.poppedUp}],onClick:t[1]||(t[1]=t=>e.poppedUp=!0)},[(k(!0),b(S,null,z(e.lawsToShow,((t,i)=>(k(),b(s,{key:t.id,law:t,selectable:e.poppedUp,numCards:e.lawsToShow.length,onAccepted:()=>e.accept(t.id),onSelected:()=>e.select(i)},null,8,["law","selectable","numCards","onAccepted","onSelected"])))),128))],2),f("div",{class:"sitOutButton",onClick:t[2]||(t[2]=()=>e.sitOut())},"Aussitzen")],64)}));Pn.render=An,Pn.__scopeId="data-v-290d8620";var Dn=h({props:{title:String,text:String},methods:{acknowledge(){this.$emit("acknowledge")}}});const Wn=y("data-v-2df6be4d");m("data-v-2df6be4d");const Tn={key:0};p();const Vn=Wn(((e,t,i,n,r,a)=>e.text?(k(),b("div",{key:0,onClick:t[1]||(t[1]=(...t)=>e.acknowledge&&e.acknowledge(...t))},[e.title?(k(),b("h2",Tn,w(e.title),1)):v("",!0),f("p",null,w(e.text),1)])):v("",!0)));Dn.render=Vn,Dn.__scopeId="data-v-2df6be4d";var Ln=h({props:{title:{type:String,required:!0},value:{type:Number,required:!0},zoom:{type:Number,default:1}},computed:{titleStyle(){return{fontSize:.5*this.zoom+"em"}},progressBarStyle(){return{width:50*this.zoom+"px",height:5*this.zoom+"px"}},indicatorStyle(){const e=this.value>40?"green":this.value>20?"goldenrod":"red";return{width:this.value+"%",backgroundColor:e}}}});const On=y("data-v-37cfebf9");m("data-v-37cfebf9");const Cn={class:"container"};p();const Fn=On(((e,t,i,n,r,a)=>(k(),b("div",Cn,[f("div",{class:"title",style:e.titleStyle},w(e.title),5),f("div",{class:"progress-bar",style:e.progressBarStyle},[f("div",{class:"indicator",style:e.indicatorStyle},null,4)],4)]))));Ln.render=Fn,Ln.__scopeId="data-v-37cfebf9";var En=h({props:{value:{type:Number,required:!0}},components:{IndicatorBar:Ln},computed:{isShort(){return this.value<20},isLess(){return this.value>=20&&this.value<50},isMore(){return this.value>=50&&this.value<80},isMuch(){return this.value>=80}}});const Bn=y("data-v-791f01dd");m("data-v-791f01dd");const Mn={id:"finances"},In={key:0,src:"/assets/money-short.7ce9dbed.png",id:"short"},Un={key:1,src:"/assets/money-less.c10d45f8.png",id:"less"},xn={key:2,src:"/assets/money-more.a1c17d8d.png",id:"more"},Gn={key:3,src:"/assets/money-much.ad651475.png",id:"much"};p();const Nn=Bn(((e,t,i,n,r,a)=>{const s=P("IndicatorBar");return k(),b("div",Mn,[f(s,{title:"Finanzen",value:e.value,zoom:.9},null,8,["value","zoom"]),e.isShort?(k(),b("img",In)):v("",!0),e.isLess?(k(),b("img",Un)):v("",!0),e.isMore?(k(),b("img",xn)):v("",!0),e.isMuch?(k(),b("img",Gn)):v("",!0)])}));En.render=Nn,En.__scopeId="data-v-791f01dd";var _n=h({props:{value:{type:Number,required:!0}},components:{IndicatorBar:Ln},computed:{areHappy(){return this.value>=50},areAngry(){return this.value<50}}});const Kn=y("data-v-e5acad4c");m("data-v-e5acad4c");const Jn={id:"popularity"},jn={key:0,src:"/assets/people-happy.1e9e529c.png",id:"happy"},Hn={key:1,src:"/assets/people-angry.495e0425.png",id:"angry"};p();const Zn=Kn(((e,t,i,n,r,a)=>{const s=P("IndicatorBar");return k(),b("div",Jn,[f(s,{title:"Beliebtheit",value:e.value,zoom:2.8,style:{margin:"-80px 0 0 200px"}},null,8,["value","zoom"]),e.areHappy?(k(),b("img",jn)):v("",!0),e.areAngry?(k(),b("img",Hn)):v("",!0)])}));_n.render=Zn,_n.__scopeId="data-v-e5acad4c";var Rn=h({data:()=>({levels:{healthy:"/assets/plant-healthy.1c912fd2.png",sick:"/assets/plant-sick.05726ebf.png",withered:"/assets/plant-withered.2d8ffb21.png"}}),props:{value:{type:Number,required:!0}},components:{IndicatorBar:Ln},computed:{status(){return this.value>66?"healthy":this.value>33?"sick":"withered"},imgSrc(){return this.levels[this.status]}}});const $n=y("data-v-8ae17ad2");m("data-v-8ae17ad2");const Qn={id:"plant"};p();const qn=$n(((e,t,i,n,r,a)=>{const s=P("IndicatorBar");return k(),b("div",Qn,[f(s,{title:"CO2-Budget",value:e.value,zoom:2.5,style:{margin:"-50px 0 0 60px"}},null,8,["value","zoom"]),f("img",{src:e.imgSrc,id:e.status},null,8,["src","id"])])}));Rn.render=qn,Rn.__scopeId="data-v-8ae17ad2";var Yn=h({props:{year:Number}});const Xn=y("data-v-38fe5c52");m("data-v-38fe5c52");const er={id:"calendar"};p();const tr=Xn(((e,t,i,n,r,a)=>(k(),b("div",er,w(e.year),1))));Yn.render=tr,Yn.__scopeId="data-v-38fe5c52";var ir=h({});const nr=y("data-v-5952ab5a");m("data-v-5952ab5a");const rr={id:"heater"},ar=f("img",{src:"/assets/heater.5a77e425.png"},null,-1);p();const sr=nr(((e,t,i,n,r,a)=>(k(),b("div",rr,[ar]))));ir.render=sr,ir.__scopeId="data-v-5952ab5a";var lr=h({});const or=y("data-v-3902beeb");m("data-v-3902beeb");const ur={id:"table"},cr=f("img",{src:"/assets/table-top.c87bd2fd.png",id:"table-top"},null,-1),dr=f("img",{src:"/assets/table-front.78c0f8c6.png",id:"table-front"},null,-1),hr=f("img",{src:"/assets/table-front.78c0f8c6.png",id:"table-back"},null,-1),gr=f("img",{src:"/assets/table-side.49774a53.png",id:"table-left-side"},null,-1),mr=f("img",{src:"/assets/table-side.49774a53.png",id:"table-right-side"},null,-1);p();const pr=or(((e,t,i,n,r,a)=>(k(),b("div",ur,[cr,dr,hr,gr,mr]))));lr.render=pr,lr.__scopeId="data-v-3902beeb";var br=h({props:{withNews:Boolean}}),fr="/assets/board-side.d7181ded.png",vr="/assets/tvset-legs.78b387df.png";const wr=y("data-v-118e7bdf");m("data-v-118e7bdf");const yr={id:"tvset"},kr=f("div",{id:"board"},[f("img",{id:"board-front",src:"/assets/board-front.41330f02.png"}),f("img",{id:"board-left",src:fr}),f("img",{id:"board-right",src:fr}),f("div",{id:"board-top"})],-1),Sr={id:"tv"},zr=f("img",{id:"tv-front",src:"/assets/tv-front.82df5c0c.png"},null,-1),Pr={key:0,id:"news",src:"/assets/news.c4bbc2d0.png"},Ar=f("div",{id:"legs"},[f("img",{id:"legs-front",src:vr}),f("img",{id:"legs-back",src:vr})],-1);p();const Dr=wr(((e,t,i,n,r,a)=>(k(),b("div",yr,[kr,f("div",Sr,[zr,e.withNews?(k(),b("img",Pr)):v("",!0)]),Ar]))));br.render=Dr,br.__scopeId="data-v-118e7bdf";var Wr={};const Tr=y("data-v-2419943a");m("data-v-2419943a");const Vr={class:"dialog"},Lr={class:"buttons"};p();const Or=Tr(((e,t,i,n,r,a)=>(k(),b("div",Vr,[A(e.$slots,"default",{},void 0,!0),f("div",Lr,[A(e.$slots,"buttons",{},void 0,!0)])]))));Wr.render=Or,Wr.__scopeId="data-v-2419943a";var Cr=h({setup(){const e=ta();return e.dispatch("setupTour"),{store:e}},components:{Dialog:Wr},mounted(){this.setHighlight(this.currentStep)},computed:{currentStep(){return bn.find((e=>e.id===this.$store.state.tour.step))},title(){var e;return null==(e=this.currentStep)?void 0:e.title},text(){var e;return null==(e=this.currentStep)?void 0:e.text}},watch:{currentStep(e){this.setHighlight(e)}},methods:{setHighlight(e){var t;const i=document.querySelector(".highlighted");i&&i.classList.remove("highlighted"),e&&e.highlight&&(null==(t=document.querySelector(`#${e.highlight}`))||t.classList.add("highlighted"))},next(){this.$store.dispatch("nextTourStep")},stop(){this.$store.dispatch("stopTour")}}});Cr.render=function(e,t,i,n,r,a){const s=P("Dialog");return e.title&&e.text?(k(),b(s,{key:0},{buttons:D((()=>[f("button",{onClick:t[1]||(t[1]=(...t)=>e.stop&&e.stop(...t))},"Tour beenden"),f("button",{onClick:t[2]||(t[2]=(...t)=>e.next&&e.next(...t))},"Weiter")])),default:D((()=>[f("h2",null,w(e.title),1),f("div",{innerHTML:e.text},null,8,["innerHTML"])])),_:1})):v("",!0)};var Fr=h({components:{Calendar:Yn,ClimateIndicator:Rn,Heater:ir,LawProposals:Pn,SpeechBubble:Dn,FinanceIndicator:En,PopularityIndicator:_n,Table:lr,Tour:Cr,TVSet:br},data:()=>({store:ta()}),computed:{eventToShow(){var e;const t=(null==(e=this.store.state.game)?void 0:e.events)||[];if(0===t.length)return;const i=t[0];return i.acknowledged?void 0:dn.find((e=>e.id===i.id))},eventTitle(){var e;return(null==(e=this.eventToShow)?void 0:e.title)||""},eventText(){var e;return(null==(e=this.eventToShow)?void 0:e.description)||""},currentYear(){var e;return(null==(e=this.store.state.game)?void 0:e.currentYear)||2021},finance(){const e=this.store.state.game;return e?function(e){return pn(100-e.values.stateDebt/Pt.stateDebt*50)}(e):0},popularity(){var e;return(null==(e=this.store.state.game)?void 0:e.values.popularity)||100},climate(){const e=this.store.state.game;return e?function(e){return 0===e.values.co2emissions?100:pn(e.values.co2budget*At(Pt).co2emissions/Pt.co2budget/e.values.co2emissions*50)}(e):0}},methods:{acknowledge(){this.$store.dispatch("acknowledgeEvent",this.eventToShow)}}});const Er={class:"game-setup"},Br=f("h1",null,"#ich-kann-klima",-1),Mr=f("div",{id:"walls"},[f("div",{id:"wall-back"}),f("div",{id:"wall-left"}),f("div",{id:"wall-right"})],-1);Fr.render=function(e,t,i,n,r,a){const s=P("Calendar"),l=P("Heater"),o=P("PopularityIndicator"),u=P("TVSet"),c=P("ClimateIndicator"),d=P("Table"),h=P("FinanceIndicator"),g=P("LawProposals"),m=P("SpeechBubble"),p=P("Tour");return k(),b("div",Er,[Br,Mr,f(s,{year:e.currentYear},null,8,["year"]),f(l),f(o,{value:e.popularity},null,8,["value"]),f(u,{"with-news":!!e.eventText},null,8,["with-news"]),f(c,{value:e.climate},null,8,["value"]),f(d),f(h,{value:e.finance},null,8,["value"]),f(g),f(m,{title:e.eventTitle,text:e.eventText,onAcknowledge:e.acknowledge},null,8,["title","text","onAcknowledge"]),f(p)])};var Ir=h({setup(){const e=ta();return{store:e,acceptedLaws:W((()=>{var t;return null==(t=e.state.game)?void 0:t.acceptedLaws}))}},data:()=>({opened:void 0}),computed:{visibleAccepted(){return Li.filter((e=>{var t,i;return(null==(t=this.acceptedLaws)?void 0:t.some((t=>t.lawId===e.id)))&&!(null==(i=e.labels)?void 0:i.includes("hidden"))}))}},methods:{toggleOpen(e){this.opened=this.opened===e?void 0:e}}});const Ur=y("data-v-aace6332")(((e,t,i,n,r,a)=>(k(!0),b(S,null,z(e.visibleAccepted,((t,i)=>(k(),b("div",{key:i,class:["Law",{opened:i===e.opened}],onClick:t=>e.toggleOpen(i)},[f("h3",null,w(t.title),1),f("div",null,w(t.description),1)],10,["onClick"])))),128))));Ir.render=Ur,Ir.__scopeId="data-v-aace6332";var xr=h({components:{GameSetup:Fr,AcceptedLaws:Ir},setup:()=>({store:ta()}),methods:{startGame(e){e?this.store.dispatch("loadGame",{gameId:e}):this.store.dispatch("startGame",void 0)}},beforeRouteEnter(e,t,i){i((t=>t.startGame(e.params.id)))}});const Gr=y("data-v-3637ce73")(((e,t,i,n,r,a)=>{const s=P("GameSetup");return k(),b(s)}));xr.render=Gr,xr.__scopeId="data-v-3637ce73";var Nr=h({components:{Dialog:Wr},setup:()=>({store:ta()}),computed:{co2(){var e,t;const i=null==(e=this.store.state.game)?void 0:e.values.co2budget;return(null==(t=this.store.state.game)?void 0:t.values.co2emissions)>0?i>0?"sind weiterhin vorhanden, aber zumindest ist das Budget noch nicht aufgebraucht, dein:e Nachfolger:in hat vielleicht noch eine Chance.":"sind explodiert, das Budget ist aufgebraucht. Hätte die AfD nicht besser hinbekommen.":i>0?"hast du im Griff! Es verbleibt sogar noch ein Rest-CO2-Budget, Gratulation!":"hast du gerade noch rechtzeitig ausreichend senken können. Punktlandung."},debt(){var e;return(null==(e=this.store.state.game)?void 0:e.values.stateDebt)<1e3?"sind ausgeglichen. Die Stabilitätskriterien werden eingehalten.":"sind dir leider aus dem Ruder gelaufen."},popularity(){var e;const t=null==(e=this.store.state.game)?void 0:e.values.popularity;return t<20?"entspricht dem, was man von einem langhährigen Diktator erwarten kann.":t<50?"ist nicht berauschend, wiedergewählt würdest du wohl eher nicht.":t<80?"reicht aus, dass du noch länger am Ruder bleiben könntest. Gratulation!":"ist völlig unglaubwürdig - war das wirklich eine freie Wahl?"}},methods:{loadGame(e){this.store.dispatch("loadGame",{gameId:e})},newGame(){this.$router.push("/games")}},beforeRouteEnter(e,t,i){i((t=>{t.loadGame(e.params.id)}))}});const _r=f("h2",null,"Das Spiel ist leider zu Ende",-1),Kr=f("p",null,"Deine Entscheidungen haben etwas verändert - soviel kann man sagen.",-1),Jr=f("p",null,"Gar nicht so einfach, Politiker zu sein, oder?",-1),jr={class:"button-bar"};Nr.render=function(e,t,i,n,r,a){const s=P("Dialog");return k(),b(s,null,{default:D((()=>[_r,Kr,f("ul",null,[f("li",null,"Die CO2-Emmissionen "+w(e.co2),1),f("li",null,"Die Staatsfinanzen "+w(e.debt),1),f("li",null,"Deine Beliebtheit "+w(e.popularity),1)]),Jr,f("div",jr,[f("button",{onClick:t[1]||(t[1]=(...t)=>e.newGame&&e.newGame(...t))},"Neuer Versuch")])])),_:1})};const Hr=[{path:"/",redirect:"/games"},{path:"/games",component:xr},{path:"/games/:id",component:xr},{path:"/games/:id/over",component:Nr}],Zr=T({history:V(),routes:Hr});const Rr=function(e,t){let i,n=[];async function r(){if(i&&(clearTimeout(i),i=void 0),n.length){const{method:s,path:l,data:o,retry:u,resolve:c,reject:d}=n[0];try{if((null==t?void 0:t.navigator)&&!(null==t?void 0:t.navigator.onLine))throw Error("Browser is offline");const i=await e(s,l,o);n.shift(),c(i)}catch(a){u?n[0].retry=Math.max(-1,u-1):(n.shift(),d(a))}n.length&&(i=setTimeout(r,(null==t?void 0:t.timeout)||1e4))}}return{add:(e,t,a,s=-1)=>new Promise(((l,o)=>{n.push({method:e,path:t,data:a,retry:s,resolve:l,reject:o}),i||r()})),remove(e,t){n=n.filter((i=>i.method.toLowerCase()!==e.toLowerCase()||i.path!==t))},callsPending:()=>n.length>0}}(function(e,t,i=console){return async function(n,r,a){var s;try{const i={method:n};["post","put","patch"].includes(n)&&(i.body=JSON.stringify(a),i.headers={"content-type":"application/json"});const l=await t(e+r,i),o=(null==(s=l.headers.get("Content-Type"))?void 0:s.match(/json/))?await l.json():await l.text();if(l.ok)return o;throw Error(o.message||o)}catch(l){throw i.error(l),l}}}(localStorage.getItem("backendURL")||"https://api.ich-kann-klima.de/api",fetch));var $r;const Qr=function({api:e,logger:t=console,storage:i=localStorage}){return{async createGame(n){i.setItem("game",JSON.stringify(n));try{e.createGame(n)}catch(r){t.warn("Cannot save new game - trying again later",r)}return n},async loadGame(t){const n=i.getItem("game");if(n){const e=JSON.parse(n);if(e.id===t)return gn(e,t)}return gn(await e.loadGame(t),t)},async saveGame(n){i.setItem("game",JSON.stringify(n));try{e.saveGame(n)}catch(r){t.warn("save on server failed - at least the game is saved in localStorage, so you can save it maybe next time",r)}},async decisionMade(t,i,n){e.decisionMade(t.id,i,n)},async eventOccurred(t,i){e.eventOccurred(t.id,i.id)}}}({api:($r=Rr,{createGame:e=>$r.add("post","/games",e),loadGame:e=>$r.add("get","/games/"+e,void 0,0),saveGame:e=>($r.remove("put","/games/"+e.id),$r.add("put","/games/"+e.id,e)),decisionMade:(e,t,i)=>$r.add("post","/games/"+e+"/decisions/"+t,{accepted:i}),eventOccurred:(e,t)=>$r.add("post","/games/"+e+"/events/"+t)})}),qr=(Yr=Zr,Xr=Qr,{async startGame(e){const t=function(e=Li,t=hn){const i=gn(t);return i.acceptedLaws=e.filter((e=>{var t;return null==(t=e.labels)?void 0:t.includes("initial")})).map((e=>({lawId:e.id,effectiveSince:i.currentYear}))),i}();await Xr.createGame(t),U(t);const i=mn(t);e.commit("setGameState",{game:t}),e.dispatch("applyEvent",{event:i}),Yr.push("/games/"+t.id)},async loadGame(e,t){try{const i=await Xr.loadGame(t.gameId);U(i),i.prngState=x(),await Xr.saveGame(i),Yr.push("/games/"+i.id+(i.over?"/over":"")),e.commit("setGameState",{game:i})}catch(i){e.dispatch("error",{error:i})}},gameOver(e){var t;e.commit("gameOver",void 0),Yr.push("/games/"+(null==(t=e.state.game)?void 0:t.id)+"/over")},async acceptLaw(e,t){const i=l({},e.state.game),n={lawId:t.lawId,effectiveSince:i.currentYear+1},r=Oi(n),a=r.removeLawsWithLabels,s=i.acceptedLaws.map(Oi).filter((e=>!(null==a?void 0:a.some((t=>{var i;return null==(i=e.labels)?void 0:i.includes(t)}))))).map((e=>({lawId:e.id,effectiveSince:e.effectiveSince})));i.acceptedLaws=[...s,n];const o=mn(i);i.prngState=x(),await Xr.saveGame(i),e.commit("setGameState",{game:i}),e.dispatch("applyEvent",{event:o}),await Xr.decisionMade(i,r.id,!0)},async rejectLaw(e,t){const i=l({},e.state.game);i.rejectedLaws=[...i.rejectedLaws,t.lawId],await Xr.decisionMade(i,t.lawId,!1),i.prngState=x(),await Xr.saveGame(i),e.commit("setGameState",{game:i})},async sitOut(e){const t=l({},e.state.game);await Xr.decisionMade(t,"sitOut",!0);const i=mn(t);t.prngState=x(),await Xr.saveGame(t),e.commit("setGameState",{game:t}),e.dispatch("applyEvent",{event:i})},async advanceYear(e){const t=l({},e.state.game),i=t.acceptedLaws.map(Oi);t.currentYear++,t.values=function(e,t,i){const n=At(e.values);return t.sort(((e,t)=>{var i,n;return(null==(i=e.treatAfterLabels)?void 0:i.some((e=>{var i;return null==(i=t.labels)?void 0:i.includes(e)})))?1:(null==(n=t.treatAfterLabels)?void 0:n.some((t=>{var i;return null==(i=e.labels)?void 0:i.includes(t)})))?-1:0})).forEach((t=>{const r=t.effects(o(l({},e),{values:n}),t.effectiveSince,i);Vt({dispatch:()=>{},values:n},r)})),n.co2budget-=n.co2emissions,n}(t,i,t.currentYear),t.prngState=x(),await Xr.saveGame(t),e.commit("setGameState",{game:t})},async applyEvent(e,t){if(!t.event)return;const i=l({},e.state.game);await Xr.eventOccurred(i,t.event);const n=t.event.apply(i);e.dispatch("applyEffects",{changes:n})},acknowledgeEvent(e,t){const i=l({},e.state.game);i.events.find((e=>e.id===t.id)).acknowledged=!0,i.prngState=x(),Xr.saveGame(i),e.commit("setGameState",{game:i})},applyEffects(e,t){const i={dispatch:e.dispatch,values:At(e.state.game.values)};Vt(i,t.changes);const n=o(l({},e.state.game),{values:i.values,prngState:x()});Xr.saveGame(n),e.commit("setGameState",{game:n})},setupTour(e){const t=localStorage.getItem("tour")||bn[0].id,i=bn.find((e=>t===e.id));i?e.commit("setTour",{step:i.id,active:!0}):e.dispatch("stopTour")},nextTourStep(e){const t=bn.findIndex((t=>e.state.tour.step===t.id));if(t<0||t==bn.length-1)e.dispatch("stopTour");else{const i=bn[t+1];e.commit("setTour",{step:i.id,active:!0}),localStorage.setItem("tour",i.id)}},stopTour(e){e.commit("setTour",{step:"",active:!1}),localStorage.setItem("tour","completed")},async error(e,t){e.commit("error",t)}});var Yr,Xr;const ea=Symbol();function ta(){return L(ea)}const ia=O({state:{game:void 0,tour:{active:!0,step:"start"}},mutations:fn,actions:qr,getters:vn});function na(e,t,...i){for(const n of i){if(e[n]<t[n])return-1;if(e[n]>t[n])return 1}return 0}function ra(e,t){const i=At(e.values);function n(e){return(e>0?"+":"")+e.toFixed(2)}function r(r){const a=function(e){const i=t.find((t=>"modify"===t.type&&t.name===e));return i&&i.condition?i.value:0}(r),s=i[r]-e.values[r];return a&&Math.abs(a-s)<.001?n(a):a?n(a)+" / "+n(s):0!=s?n(s):""}Vt({dispatch:()=>{},values:i},t);return zt.map((t=>{return{id:t.name,unit:t.unit,value:(i=t.name,e.values[i].toFixed(2)),effect:r(t.name),class:t.writable?"writable":"calculated"};var i}))}var aa=h({props:{citation:{type:Object,required:!0},showInternals:{type:Boolean,default:!1}},computed:{href(){return this.citation.url.toString()},title(){return this.citation.title||this.citation.url.toString()}}});const sa={key:0},la=C(". "),oa={key:1},ua={key:2},ca=C("Bemerkung: "),da=C(". "),ha={key:3},ga=C("Internes: "),ma=C(". "),pa={key:4},ba=C(". "),fa={key:5},va=C(". "),wa={key:6},ya=C(". ");aa.render=function(e,t,i,n,r,a){return k(),b("p",null,[e.citation.authors?(k(),b("span",sa,w(e.citation.authors+e.citation.dateString())+". ",1)):v("",!0),f("a",{target:"_blank",rel:"noreferrer noopener",href:e.href},'"'+w(e.title)+'"',9,["href"]),la,e.citation.publisher?(k(),b("span",oa,w(e.citation.publisher)+". ",1)):v("",!0),e.citation.comment?(k(),b("span",ua,[ca,f("span",{innerHTML:e.citation.comment},null,8,["innerHTML"]),da])):v("",!0),e.showInternals&&e.citation.internalComment?(k(),b("span",ha,[ga,f("span",{innerHTML:e.citation.internalComment},null,8,["innerHTML"]),ma])):v("",!0),e.citation.referringUrl?(k(),b("span",pa,[f("a",{target:"_blank",rel:"noreferrer noopener",href:e.citation.referringUrl.toString()},"Hier gefunden",8,["href"]),ba])):v("",!0),e.citation.archiveUrl?(k(),b("span",fa,[f("a",{target:"_blank",rel:"noreferrer noopener",href:e.citation.archiveUrl.toString()},"Web Archiv Kopie",8,["href"]),va])):v("",!0),e.citation.localCopy?(k(),b("span",wa,[f("a",{target:"_blank",rel:"noreferrer noopener",href:"/sources/"+e.citation.localCopy},"Kopie",8,["href"]),ya])):v("",!0)])};var ka=h({components:{Citation:aa},setup(){const e=ta();return{store:e,game:W((()=>e.state.game))}},data:()=>({selectedTable:"laws",lawsSortCol:"state",lawsSortDir:1,eventsSortCol:"probability",eventsSortDir:-1,lawSelected:void 0,eventSelected:void 0,paramSelected:void 0}),methods:{sortLaws(e){e===this.lawsSortCol?this.lawsSortDir=this.lawsSortDir>0?-1:1:this.lawsSortDir=1,this.lawsSortCol=e},sortEvents(e){e===this.eventsSortCol?this.eventsSortDir=this.eventsSortDir>0?-1:1:this.eventsSortDir=1,this.eventsSortCol=e},selectLaw(e){this.unselect(),this.lawSelected=e},selectEvent(e){this.unselect(),this.eventSelected=e},selectParam(e){this.unselect(),this.paramSelected=e},unselect(){this.lawSelected=void 0,this.eventSelected=void 0,this.paramSelected=void 0}},computed:{startYearOfSelected(){if(!this.lawSelected||!this.game)return 2021;const e=this.game.acceptedLaws.find((e=>e.lawId===this.lawSelected));return e?e.effectiveSince:2021},selectedLaw(){return Li.find((e=>e.id===this.lawSelected))},selectedEvent(){return dn.find((e=>e.id===this.eventSelected))},selectedParam(){return this.paramSelected?ft[this.paramSelected]:void 0},wParam(){const e=this.selectedParam;return e instanceof Pe?e:void 0},cParam(){const e=this.selectedParam;return e instanceof Ae?e:void 0},citationsOfLaw(){return this.selectedLaw&&this.selectedLaw.citations?this.selectedLaw.citations:[]},effectsOfSelected(){if(!this.lawSelected||!this.game)return[];this.game;const e=this.selectedLaw;return e?e.effects(this.game,this.startYearOfSelected,this.game.currentYear):[]},sortedValues(){return this.game?ra(this.game,this.effectsOfSelected):[]},sortedLaws(){return this.game?function(e,t,i,n){const r=e.proposedLaws,a=e.acceptedLaws.map((e=>e.lawId)),s=e.rejectedLaws;return n.map((t=>{return{id:t.id,priority:t.priority(e),state:(i=t.id,a.includes(i)?"a":r.includes(i)?"p":s.includes(i)?"r":"x")};var i})).sort(((e,n)=>na(e,n,t,"id")*i)).map((e=>o(l({},e),{priority:e.priority.toFixed(2)})))}(this.game,this.lawsSortCol,this.lawsSortDir,Li):[]},sortedEvents(){return this.game?(e=this.game,t=this.eventsSortCol,i=this.eventsSortDir,dn.map((t=>({id:t.id,probability:t.probability(e)}))).sort(((e,n)=>na(e,n,t,"id")*i)).map((e=>o(l({},e),{probability:(100*e.probability).toFixed(2)})))):[];var e,t,i}}});const Sa=y("data-v-7bb3c05c");m("data-v-7bb3c05c");const za={class:"peekData"},Pa={key:0,class:"Details"},Aa={class:"Title"},Da={class:"Description"},Wa=f("div",{class:"SectionHead"},"Details:",-1),Ta=f("div",{class:"SectionHead"},"Internes:",-1),Va=f("div",{class:"SectionHead"},"Referenzen:",-1),La={key:1,class:"Details"},Oa={class:"Title"},Ca={class:"Description"},Fa=f("div",{class:"SectionHead"},"Details:",-1),Ea=f("div",{class:"SectionHead"},"Internes:",-1),Ba=f("div",{class:"SectionHead"},"Referenzen:",-1),Ma={key:2,class:"Details"},Ia={class:"Title"},Ua={key:0},xa={key:1},Ga={key:2},Na=f("div",{class:"SectionHead"},"Details:",-1),_a=f("div",{class:"SectionHead"},"Internes:",-1),Ka=f("div",{class:"SectionHead"},"Referenzen:",-1),Ja={class:"paramsList"},ja={class:"numbercol"},Ha={class:"effcol"},Za={class:"buttonlist"},Ra={class:"lawList"},$a={key:0},Qa={class:"priocol"},qa={class:"eventList"},Ya={key:0},Xa={class:"priocol"};p();const es=Sa(((e,t,i,n,r,a)=>{var s;const l=P("Citation");return k(),b("details",za,[f("summary",{onClick:t[1]||(t[1]=t=>e.unselect()),class:"clickable"},"Peek"),e.selectedLaw?(k(),b("div",Pa,[f("div",Aa,w(e.selectedLaw.title),1),f("div",Da,w(e.selectedLaw.description),1),Wa,f("div",{class:"Section",innerHTML:e.selectedLaw.details},null,8,["innerHTML"]),Ta,f("div",{class:"Section",innerHTML:e.selectedLaw.internals},null,8,["innerHTML"]),Va,(k(!0),b(S,null,z(e.citationsOfLaw,((e,t)=>(k(),b(l,{class:"Section",key:t,citation:e},null,8,["citation"])))),128))])):v("",!0),e.selectedEvent?(k(),b("div",La,[f("div",Oa,w(e.selectedEvent.title),1),f("div",Ca,w(e.selectedEvent.description),1),Fa,f("div",{class:"Section",innerHTML:e.selectedEvent.details},null,8,["innerHTML"]),Ea,f("div",{class:"Section",innerHTML:e.selectedEvent.internals},null,8,["innerHTML"]),Ba,(k(!0),b(S,null,z(null==(s=e.selectedEvent)?void 0:s.citations,((e,t)=>(k(),b(l,{class:"Section",key:t,citation:e},null,8,["citation"])))),128))])):v("",!0),e.selectedParam?(k(),b("div",Ma,[f("div",Ia,w(e.paramSelected)+" ["+w(e.selectedParam.unit)+"]",1),e.wParam?(k(),b("div",Ua,"Initial value: "+w(e.wParam.initialValue)+" "+w(e.wParam.unit),1)):v("",!0),e.cParam&&e.cParam.shouldInitiallyBe?(k(),b("div",xa," Should initially be: "+w(e.cParam.shouldInitiallyBe)+" "+w(e.cParam.unit),1)):v("",!0),e.cParam?(k(),b("div",Ga," Calculation: "+w(e.cParam.valueGetter),1)):v("",!0),Na,f("div",{class:"Section",innerHTML:e.selectedParam.details},null,8,["innerHTML"]),_a,f("div",{class:"Section",innerHTML:e.selectedParam.internals},null,8,["innerHTML"]),Ka,(k(!0),b(S,null,z(e.selectedParam.citations,((e,t)=>(k(),b(l,{class:"Section",key:t,citation:e},null,8,["citation"])))),128))])):v("",!0),f("div",Ja,[f("table",null,[(k(!0),b(S,null,z(e.sortedValues,(t=>(k(),b("tr",{key:t.id,class:["clickable",t.class],onClick:i=>e.selectParam(t.id)},[f("td",null,w(t.id),1),f("td",ja,w(t.value),1),f("td",Ha,w(t.effect),1),f("td",null,w(t.unit),1)],10,["onClick"])))),128))])]),f("div",null,[f("table",Za,[f("tr",null,[f("td",{class:["clickable lawButton",e.selectedTable],onClick:t[2]||(t[2]=t=>e.selectedTable="laws")},"Laws",2),f("td",{class:["clickable eventButton",e.selectedTable],onClick:t[3]||(t[3]=t=>e.selectedTable="events")},"Events",2)])]),f("div",Ra,["laws"===e.selectedTable?(k(),b("table",$a,[f("tr",null,[f("th",{onClick:t[4]||(t[4]=t=>e.sortLaws("state")),class:"clickable"},"S"),f("th",{onClick:t[5]||(t[5]=t=>e.sortLaws("id")),class:"clickable"},"ID"),f("th",{onClick:t[6]||(t[6]=t=>e.sortLaws("priority")),class:"clickable priocol"},"Priority")]),(k(!0),b(S,null,z(e.sortedLaws,(t=>(k(),b("tr",{key:t.id,class:["clickable",t.state],onClick:i=>e.selectLaw(t.id)},[f("td",null,w(t.state),1),f("td",null,w(t.id),1),f("td",Qa,w(t.priority),1)],10,["onClick"])))),128))])):v("",!0)]),f("div",qa,["events"===e.selectedTable?(k(),b("table",Ya,[f("tr",null,[f("th",{onClick:t[7]||(t[7]=t=>e.sortEvents("id")),class:"clickable"},"ID"),f("th",{onClick:t[8]||(t[8]=t=>e.sortEvents("probability")),class:"clickable priocol"},"Probability")]),(k(!0),b(S,null,z(e.sortedEvents,(t=>(k(),b("tr",{key:t.id,class:"clickable",onClick:i=>e.selectEvent(t.id)},[f("td",null,w(t.id),1),f("td",Xa,w(t.probability),1)],8,["onClick"])))),128))])):v("",!0)])])])}));ka.render=es,ka.__scopeId="data-v-7bb3c05c";var ts=h({components:{PeekInside:ka},setup:()=>({store:ta(),devMode:"true"===localStorage.getItem("devMode")}),methods:{updateStyle(){const e=window.innerHeight,t=window.innerWidth,i=Math.min(e/800,t/1e3),n=(t-1e3*i)/2;document.documentElement.style.setProperty("--scale",`${i}`),document.documentElement.style.setProperty("--translateX",`${n}px`)}},mounted(){setTimeout(this.updateStyle,0),window.addEventListener("resize",this.updateStyle)}});const is={class:"perspective"},ns={class:"peek"};ts.render=function(e,t,i,n,r,a){const s=P("router-view"),l=P("PeekInside");return k(),b(S,null,[f("div",is,[f(s)]),f("div",ns,[e.devMode?(k(),b(l,{key:0})):v("",!0)])],64)};const rs=F(ts);rs.use(ia,ea),rs.use(Zr),rs.mount("#app");
