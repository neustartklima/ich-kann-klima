...
Hier sind ein paar Referenzen gelistet, die interessant sind, und noch nicht verarbeitet wurden.
  `,citations:[Z]}),Te=new he({unit:"TWh",initialValue:480.54,citations:[I],details:fe`

  `,internals:fe`

  `}),Ve=new he({unit:"Percent",initialValue:50,citations:[],details:fe`
  ...
  `}),Oe=new he({unit:"TWh",initialValue:131.85,citations:[I],details:fe`

  `,internals:fe`

  `});const Ce=new ge({unit:"TWh",valueGetter(e){const t=Oe.initialValue,i=e.electricityGridQuality,n=function(e,t){const i=e.value-t.value;return n=>e.result*(n-t.value)/i-t.result*(n-e.value)/i}({value:50,result:t},{value:100,result:e.electricityDemand})(i);return Math.min(n,e.electricityWind)},shouldInitiallyBe:Oe.initialValue,citations:[],details:fe`The electrical energy produced by wind and not impaired by poor quality of the grid.`,internals:fe`

  `}),Fe=new he({unit:"TWh",initialValue:6,citations:[I],details:fe`

  `,internals:fe`

  `}),Ee=new he({unit:"TWh",initialValue:14.99,citations:[I],details:fe`
...
Anfangswert ist die deutsche Staatsverschuldung 2019.
  ...
  `,internals:fe`
    ...
    - linear interpoliert
  `},Tt={title:"Stromspeicherung erleichtern",description:"Bürokratische Hürden für den Bau von Speicheranlagen und Einspeisung von gespeichertem Strom werden abgeschafft.",effects:(e,t,i)=>[wt("electricityGridQuality").byValue(.2)],priority:e=>ki(70,30,e.values.electricityGridQuality),citations:[],details:fe`
  ...
  `,internals:fe`
    ...
    - 100 bei 10% Anteil
    - linear interpoliert
  `},Xt={title:"Windkraft vereinfachen",description:"Genehmigungen für Windkraftanlagen werden vereinfacht und beschleunigt.",labels:[],removeLawsWithLabels:[],effects:(e,t,i)=>[],priority:e=>ki(80,40,Pi(e)),citations:[],details:fe`
  ...
  `,internals:fe`
    ...
    - 100%
  `},di={title:"Solarstrom Förderung einstellen",description:"Mittlere bis große Solaranlagen sollten sich selbst tragen. Die Förderung wird abgeschafft.",labels:["SolarFoerderung"],removeLawsWithLabels:["SolarFoerderung"],treatAfterLabels:[],effects:()=>[wt("electricitySolar").byValue(2)],priority:e=>Ai(e,"SolarstromFoerderungBeibehalten")?ki(0,100,Di(e)):0,details:fe`

  `},hi={title:"Solarstrom Förderung beibehalten",description:"Subventionierung für mittlere bis große Solaranlagen wie bisher",labels:["initial","SolarFoerderung"],removeLawsWithLabels:["SolarFoerderung"],treatAfterLabels:[],effects:()=>[wt("electricitySolar").byValue(5)],priority:e=>ki(70,100,Di(e)),details:fe`
  ...
  `},BSE:{title:"Staatsoberhaupt verstorben",description:"Du stirbst an der neuen BSE Variante. Tja, hättest du dich mal besser um das Tierwohl gekümmert...",apply:()=>[vt("gameOver")],probability:e=>yi(e.acceptedLaws.map((e=>e.lawId))).find((e=>e.title.match(/tierwohl/i)))?0:Math.random(),laws:[],citations:[],details:fe`
