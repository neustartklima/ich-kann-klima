...
Anfangswert ist die deutsche Staatsverschuldung 2019.
  ...
  `,internals:fe`
    ...
    - linear interpoliert
  `},Wt={title:"Stromspeicherung erleichtern",description:"Bürokratische Hürden für den Bau von Speicheranlagen und Einspeisung von gespeichertem Strom werden abgeschafft.",effects:(e,t,i)=>[wt("electricityGridQuality").byValue(.2)],priority:e=>bi(70,30,e.values.electricityGridQuality),citations:[],details:fe`
  ...
  `,internals:fe`
    ...
    - linear interpoliert
  `},Vt={title:"Stromspeicherung fördern",description:"Bau von Speicheranlagen und Einspeisung von gespeichertem Strom mit Steuermitteln fördern",effects:(e,t,i)=>fi(e,"StromspeicherungErleichtern")?[wt("popularity").byValue(.2),wt("stateDebt").byValue(2),wt("electricityGridQuality").byValue(1)]:[wt("stateDebt").byValue(1)],priority:e=>bi(70,30,e.values.electricityGridQuality),citations:[],details:fe`
  ...
  `},Ft={title:"Autos in Innenstädten verbieten",description:"Die Innenstädte der großen Städte werden zu Autofreien Zonen erklärt und begrünt, sowie Fahrrad und Fußgängerzonen eingerichtet.",effects(e,t,i){var n=-2;e.values.publicLocalCapacity>1.2*e.values.publicLocalUsage&&(n=-1,t+2<i&&(n=2));const r=wt("carUsage").byValue(-.1*e.values.publicLocalUsage).if(t===i),a=r.getChange(e.values);return[wt("popularity").byValue(n),r,wt("publicLocalUsage").byValue(-a)]},priority:e=>bi(90,120,e.values.publicLocalCapacity/e.values.publicLocalUsage*100)},Ut={title:"Fernverkehr Verbindungen ausbauen",description:"Der Ausbau des öffentlichen Fernverkehrs wird bundesweit stärker Bezuschusst und Vorangetrieben",effects(e){const t=e.values.publicNationalCapacity/e.values.publicNationalUsage*100,i=wt("carUsage").byValue(.015*e.values.publicNationalUsage).if(t>=105),n=i.getChange(e.values);return[wt("stateDebt").byValue(6),wt("publicNationalCapacity").byPercent(1),i,wt("publicNationalUsage").byValue(.667*-n),wt("publicLocalUsage").byValue(.333*-n),wt("popularity").byValue(2)]},priority:e=>bi(150,80,e.values.publicNationalCapacity/e.values.publicNationalUsage*100)},Gt={title:"Wasserstofftechnologie fördern",description:"Forschung und Entwicklung von wasserstoffbasierter Antriebs- und Produktionstechnologie wird stark gefördert.",effects:(e,t,i)=>[wt("stateDebt").byValue(3),wt("carRenewablePercentage").byValue(1).if(t+5<=i)],priority(e){const t=e.values;return bi(40,90,t.carUsage*(1-t.carRenewablePercentage/100)/t.passengerTransportUsage*100)}},xt={title:"Abschaffung der Mineralölsteuer",description:"Die Steuer auf sämtliche erdölbasierten Treibstoffe wird abgeschafft.",effects(e,t,i){const n=wt("publicLocalUsage").byPercent(-20).if(t===i),r=wt("publicNationalUsage").byPercent(-20).if(t===i),a=n.getChange(e.values),s=r.getChange(e.values);return[wt("stateDebt").byValue(41),wt("popularity").byValue(5).if(t===i),wt("popularity").byValue(-3).if(t<i),wt("carUsage").byValue(-a-s).if(t===i),n,r]},priority(e){const t=e.values;return bi(60,100,t.carUsage*(1-t.carRenewablePercentage/100)/t.passengerTransportUsage*100)},citations:[N],details:"",internals:fe`
    ...
    - linear interpoliert
  `},It={title:"Ausbau von Straßen",description:"Autobahnen und Straßen werden intensiver ausgebaut.",effects(e){const t=wt("publicLocalUsage").byPercent(-1),i=wt("publicNationalUsage").byPercent(-1),n=t.getChange(e.values),r=i.getChange(e.values);return[wt("stateDebt").byValue(5),wt("popularity").byValue(.5),wt("carUsage").byValue(-n-r),t,i]},priority(e){const t=e.values;return bi(60,100,t.carUsage/t.passengerTransportUsage*100)}},_t={title:"Diesel Privileg abgeschaffen",description:"Diesel wird jetzt genauso besteuert wie Benzin.",effects:(e,t,i)=>[wt("stateDebt").byValue(-7.35),wt("popularity").byValue(-1).if(t===i)],priority(e){const t=e.values;return bi(10,100,t.carUsage*(1-t.carRenewablePercentage/100)/t.passengerTransportUsage*100)}},Nt={title:"Dienstwagen Privileg abgeschaffen",description:"Steuererleichterungen für Dienstwagen werden abgeschafft.",effects(e,t,i){const n=wt("carUsage").byPercent(-.05),r=n.getChange(e.values);return[wt("stateDebt").byValue(-18),wt("popularity").byValue(-1).if(t===i),n,wt("publicLocalUsage").byValue(-r)]},priority(e){const t=e.values;return bi(50,100,t.carUsage*(1-t.carRenewablePercentage/100)/t.passengerTransportUsage*100)},citations:[K,le],details:fe`
  ...
  `,internals:fe`
    ...
    - linear interpoliert
  `},$t={title:"Abstandsregeln für Windkraft wie zu Beginn",description:"Das Land / Die Kommune bestimmem über Abstände zwischen den Windkraftanlagen und Wohngebäuden.",labels:["initial","WindkraftAbstandsregel"],removeLawsWithLabels:["WindkraftAbstandsregel"],effects(e,t,i){const n=fi(e,"WindkraftVereinfachen")?0:5;return[wt("electricityWindOnshoreMaxNew").setValue(6).if(i>=t+n)]},priority:e=>fi(e,"AbstandsregelnFuerWindkraftLockern")?bi(30,100,vi(e)):fi(e,"AbstandsregelnFuerWindkraftVerschaerfen")?bi(70,30,vi(e)):0},Rt={title:"Abstandsregeln für Windkraft lockern",description:"Bundesweite gelockerte Abstandsregeln für Windkraftanlagen sowie Bauerlaubniss in Wäldern. Ja auch Bayern wird jetzt gezwungen Windkraftanlagen zuzulassen, sowie andere nicht bauwillige Kommunen.",labels:["WindkraftAbstandsregel"],removeLawsWithLabels:["WindkraftAbstandsregel"],effects(e,t,i){const n=fi(e,"WindkraftVereinfachen")?0:5;return[wt("popularity").byValue(-3).if(t===i),wt("electricityWindOnshoreMaxNew").setValue(30).if(i>=t+n)]},priority:e=>fi(e,"AbstandsregelnFuerWindkraftWieBisher")?bi(70,30,vi(e)):fi(e,"AbstandsregelnFuerWindkraftAbschaffen")?bi(30,100,vi(e)):0,citations:[],details:fe`
  ...
  `},Qt={title:"Abstandsregeln für Windkraft abschaffen",description:"Jeder der Land besitzt kann seine Windkraftanlage dahin bauen wo er will.",labels:["WindkraftAbstandsregel"],removeLawsWithLabels:["WindkraftAbstandsregel"],effects(e,t,i){const n=fi(e,"WindkraftVereinfachen")?0:5;return[wt("popularity").byValue(-40).if(t===i),wt("electricityWindOnshoreMaxNew").setValue(1e3).if(i>=t+n)]},priority:e=>fi(e,"AbstandsregelnFuerWindkraftLockern")?bi(80,40,vi(e)):0},qt={title:"Abstandsregeln für Windkraft verschärfen",description:"Der Mindestabstand zwischen Wind Energie Anlagen und Wohngebäuden im Innenbereich muss das Zehnfache der Gesamthöhe der Wind Energie Anlagen betragen (10H-Regel)",labels:["WindkraftAbstandsregel"],removeLawsWithLabels:["WindkraftAbstandsregel"],effects:(e,t,i)=>[wt("popularity").byValue(5).if(t===i),wt("electricityWindOnshoreMaxNew").setValue(.42)],priority:e=>fi(e,"AbstandsregelnFuerWindkraftWieBisher")?bi(0,100,vi(e)):0},Yt={title:"Ausschreibungsverfahren für Windkraft wie zu Beginn",description:"Windkraft Betreiber können sich mehrmals im Jahr auf ein eine bestimte Leistung von Windkraft bewerben. Der Betreiber, der das Projekt mit der kleinstmöglichen Subventionierung umsetzen kann bekommt den Zuschlag. Insgesamt werden 8,1 TWh pro Jahr ausgeschrieben.",labels:["initial","hidden","WindkraftSubvention"],removeLawsWithLabels:["WindkraftSubvention"],treatAfterLabels:["WindkraftAbstandsregel"],effects(e,t,i){const n=fi(e,"WindkraftVereinfachen")?0:5,r=Math.min(6.9,e.values.electricityWindOnshoreMaxNew);return[wt("electricityWind").byValue(r+1.2).if(i>=t+n)]},priority:e=>fi(e,"AusschreibungsverfahrenfuerWindkraftVerdoppeln")?bi(60,100,wi(e)):0},Xt={title:"Ausschreibungsverfahren für Windkraft verdoppeln",description:"Der jährlich ausgeschriebene Windstrom-Zubau wird auf 16,2TWh verdoppelt.",labels:["WindkraftSubvention"],removeLawsWithLabels:["WindkraftSubvention"],treatAfterLabels:["WindkraftAbstandsregel"],effects(e,t,i){const n=fi(e,"WindkraftVereinfachen")?0:5,r=Math.min(13.8,e.values.electricityWindOnshoreMaxNew);return[wt("popularity").byValue(-1).if(t===i),wt("unemployment").byValue(-20).if(t===i),wt("electricityWind").byValue(r+2.4).if(i>=t+n)]},priority:e=>fi(e,"AusschreibungsverfahrenfuerWindkraftWieBisher")?bi(100,50,wi(e)):fi(e,"AusschreibungsverfahrenfuerWindkraftVervierfachen")?bi(40,100,wi(e)):0},ei={title:"Ausschreibungsverfahren für Windkraft vervierfachen",description:"Der jährlich ausgeschriebene Windstrom-Zubau wird auf 32,4TWh vervierfacht.",labels:["WindkraftSubvention"],removeLawsWithLabels:["WindkraftSubvention"],treatAfterLabels:["WindkraftAbstandsregel"],effects(e,t,i){const n=fi(e,"WindkraftVereinfachen")?0:5,r=Math.min(27.6,e.values.electricityWindOnshoreMaxNew);return[wt("popularity").byValue(-2).if(t===i),wt("unemployment").byValue(-100).if(t===i),wt("electricityWind").byValue(r+4.8).if(i>=t+n)]},priority:e=>fi(e,"AusschreibungsverfahrenfuerWindkraftVerdoppeln")?bi(100,40,wi(e)):fi(e,"AusschreibungsverfahrenfuerWindkraftVerachtfachen")?bi(0,100,wi(e)):0,citations:[],details:fe`
  ...
  `,internals:fe`
    ...
    - linear interpoliert
  `},ti={title:"Ausschreibungsverfahren für Windkraft verachtfachen",description:"Der jährlich ausgeschriebene Windstrom-Zubau wird auf 64,8TWh verachtfacht.",labels:["WindkraftSubvention"],removeLawsWithLabels:["WindkraftSubvention"],treatAfterLabels:["WindkraftAbstandsregel"],effects(e,t,i){const n=fi(e,"WindkraftVereinfachen")?0:5,r=Math.min(55.2,e.values.electricityWindOnshoreMaxNew);return[wt("popularity").byValue(-20).if(t===i),wt("unemployment").byValue(-100).if(t===i),wt("electricityWind").byValue(r+9.6).if(i>=t+n)]},priority:e=>fi(e,"AusschreibungsverfahrenfuerWindkraftVervierfachen")?bi(100,0,wi(e)):0},ii={title:"CO2 Preis Erhöhen",description:"Die Preise werden schneller erhöht, als bisher geplant. Eine Tonne CO2 kostet in 2 Jahren 70 Euro und in 4 Jahren 100 Euro.",labels:["CO2Preis"],removeLawsWithLabels:["CO2Preis"],effects(e,t,i){const n=pi(50,0,wi(e),-1),r=pi(50,0,e.values.carRenewablePercentage,-1),a=-.5,s=wt("electricityBrownCoal").byPercent(a),l=wt("electricityHardCoal").byPercent(a),o=s.getChange(e.values)+l.getChange(e.values),u=wt("buildingsSourceOil").byPercent(a),c=u.getChange(e.values),d=wt("carUsage").byPercent(a),h=d.getChange(e.values);return[wt("stateDebt").byValue(-45e6*e.values.co2emissions).if(i>=t+2),wt("stateDebt").byValue(-3e7*e.values.co2emissions).if(i>=t+4),wt("popularity").byValue(n+r),wt("co2emissionsIndustry").byPercent(a),wt("co2emissionsAgriculture").byPercent(a),wt("co2emissionsOthers").byPercent(a),s,l,wt("electricityWind").byValue(.7*-o),wt("electricitySolar").byValue(.3*-o),u,wt("buildingsSourceBio").byValue(-c),d,wt("publicNationalUsage").byValue(.5*-h),wt("publicLocalUsage").byValue(.5*-h)]},priority:e=>100,citations:[ue],details:fe`
  ...
  `,internals:fe`
    ...
    - 100%
  `},ni={title:"Wirksamer CO2 Preis",description:"Eine Tonne CO2 kostet ab jetzt 150 Euro.",labels:["CO2Preis"],removeLawsWithLabels:["CO2Preis"],effects(e,t,i){const n=pi(80,50,wi(e),-3),r=pi(80,50,e.values.carRenewablePercentage,-3),a=-2,s=wt("electricityBrownCoal").byPercent(a),l=wt("electricityHardCoal").byPercent(a),o=s.getChange(e.values)+l.getChange(e.values),u=wt("buildingsSourceOil").byPercent(a),c=u.getChange(e.values),d=wt("carUsage").byPercent(a),h=d.getChange(e.values);return[wt("stateDebt").byValue(-125e6*e.values.co2emissions),wt("popularity").byValue(n+r),wt("co2emissionsIndustry").byPercent(a),wt("co2emissionsAgriculture").byPercent(a),wt("co2emissionsOthers").byPercent(a),s,l,wt("electricityWind").byValue(.7*-o),wt("electricitySolar").byValue(.3*-o),u,wt("buildingsSourceBio").byValue(-c),d,wt("publicNationalUsage").byValue(.5*-h),wt("publicLocalUsage").byValue(.5*-h)]},priority:e=>100,citations:[ue],details:fe`
  ...
  `,internals:fe`
    ...
    - 100%
  `},ri={title:"Voller CO2 Preis",description:"Eine Tonne CO2 kostet ab jetzt 3000 Euro. Das deckt die derzeit prognostizierten Klimafolgekosten.",labels:["CO2Preis"],removeLawsWithLabels:["CO2Preis"],effects(e,t,i){const n=pi(90,50,wi(e),-10),r=pi(90,50,e.values.carRenewablePercentage,-10),a=-5,s=wt("electricityBrownCoal").byPercent(a),l=wt("electricityHardCoal").byPercent(a),o=s.getChange(e.values)+l.getChange(e.values),u=wt("buildingsSourceOil").byPercent(a),c=u.getChange(e.values),d=wt("carUsage").byPercent(a),h=d.getChange(e.values);return[wt("stateDebt").byValue(-3e9*e.values.co2emissions),wt("popularity").byValue(n+r),wt("co2emissionsIndustry").byPercent(a),wt("co2emissionsAgriculture").byPercent(a),wt("co2emissionsOthers").byPercent(a),s,l,wt("electricityWind").byValue(.7*-o),wt("electricitySolar").byValue(.3*-o),u,wt("buildingsSourceBio").byValue(-c),d,wt("publicNationalUsage").byValue(.5*-h),wt("publicLocalUsage").byValue(.5*-h)]},priority:e=>100,citations:[oe],details:fe`
  ...
  `,internals:fe`
    ...
    - 100%
  `},ai={title:"Solarstrom Förderung einstellen",description:"Mittlere bis große Solaranlagen sollten sich selbst tragen. Die Förderung wird abgeschafft.",labels:["SolarFoerderung"],removeLawsWithLabels:["SolarFoerderung"],treatAfterLabels:[],effects:()=>[wt("electricitySolar").byValue(2)],priority:e=>fi(e,"SolarstromFoerderungBeibehalten")?bi(0,100,wi(e)):0,details:fe`

  `},si={title:"Solarstrom Förderung beibehalten",description:"Subventionierung für mittlere bis große Solaranlagen wie bisher",labels:["initial","SolarFoerderung"],removeLawsWithLabels:["SolarFoerderung"],treatAfterLabels:[],effects:()=>[wt("electricitySolar").byValue(5)],priority:e=>bi(70,100,wi(e)),details:fe`
  ...
  `},li={title:"Solarstrom Förderung x2",description:"Subventionierung für mittlere bis große Solaranlagen verdoppeln",labels:["SolarFoerderung"],removeLawsWithLabels:["SolarFoerderung"],treatAfterLabels:[],effects:(e,t,i)=>[wt("popularity").byValue(10).if(t===i),wt("unemployment").byValue(-31e3).if(t===i),wt("electricitySolar").byValue(10)],priority:e=>fi(e,"SolarstromFoerderungBeibehalten")?bi(100,30,wi(e)):0,details:fe`
    Betreiber von etwas größeren PV Anlagen z.B. Lagerhaus bewerben sich um Subventionen.
    Der Betreiber, der das Projekt mit der kleinstmöglichen Subventionierung umsetzen kann bekommt den Zuschlag.`},oi={title:"Solarstrom Förderung x4",description:"Subventionierung für mittlere bis große Solaranlagen vervierfachen",labels:["SolarFoerderung"],removeLawsWithLabels:["SolarFoerderung"],treatAfterLabels:[],effects:(e,t,i)=>[wt("popularity").byValue(20).if(t===i),wt("unemployment").byValue(-89e3).if(t===i),wt("electricitySolar").byValue(20)],priority:e=>fi(e,"SolarstromFoerdernx2")?bi(100,30,wi(e)):0,details:fe`
    Betreiber von etwas größeren PV Anlagen z.B. Lagerhaus bewerben sich um Subventionen.
    Der Betreiber, der das Projekt mit der kleinstmöglichen Subventionierung umsetzen kann bekommt den Zuschlag.
  ...
  `,internals:fe`
    ...
    ${G(j)}
  `,citations:[j]},ui={title:"Solarstrom Förderung x8",description:"Subventionierung für mittlere bis große Solaranlagen verachtfachen",labels:["SolarFoerderung"],removeLawsWithLabels:["SolarFoerderung"],treatAfterLabels:[],effects:(e,t,i)=>[wt("popularity").byValue(-10).if(t===i),wt("unemployment").byValue(-209e3).if(t===i),wt("electricitySolar").byValue(40)],priority:e=>fi(e,"SolarstromFoerdernx4")?bi(100,30,wi(e)):0,details:fe`
    Betreiber von etwas größeren PV Anlagen z.B. Lagerhaus bewerben sich um Subventionen.
    Der Betreiber, der das Projekt mit der kleinstmöglichen Subventionierung umsetzen kann bekommt den Zuschlag.
    Nachrüst Pflicht für alle Gebäude, auch bei moderater Ausbäute.
    Umwandlung vieler Landwirtschaftlicher flächen in Freiflächen PV.`},ci={title:"Solar auf neuen Dächern verpflichtend",description:"Alle Neubauten bekommen PV Anlagen auf die Dächer.",labels:["SolarFoerderung"],removeLawsWithLabels:["SolarFoerderung"],treatAfterLabels:[],effects:(e,t,i)=>[wt("popularity").byValue(-3).if(t===i),wt("electricitySolar").byValue(2)],priority:e=>fi(e,"SolarstromFoerderungBeibehalten")?bi(100,30,wi(e)):0,details:fe`
  ...
  `};const di=E({AllesBleibtBeimAlten:M,InitialAtomausstieg:Dt,KohleverstromungEinstellen:kt,EnergiemixRegeltDerMarkt:St,KernenergienutzungVerlaengern:Pt,NetzausbauErleichtern:zt,StromspeicherungErleichtern:Wt,StromspeicherungFoerdern:Vt,WindkraftVereinfachen:Zt,AbstandsregelnFuerWindkraftVerschaerfen:qt,AbstandsregelnFuerWindkraftWieBisher:$t,AbstandsregelnFuerWindkraftLockern:Rt,AbstandsregelnFuerWindkraftAbschaffen:Qt,AusschreibungsverfahrenfuerWindkraftWieBisher:Yt,AusschreibungsverfahrenfuerWindkraftVerdoppeln:Xt,AusschreibungsverfahrenfuerWindkraftVervierfachen:ei,AusschreibungsverfahrenfuerWindkraftVerachtfachen:ti,SolarstromFoerderungAbschaffen:ai,SolarstromFoerderungBeibehalten:si,SolarstromFoerdernx2:li,SolarstromFoerdernx4:oi,SolarstromFoerdernx8:ui,SolarAufAllenDaechernVerpflichtend:ci,DaemmungAltbau1Percent:Tt,DaemmungAltbau2Percent:Lt,DaemmungAltbau4Percent:Ct,DaemmungAltbauAbschaffen:Ot,NahverkehrKostenlos:Mt,AutosInInnenstaedtenVerbieten:Ft,WasserstofftechnologieFoerdern:Gt,NahverkehrAusbauen:Et,FernverkehrVerbindungenAusbauen:Ut,AusbauVonStrassen:It,AbschaffungDerMineraloelsteuer:xt,DieselPrivilegAbgeschaffen:_t,DienstwagenPrivilegAbgeschaffen:Nt,Tempolimit130AufAutobahnen:Kt,Tempolimit120AufAutobahnen:jt,Tempolimit100AufAutobahnen:Ht,TempolimitAufAutobahnenAussitzen:Jt,FoerderungFuerTierhaltungAbschaffen:Bt,CO2PreisErhoehen:ii,WirksamerCO2Preis:ni,VollerCO2Preis:ri});function hi(e){const t=di.find((t=>t.id===e));if(t)return t;throw Error(`Law #${e} not found`)}function gi(e){const t=hi(e.lawId);if(t)return o(l({},t),{effectiveSince:e.effectiveSince});throw Error(`Law #${e.lawId} not found`)}function mi(e){return e.map((e=>{const t=di.find((t=>t.id===e));return t||console.error(`Inconsistency: Proposed law #${e} not found`),t})).filter((e=>e))}function bi(e,t,i){const n=i-e,r=t-e;if(0===r)throw new Error("Linear interpolation requested with the same value for zero and hundred: "+e);return n/r*100}function pi(e,t,i,n){return Math.max(0,bi(e,t,i))/100*n}function fi(e,t){if(!di.map((e=>e.id)).includes(t))throw new Error("Unknown law ID "+t+" used in a law.");return e.acceptedLaws.some((i=>i.lawId===t&&i.effectiveSince<=e.currentYear))}function vi(e){const t=e.values;return t.electricityWindUsable/t.electricityDemand*100}function wi(e){return(e.values.electricityWindUsable+e.values.electricitySolar+e.values.electricityWater+e.values.electricityBiomass)/e.values.electricityDemand*100}function yi(e){return e.find((e=>e.title.match(/subvention/i)&&e.title.match(/abbau/i)))}const ki=2,Si=3,Ai=4,Pi=5,Di=6;const zi=E({AbstandsregelnWindkraft:B,Altbausanierung:{title:"Gesetzesinitiative zur Sanierung von Altbauten",description:"Zur Einhaltung der Pariser Klimaschutzvereinbarung halten Experten es für unausweichlich, dass in die Sanierung von Altbauten investiert werden muss. Die konkrete Ausgestaltung wird kontrovers diskutiert.",laws:["DaemmungAltbauAbschaffen","AllesBleibtBeimAlten","DaemmungAltbau1Percent","DaemmungAltbau2Percent","DaemmungAltbau4Percent"],apply:()=>[],probability(e){const t=e.values.co2emissionsBuildings/e.values.co2emissions*100;return Math.max(1,bi(15,25,t)/100)}},Bestechung:{title:"Anruf von befreundetem Unternehmer",description:"Klaus, ein Unternehmer, den du auf einer Dienstreise kennen gelernt hast, ruft an und möchte dich in seine\n    Ferienvilla auf Sardinien einladen. Er verlässt sich natürlich darauf, dass du dem Gesetzentwurf zum Abbau von Subventionen\n    nicht zustimmen wirst.\n  ",apply(e){if(e){const t=yi(mi(e.proposedLaws));if(t)return[vt("rejectLaw",{lawId:t.id})]}return[]},probability:e=>yi(mi(e.proposedLaws))?Math.random():0},EnergieStrategie:{title:"Grundsatzdebatte zur Stromerzeugung",description:"Der Bundestag debattierte heute über die Strategie zur Stromerzeugung in Deutschland. Die Meinungen der Parteien gingen dabei stark auseinander.",laws:["KohleverstromungEinstellen","EnergiemixRegeltDerMarkt","KernenergienutzungVerlaengern"],apply:()=>[],probability:()=>Math.random()},FinanzKollaps:{title:"Zusammenbruch des Finanzsystems",description:"Deine Staatsfinanzen sind desaströs. Kein Land der Welt, keine Institutionen oder Privatpersonen trauen dir zu, dass du deine Schulden\n    jemals wieder wirst zurückahlen können. Daher gibt dir auch niemand mehr Geld, mit dem du die Staatsangestellten oder die offenen Verpflichtungen zahlen\n    könntest. Das Spiel ist damit leider beendet.\n  ",apply:()=>[vt("gameOver")],probability:e=>e.values.stateDebt>2*pt.stateDebt?Ai:0},"Hitzehölle":{title:"Hitzehölle",description:"Die CO2-Werte sind soweit gestiegen, dass die Erde nur noch an wenigen Orten bewohnbar ist. Die ehemaligen Küstenregionen\n  stehen unter Wasser, ganze Landstriche sind verschwunden. In den trockeneren Gebieten ist die Temperatur so hoch, dass nichts mehr wächst.\n  Um die verbleibdenden Teile sind erbitterte Kämpfe ausgebrochen.\n  ",apply:()=>[vt("gameOver")],probability:e=>e.values.co2budget<=0?Di:0},NewYear:{title:"Happy New Year!",description:"Mal wieder geht ein ereignisreiches Jahr zuende. Die Regierung hat eine Bilanz ihrer bisherigen Tätigkeit aufgestellt\n    und kommt zu dem nicht weiter überraschenden Ergebnis, dass sie sehr wirkungsvolle Gesetze beschlossen hat. Die Opposition -\n    ebenfalls nicht überraschend - sieht die Sache anders und verurteilt die Regierungserklärung als haltlos.\n  ",apply:()=>[vt("advanceYear")],probability(e){const t=null==e?void 0:e.acceptedLaws.map(gi).filter((t=>{var i;return!(null==(i=t.labels)?void 0:i.includes("initial"))&&t.effectiveSince==e.currentYear+1})),i=t&&t.length||0;if(i<3)return 0;if(i>=5)return ki;const n=Math.round(33.3*(i-2))/100;return Math.min(1,n)}},SocialMedia:{title:"Social Media Alarm!",description:"Deine Wahlkampfberaterin ruft dich völlig aufgelöst an. Ob denn an den Geschichten was dran sein, die da im\n    Netz kursieren, dass du vor einigen Jahren bei einer Demo dabei warst, bei der die Gewalt eskaliert ist.\n    Die Zeitungen haben die Meldung schon aufgegriffen und es gibt Spekulationen, ob man dir das Misstrauen aussprechen wird.\n  ",apply:()=>[wt("popularity").byPercent(-20)],probability:()=>Math.random()},TempolimitAufAutobahnen:{title:"Generelles Tempolimit beschlossen",description:"Die EU hat ein einheitliches, generelles Tempolimit von 120km/h auf Autobahnen beschlossen. Bis auf Deutschland müssen die Mitgliedsstaaten ihr bereits bestehendes generelles Tempolimit nur noch anpassen.",laws:["Tempolimit130AufAutobahnen","Tempolimit120AufAutobahnen","Tempolimit100AufAutobahnen","TempolimitAufAutobahnenAussitzen"],apply:()=>[],probability:()=>Math.random()},TimesUp:{title:"Du hast durchgehalten",description:"Es ist vielleicht nicht alles optimal nach deiner inzwischen sehr langen Amtszeit, aber du hast es geschafft,\n    bis hierhin durchzuhalten! Das ist wunderbar, denn noch immer ist der Planet bewohnbar, deine Maßnahmen waren zu finanzieren\n    und die Menschen hast du auf diesem Weg auch mitgenommen. Gratulation!\n  ",apply:()=>[vt("gameOver")],probability:e=>2050===e.currentYear?Si:0},WahlVerloren:{title:"Wahl verloren",description:"Deine Beliebtheit in der Bevölkerung ist katastrophal, lieber würde man Mao Zedong wählen als dich.\n    Deine Partei hat daher bei der Wahl gerade mal 1.3% erreicht (weil wohl manche nicht wussten, zu welcher Partei du gehörst) und ist damit unter\n    die 5% Marke gerutscht. An eine weitere Kanzlerschaft hat schon länger kein vernünftiger Mensch mehr geglaubt.\n  ",apply:()=>[vt("gameOver")],probability:e=>e.values.popularity<=0?Pi:0},WindkraftAusschreibung:{title:"Abstimmung zur Ausschreibung von Windkraftanlagen",description:"Heute findet die Abstimmung im Bundestag zur weiteren Ausschreibung von Kindkraftanlagen statt. Die Meinungen der Parteien sind sehr unterschiedlich.",laws:["AusschreibungsverfahrenfuerWindkraftWieBisher","AusschreibungsverfahrenfuerWindkraftVerdoppeln","AusschreibungsverfahrenfuerWindkraftVervierfachen","AusschreibungsverfahrenfuerWindkraftVerachtfachen"],apply:()=>[],probability:()=>Math.random(),citations:[],details:fe`
    # Bauarbeiten
  ...
  `},SolarstromFoerderung:{title:"Bürgerinitiative fordert stärkere Solarförderung",description:"",laws:["SolarstromFoerderungAbschaffen","SolarstromFoerderungBeibehalten","SolarstromFoerdernx2","SolarstromFoerdernx4","SolarstromFoerdernx8"],apply:()=>[],probability(e){const t=fi(e,"SolarstromFoerderungAbschaffen"),i=fi(e,"SolarstromFoerderungBeibehalten"),n=fi(e,"SolarstromFoerdernx2");return t||i||n?Math.random():0},citations:[_],details:fe`
  ...
  `},BSE:{title:"Staatsoberhaupt verstorben",description:"Du stirbst an der neuen BSE Variante. Tja, hättest du dich mal besser um das Tierwohl gekümmert...",apply:()=>[vt("gameOver")],probability:e=>mi(e.acceptedLaws.map((e=>e.lawId))).find((e=>e.title.match(/tierwohl/i)))?0:Math.random(),laws:[],citations:[],details:fe`
  ...
  `}}),Wi={currentYear:2021,values:pt,acceptedLaws:[],proposedLaws:[],rejectedLaws:[]};function Vi(e=Wi,t=c()){return{id:t,currentYear:e.currentYear,acceptedLaws:e.acceptedLaws,proposedLaws:e.proposedLaws,rejectedLaws:e.rejectedLaws,values:ft(e.values),events:[],over:!1}}function Ti(e,t=di,i=zi,n=Math.random){const r=function(e,t,i){const n=function(e,t){return t.map((t=>o(l({},t),{prob:t.probability(e)}))).filter((e=>e.prob>0))}(e,t),r=function(e){return e.filter((e=>e.prob>1)).reduce(((e,t)=>t.prob>((null==e?void 0:e.prob)||0)?t:e),void 0)}(n);if(r)return r;return function(e,t){for(const i of e)if((t-=i.prob)<0)return i;return}(function(e){const t=e.map((e=>e.prob)).reduce(((e,t)=>e+t),0),i=.6/t;return e.map((e=>o(l({},e),{prob:e.prob*i})))}(n),i())}(e,i,n);r&&e.events.unshift(r);const a=function(e,t,i){const n=t=>{var i;return null==(i=e.acceptedLaws)?void 0:i.some((e=>e.lawId===t.id))},r=t=>{var i;return null==(i=e.rejectedLaws)?void 0:i.includes(t.id)},a=e=>{var t;return(null==(t=e.labels)?void 0:t.includes("hidden"))||!1},s=t=>({law:t,priority:t.priority(e)}),l=e=>({law:e.law,priority:e.priority+(i.includes(e.law.id)?100:0)});return t.filter(ve(n)).filter(ve(r)).filter(ve(a)).map(s).filter((e=>e.priority>0)).map(l).sort(((e,t)=>t.priority-e.priority)).map((e=>e.law.id)).slice(0,6)}(e,t,(null==r?void 0:r.laws)?r.laws:[]);return e.proposedLaws=function(e,t){const i=[...e],n=t.filter((e=>i.includes(e))),r=t.filter((e=>!n.includes(e)));var a=0;for(;a<i.length;)n.includes(i[a])?a++:0!==r.length?(i[a]=r.shift(),a++):i.splice(a,1);return i.push(...r.slice(0,6-i.length)),i}(e.proposedLaws,a),r}function Li(e){return Math.max(0,Math.min(100,e))}var Ci=d({props:{law:{type:Object,required:!0},selectable:{type:Boolean,required:!0},numCards:{type:Number,required:!0}},setup:()=>({store:dr()}),data:()=>({accepted:!1}),computed:o(l({},h(["proposedLaws"])),{zIndex(){return this.law.zIndex},transform(){return`rotate(${2*(this.law.pos-this.numCards/2)}deg) translate(${20*Math.abs(this.numCards/2-this.law.pos)}px, -50%)`}}),methods:{select(){this.$emit("selected")},accept(){this.accepted=!0},sendAccept(e){e.animationName.match(/^twistOut-/)&&this.$emit("accepted",this.law.id)}}});const Oi=w("data-v-c57832f8");g("data-v-c57832f8");const Ei={key:0,type:"radio"},Bi={key:0,class:"button-bar"};m();const Mi=Oi(((e,t,i,n,r,a)=>(y(),b("div",{class:["Law",{accepted:e.accepted}],style:{zIndex:e.zIndex},onClick:t[2]||(t[2]=(...t)=>e.select&&e.select(...t)),onAnimationend:t[3]||(t[3]=(...t)=>e.sendAccept&&e.sendAccept(...t))},[p("label",null,[e.selectable?(y(),b("input",Ei)):f("",!0),p("div",null,[p("h3",null,v(e.law.title),1),p("div",null,v(e.law.description),1),e.selectable?(y(),b("div",Bi,[p("button",{class:"accept",onClick:t[1]||(t[1]=(...t)=>e.accept&&e.accept(...t))},"✓")])):f("",!0)])])],38))));Ci.render=Mi,Ci.__scopeId="data-v-c57832f8";var Fi=d({components:{LawCard:Ci},setup:()=>({store:dr()}),data:()=>({zIndexes:[],poppedUp:!1}),computed:o(l({},h(["proposedLaws"])),{lawsToShow(){return this.zIndexes.length||(this.zIndexes=pe(this.proposedLaws.length,0)),this.proposedLaws.map(((e,t)=>o(l({},e),{zIndex:this.zIndexes[t],pos:t})))}}),methods:{accept(e){this.store.dispatch("acceptLaw",{lawId:e})},select(e){this.zIndexes=pe(this.proposedLaws.length,e)}}});const Ui=w("data-v-d34c798a")(((e,t,i,n,r,a)=>{const s=A("LawCard");return y(),b("div",{class:["ProposedLaws",{poppedUp:e.poppedUp}],onClick:t[1]||(t[1]=t=>e.poppedUp=!0)},[(y(!0),b(k,null,S(e.lawsToShow,((t,i)=>(y(),b(s,{key:t.id,law:t,selectable:e.poppedUp,numCards:e.lawsToShow.length,onAccepted:()=>e.accept(t.id),onSelected:()=>e.select(i)},null,8,["law","selectable","numCards","onAccepted","onSelected"])))),128))],2)}));Fi.render=Ui,Fi.__scopeId="data-v-d34c798a";var Gi=d({props:{title:String,text:String},methods:{acknowledge(){this.$emit("acknowledge")}}});const xi=w("data-v-2df6be4d");g("data-v-2df6be4d");const Ii={key:0};m();const _i=xi(((e,t,i,n,r,a)=>e.text?(y(),b("div",{key:0,onClick:t[1]||(t[1]=(...t)=>e.acknowledge&&e.acknowledge(...t))},[e.title?(y(),b("h2",Ii,v(e.title),1)):f("",!0),p("p",null,v(e.text),1)])):f("",!0)));Gi.render=_i,Gi.__scopeId="data-v-2df6be4d";var Ni=d({props:{value:{type:Number,required:!0}},computed:{isShort(){return this.value<20},isLess(){return this.value>=20&&this.value<50},isMore(){return this.value>=50&&this.value<80},isMuch(){return this.value>=80}}});const Ki=w("data-v-df0e905e");g("data-v-df0e905e");const ji={id:"finances"},Hi={key:0,src:"/assets/money-short.7ce9dbed.png",id:"short"},Ji={key:1,src:"/assets/money-less.c10d45f8.png",id:"less"},Zi={key:2,src:"/assets/money-more.a1c17d8d.png",id:"more"},$i={key:3,src:"/assets/money-much.ad651475.png",id:"much"};m();const Ri=Ki(((e,t,i,n,r,a)=>(y(),b("div",ji,[e.isShort?(y(),b("img",Hi)):f("",!0),e.isLess?(y(),b("img",Ji)):f("",!0),e.isMore?(y(),b("img",Zi)):f("",!0),e.isMuch?(y(),b("img",$i)):f("",!0)]))));Ni.render=Ri,Ni.__scopeId="data-v-df0e905e";var Qi=d({props:{value:{type:Number,required:!0}},computed:{areHappy(){return this.value>=50},areAngry(){return this.value<50}}});const qi=w("data-v-a375dc26");g("data-v-a375dc26");const Yi={id:"popularity"},Xi={key:0,src:"/assets/people-happy.1e9e529c.png",id:"happy"},en={key:1,src:"/assets/people-angry.495e0425.png",id:"angry"};m();const tn=qi(((e,t,i,n,r,a)=>(y(),b("div",Yi,[e.areHappy?(y(),b("img",Xi)):f("",!0),e.areAngry?(y(),b("img",en)):f("",!0)]))));Qi.render=tn,Qi.__scopeId="data-v-a375dc26";var nn=d({data:()=>({levels:{healthy:"/assets/plant-healthy.1c912fd2.png",sick:"/assets/plant-sick.05726ebf.png",withered:"/assets/plant-withered.2d8ffb21.png"}}),props:{value:{type:Number,required:!0}},computed:{status(){return this.value>66?"healthy":this.value>33?"sick":"withered"},imgSrc(){return this.levels[this.status]}}});const rn=w("data-v-c0f87ac2");g("data-v-c0f87ac2");const an={id:"plant"};m();const sn=rn(((e,t,i,n,r,a)=>(y(),b("div",an,[p("img",{src:e.imgSrc,id:e.status},null,8,["src","id"])]))));nn.render=sn,nn.__scopeId="data-v-c0f87ac2";var ln=d({props:{year:Number}});const on=w("data-v-38fe5c52");g("data-v-38fe5c52");const un={id:"calendar"};m();const cn=on(((e,t,i,n,r,a)=>(y(),b("div",un,v(e.year),1))));ln.render=cn,ln.__scopeId="data-v-38fe5c52";var dn=d({});const hn=w("data-v-5952ab5a");g("data-v-5952ab5a");const gn={id:"heater"},mn=p("img",{src:"/assets/heater.5a77e425.png"},null,-1);m();const bn=hn(((e,t,i,n,r,a)=>(y(),b("div",gn,[mn]))));dn.render=bn,dn.__scopeId="data-v-5952ab5a";var pn=d({});const fn=w("data-v-3902beeb");g("data-v-3902beeb");const vn={id:"table"},wn=p("img",{src:"/assets/table-top.c87bd2fd.png",id:"table-top"},null,-1),yn=p("img",{src:"/assets/table-front.78c0f8c6.png",id:"table-front"},null,-1),kn=p("img",{src:"/assets/table-front.78c0f8c6.png",id:"table-back"},null,-1),Sn=p("img",{src:"/assets/table-side.49774a53.png",id:"table-left-side"},null,-1),An=p("img",{src:"/assets/table-side.49774a53.png",id:"table-right-side"},null,-1);m();const Pn=fn(((e,t,i,n,r,a)=>(y(),b("div",vn,[wn,yn,kn,Sn,An]))));pn.render=Pn,pn.__scopeId="data-v-3902beeb";var Dn=d({props:{withNews:Boolean}}),zn="/assets/board-side.d7181ded.png",Wn="/assets/tvset-legs.78b387df.png";const Vn=w("data-v-118e7bdf");g("data-v-118e7bdf");const Tn={id:"tvset"},Ln=p("div",{id:"board"},[p("img",{id:"board-front",src:"/assets/board-front.41330f02.png"}),p("img",{id:"board-left",src:zn}),p("img",{id:"board-right",src:zn}),p("div",{id:"board-top"})],-1),Cn={id:"tv"},On=p("img",{id:"tv-front",src:"/assets/tv-front.82df5c0c.png"},null,-1),En={key:0,id:"news",src:"/assets/news.c4bbc2d0.png"},Bn=p("div",{id:"legs"},[p("img",{id:"legs-front",src:Wn}),p("img",{id:"legs-back",src:Wn})],-1);m();const Mn=Vn(((e,t,i,n,r,a)=>(y(),b("div",Tn,[Ln,p("div",Cn,[On,e.withNews?(y(),b("img",En)):f("",!0)]),Bn]))));Dn.render=Mn,Dn.__scopeId="data-v-118e7bdf";const Fn=[{id:"start",title:"Stell dir vor...",text:fe`
      ### ... du bist Politiker.
    ...
    `},{id:"room",title:"Dein Arbeitszimmer",text:"Dies ist das Zimmer, in dem Du arbeitest und Entscheidungen triffst."},{id:"desk",title:"Dein Schreibtisch",text:"Du sitzt an Deinem Schreibtisch und findest dort immer wieder Gesetzesvorhaben, unter denen du auswählen musst.",highlight:"table"},{id:"finances",title:"Die Staatsfinanzen",text:"Auf Deinem Schreibtisch siehst Du, wie viel Geld der Staat noch hat, um Deine Entscheidungen umzusetzen.",highlight:"finances"},{id:"popularity",title:"Die Wähler",text:"Wenn Du aus dem Fenster schaust, siehst Du, in welcher Stimmung Deine Wähler sind.",highlight:"popularity"},{id:"climate",title:"Das Klima",text:"Die Pflanze in der Ecke zeigt Dir, wie sich das Klima entwickelt.",highlight:"plant"}];var Un={};const Gn=w("data-v-2419943a");g("data-v-2419943a");const xn={class:"dialog"},In={class:"buttons"};m();const _n=Gn(((e,t,i,n,r,a)=>(y(),b("div",xn,[P(e.$slots,"default",{},void 0,!0),p("div",In,[P(e.$slots,"buttons",{},void 0,!0)])]))));Un.render=_n,Un.__scopeId="data-v-2419943a";var Nn=d({setup(){const e=dr();return e.dispatch("setupTour"),{store:e}},components:{Dialog:Un},mounted(){this.setHighlight(this.currentStep)},computed:{currentStep(){return Fn.find((e=>e.id===this.$store.state.tour.step))},title(){var e;return null==(e=this.currentStep)?void 0:e.title},text(){var e;return null==(e=this.currentStep)?void 0:e.text}},watch:{currentStep(e){this.setHighlight(e)}},methods:{setHighlight(e){var t;const i=document.querySelector(".highlighted");i&&i.classList.remove("highlighted"),e&&e.highlight&&(null==(t=document.querySelector(`#${e.highlight}`))||t.classList.add("highlighted"))},next(){this.$store.dispatch("nextTourStep")},stop(){this.$store.dispatch("stopTour")}}});Nn.render=function(e,t,i,n,r,a){const s=A("Dialog");return e.title&&e.text?(y(),b(s,{key:0},{buttons:D((()=>[p("button",{onClick:t[1]||(t[1]=(...t)=>e.stop&&e.stop(...t))},"Tour beenden"),p("button",{onClick:t[2]||(t[2]=(...t)=>e.next&&e.next(...t))},"Weiter")])),default:D((()=>[p("h2",null,v(e.title),1),p("div",{innerHTML:e.text},null,8,["innerHTML"])])),_:1})):f("",!0)};var Kn=d({components:{Calendar:ln,ClimateIndicator:nn,Heater:dn,LawProposals:Fi,SpeechBubble:Gi,FinanceIndicator:Ni,PopularityIndicator:Qi,Table:pn,Tour:Nn,TVSet:Dn},data:()=>({store:dr()}),computed:{eventTitle(){var e;return(null==(e=this.eventToShow())?void 0:e.title)||""},eventText(){var e;return(null==(e=this.eventToShow())?void 0:e.description)||""},currentYear(){var e;return(null==(e=this.store.state.game)?void 0:e.currentYear)||2021},finance(){const e=this.store.state.game;return e?function(e){return Li(100-e.values.stateDebt/pt.stateDebt*50)}(e):0},popularity(){var e;return(null==(e=this.store.state.game)?void 0:e.values.popularity)||100},climate(){const e=this.store.state.game;return e?function(e){return 0===e.values.co2emissions?100:Li(e.values.co2budget*ft(pt).co2emissions/pt.co2budget/e.values.co2emissions*50)}(e):0}},methods:{eventToShow(){var e;const t=null==(e=this.$store.state.game)?void 0:e.events[0];return t&&!t.acknowledged?t:null},acknowledge(){this.$store.dispatch("acknowledgeEvent",this.eventToShow())}}});const jn={class:"game-setup"},Hn=p("h1",null,"#ich-kann-klima",-1),Jn=p("div",{id:"walls"},[p("div",{id:"wall-back"}),p("div",{id:"wall-left"}),p("div",{id:"wall-right"})],-1);Kn.render=function(e,t,i,n,r,a){const s=A("Calendar"),l=A("Heater"),o=A("PopularityIndicator"),u=A("TVSet"),c=A("ClimateIndicator"),d=A("Table"),h=A("FinanceIndicator"),g=A("LawProposals"),m=A("SpeechBubble"),f=A("Tour");return y(),b("div",jn,[Hn,Jn,p(s,{year:e.currentYear},null,8,["year"]),p(l),p(o,{value:e.popularity},null,8,["value"]),p(u,{"with-news":!!e.eventText},null,8,["with-news"]),p(c,{value:e.climate},null,8,["value"]),p(d),p(h,{value:e.finance},null,8,["value"]),p(g),p(m,{title:e.eventTitle,text:e.eventText,onAcknowledge:e.acknowledge},null,8,["title","text","onAcknowledge"]),p(f)])};var Zn=d({setup(){const e=dr();return{store:e,acceptedLaws:z((()=>{var t;return null==(t=e.state.game)?void 0:t.acceptedLaws}))}},data:()=>({opened:void 0}),computed:{visibleAccepted(){return di.filter((e=>{var t,i;return(null==(t=this.acceptedLaws)?void 0:t.some((t=>t.lawId===e.id)))&&!(null==(i=e.labels)?void 0:i.includes("hidden"))}))}},methods:{toggleOpen(e){this.opened=this.opened===e?void 0:e}}});const $n=w("data-v-aace6332")(((e,t,i,n,r,a)=>(y(!0),b(k,null,S(e.visibleAccepted,((t,i)=>(y(),b("div",{key:i,class:["Law",{opened:i===e.opened}],onClick:t=>e.toggleOpen(i)},[p("h3",null,v(t.title),1),p("div",null,v(t.description),1)],10,["onClick"])))),128))));Zn.render=$n,Zn.__scopeId="data-v-aace6332";var Rn=d({components:{GameSetup:Kn,AcceptedLaws:Zn},setup:()=>({store:dr()}),methods:{startGame(e){e?this.store.dispatch("loadGame",{gameId:e}):this.store.dispatch("startGame",void 0)}},beforeRouteEnter(e,t,i){i((t=>t.startGame(e.params.id)))}});const Qn=w("data-v-3637ce73")(((e,t,i,n,r,a)=>{const s=A("GameSetup");return y(),b(s)}));Rn.render=Qn,Rn.__scopeId="data-v-3637ce73";var qn=d({components:{Dialog:Un},setup:()=>({store:dr()}),computed:{co2(){var e,t;const i=null==(e=this.store.state.game)?void 0:e.values.co2budget;return(null==(t=this.store.state.game)?void 0:t.values.co2emissions)>0?i>0?"sind weiterhin vorhanden, aber zumindest ist das Budget noch nicht aufgebraucht, dein:e Nachfolger:in hat vielleicht noch eine Chance.":"sind explodiert, das Budget ist aufgebraucht. Hätte die AfD nicht besser hinbekommen.":i>0?"hast du im Griff! Es verbleibt sogar noch ein Rest-CO2-Budget, Gratulation!":"hast du gerade noch rechtzeitig ausreichend senken können. Punktlandung."},debt(){var e;return(null==(e=this.store.state.game)?void 0:e.values.stateDebt)<1e3?"sind ausgeglichen. Die Stabilitätskriterien werden eingehalten.":"sind dir leider aus dem Ruder gelaufen."},popularity(){var e;const t=null==(e=this.store.state.game)?void 0:e.values.popularity;return t<20?"entspricht dem, was man von einem langhährigen Diktator erwarten kann.":t<50?"ist nicht berauschend, wiedergewählt würdest du wohl eher nicht.":t<80?"reicht aus, dass du noch länger am Ruder bleiben könntest. Gratulation!":"ist völlig unglaubwürdig - war das wirklich eine freie Wahl?"}},methods:{loadGame(e){this.store.dispatch("loadGame",{gameId:e})},newGame(){this.$router.push("/games")}},beforeRouteEnter(e,t,i){i((t=>{t.loadGame(e.params.id)}))}});const Yn=p("h2",null,"Das Spiel ist leider zu Ende",-1),Xn=p("p",null,"Deine Entscheidungen haben etwas verändert - soviel kann man sagen.",-1),er=p("p",null,"Gar nicht so einfach, Politiker zu sein, oder?",-1),tr={class:"button-bar"};qn.render=function(e,t,i,n,r,a){const s=A("Dialog");return y(),b(s,null,{default:D((()=>[Yn,Xn,p("ul",null,[p("li",null,"Die CO2-Emmissionen "+v(e.co2),1),p("li",null,"Die Staatsfinanzen "+v(e.debt),1),p("li",null,"Deine Beliebtheit "+v(e.popularity),1)]),er,p("div",tr,[p("button",{onClick:t[1]||(t[1]=(...t)=>e.newGame&&e.newGame(...t))},"Neuer Versuch")])])),_:1})};const ir=[{path:"/",redirect:"/games"},{path:"/games",component:Rn},{path:"/games/:id",component:Rn},{path:"/games/:id/over",component:qn}],nr=W({history:V(),routes:ir});const rr=function(e,t){let i,n=[];async function r(){if(i&&(clearTimeout(i),i=void 0),n.length){const{method:s,path:l,data:o,retry:u,resolve:c,reject:d}=n[0];try{if((null==t?void 0:t.navigator)&&!(null==t?void 0:t.navigator.onLine))throw Error("Browser is offline");const i=await e(s,l,o);n.shift(),c(i)}catch(a){u?n[0].retry=Math.max(-1,u-1):(n.shift(),d(a))}n.length&&(i=setTimeout(r,(null==t?void 0:t.timeout)||1e4))}}return{add:(e,t,a,s=-1)=>new Promise(((l,o)=>{n.push({method:e,path:t,data:a,retry:s,resolve:l,reject:o}),i||r()})),remove(e,t){n=n.filter((i=>i.method.toLowerCase()!==e.toLowerCase()||i.path!==t))},callsPending:()=>n.length>0}}(function(e,t,i=console){return async function(n,r,a){var s;try{const i={method:n};["post","put","patch"].includes(n)&&(i.body=JSON.stringify(a),i.headers={"content-type":"application/json"});const l=await t(e+r,i),o=(null==(s=l.headers.get("Content-Type"))?void 0:s.match(/json/))?await l.json():await l.text();if(l.ok)return o;throw Error(o.message||o)}catch(l){throw i.error(l),l}}}("https://api.ich-kann-klima.de/api",fetch));var ar;const sr=function({api:e,logger:t=console,storage:i=localStorage}){return{async createGame(n){i.setItem("game",JSON.stringify(n));try{e.createGame(n)}catch(r){t.warn("Cannot save new game - trying again later",r)}return n},async loadGame(t){const n=i.getItem("game");if(n){const e=JSON.parse(n);if(e.id===t)return Vi(e,t)}return Vi(await e.loadGame(t),t)},async saveGame(n){i.setItem("game",JSON.stringify(n));try{e.saveGame(n)}catch(r){t.warn("save on server failed - at least the game is saved in localStorage, so you can save it maybe next time",r)}},async decisionMade(t,i,n){e.decisionMade(t.id,i.id,n)},async eventOccurred(t,i){e.eventOccurred(t.id,i.id)}}}({api:(ar=rr,{createGame:e=>ar.add("post","/games",e),loadGame:e=>ar.add("get","/games/"+e,void 0,0),saveGame:e=>(ar.remove("put","/games/"+e.id),ar.add("put","/games/"+e.id,e)),decisionMade:(e,t,i)=>ar.add("post","/games/"+e+"/decisions/"+t,{accepted:i}),eventOccurred:(e,t)=>ar.add("post","/games/"+e+"/events/"+t)})}),lr={async startGame(e){const t=function(e=di,t=Wi){const i=Vi(t);return i.acceptedLaws=e.filter((e=>{var t;return null==(t=e.labels)?void 0:t.includes("initial")})).map((e=>({lawId:e.id,effectiveSince:i.currentYear}))),i}(),i=Ti(t);await sr.createGame(t),e.commit("setGameState",{game:t}),e.dispatch("applyEvent",{event:i}),nr.push("/games/"+t.id)},async loadGame(e,t){try{const i=await sr.loadGame(t.gameId);await sr.saveGame(i),nr.push("/games/"+i.id),e.commit("setGameState",{game:i})}catch(i){e.dispatch("error",{error:i})}},gameOver(e){var t;e.commit("gameOver",void 0),nr.push("/games/"+(null==(t=e.state.game)?void 0:t.id)+"/over")},async acceptLaw(e,t){const i=l({},e.state.game),n={lawId:t.lawId,effectiveSince:i.currentYear+1},r=gi(n),a=r.removeLawsWithLabels,s=i.acceptedLaws.map(gi).filter((e=>!(null==a?void 0:a.some((t=>{var i;return null==(i=e.labels)?void 0:i.includes(t)}))))).map((e=>({lawId:e.id,effectiveSince:e.effectiveSince})));i.acceptedLaws=[...s,n];const o=Ti(i);await sr.saveGame(i),e.commit("setGameState",{game:i}),e.dispatch("applyEvent",{event:o}),await sr.decisionMade(i,r,!0)},async rejectLaw(e,t){const i=l({},e.state.game);i.rejectedLaws=[...i.rejectedLaws,t.lawId],await sr.decisionMade(i,hi(t.lawId),!1),await sr.saveGame(i),e.commit("setGameState",{game:i})},async advanceYear(e){const t=l({},e.state.game),i=t.acceptedLaws.map(gi);t.currentYear++,t.values=function(e,t,i){const n=ft(e.values);return t.sort(((e,t)=>{var i,n;return(null==(i=e.treatAfterLabels)?void 0:i.some((e=>{var i;return null==(i=t.labels)?void 0:i.includes(e)})))?1:(null==(n=t.treatAfterLabels)?void 0:n.some((t=>{var i;return null==(i=e.labels)?void 0:i.includes(t)})))?-1:0})).forEach((t=>{const r=t.effects(o(l({},e),{values:n}),t.effectiveSince,i);yt({dispatch:()=>{},values:n},r)})),n.co2budget-=n.co2emissions,n}(t,i,t.currentYear),await sr.saveGame(t),e.commit("setGameState",{game:t})},async applyEvent(e,t){if(!t.event)return;const i=l({},e.state.game);await sr.eventOccurred(i,t.event);const n=t.event.apply(i);this.applyEffects(e,n)},acknowledgeEvent(e,t){const i=l({},e.state.game);i.events.find((e=>e.id===t.id)).acknowledged=!0,sr.saveGame(i),e.commit("setGameState",{game:i})},applyEffects(e,t){const i={dispatch:e.dispatch,values:e.state.game.values};yt(i,t);const n=o(l({},e.state.game),{values:i.values});sr.saveGame(n),e.commit("setGameState",{game:n})},setupTour(e){const t=localStorage.getItem("tour")||Fn[0].id,i=Fn.find((e=>t===e.id));i?e.commit("setTour",{step:i.id,active:!0}):lr.stopTour(e)},nextTourStep(e){const t=Fn.findIndex((t=>e.state.tour.step===t.id));if(t<0||t==Fn.length-1)lr.stopTour(e);else{const i=Fn[t+1];e.commit("setTour",{step:i.id,active:!0}),localStorage.setItem("tour",i.id)}},stopTour(e){e.commit("setTour",{step:"",active:!1}),localStorage.setItem("tour","completed")},async error(e,t){e.commit("error",t)}},or={setGameState(e,t){e.game=t.game},gameOver(e){e.game=o(l({},e.game),{over:!0})},setTour(e,t){e.tour=t},error(e,t){console.error(t.error),alert(t.error.message)}},ur={proposedLaws:e=>e.game&&e.game.proposedLaws?mi(e.game.proposedLaws):[]},cr=Symbol();function dr(){return T(cr)}const hr=L({state:{game:void 0,tour:{active:!0,step:"start"}},mutations:or,actions:lr,getters:ur});function gr(e,t){return e<t?-1:e>t?1:0}function mr(e,t){const i=ft(e.values);function n(e){return(e>0?"+":"")+e.toFixed(2)}function r(r){const a=function(e){const i=t.find((t=>"modify"===t.type&&t.name===e));return i&&i.condition?i.value:0}(r),s=i[r]-e.values[r];return a&&Math.abs(a-s)<.001?n(a):a?n(a)+" / "+n(s):0!=s?n(s):""}yt({dispatch:()=>{},values:i},t);return bt.map((t=>{return{id:t.name,unit:t.unit,value:(i=t.name,e.values[i].toFixed(2)),effect:r(t.name),class:t.writable?"writable":"calculated"};var i}))}var br=d({props:{citation:{type:Object,required:!0},showInternals:{type:Boolean,default:!1}},computed:{href(){return this.citation.url.toString()},title(){return this.citation.title||this.citation.url.toString()}}});const pr={key:0},fr=C(". "),vr={key:1},wr={key:2},yr=C("Bemerkung: "),kr=C(". "),Sr={key:3},Ar=C("Internes: "),Pr=C(". "),Dr={key:4},zr=C(". "),Wr={key:5},Vr=C(". "),Tr={key:6},Lr=C(". ");br.render=function(e,t,i,n,r,a){return y(),b("p",null,[e.citation.authors?(y(),b("span",pr,v(e.citation.authors+e.citation.dateString())+". ",1)):f("",!0),p("a",{target:"_blank",rel:"noreferrer noopener",href:e.href},'"'+v(e.title)+'"',9,["href"]),fr,e.citation.publisher?(y(),b("span",vr,v(e.citation.publisher)+". ",1)):f("",!0),e.citation.comment?(y(),b("span",wr,[yr,p("span",{innerHTML:e.citation.comment},null,8,["innerHTML"]),kr])):f("",!0),e.showInternals&&e.citation.internalComment?(y(),b("span",Sr,[Ar,p("span",{innerHTML:e.citation.internalComment},null,8,["innerHTML"]),Pr])):f("",!0),e.citation.referringUrl?(y(),b("span",Dr,[p("a",{target:"_blank",rel:"noreferrer noopener",href:e.citation.referringUrl.toString()},"Hier gefunden",8,["href"]),zr])):f("",!0),e.citation.archiveUrl?(y(),b("span",Wr,[p("a",{target:"_blank",rel:"noreferrer noopener",href:e.citation.archiveUrl.toString()},"Web Archiv Kopie",8,["href"]),Vr])):f("",!0),e.citation.localCopy?(y(),b("span",Tr,[p("a",{target:"_blank",rel:"noreferrer noopener",href:"/sources/"+e.citation.localCopy},"Kopie",8,["href"]),Lr])):f("",!0)])};var Cr=d({components:{Citation:br},setup(){const e=dr();return{store:e,game:z((()=>e.state.game))}},data:()=>({selectedTable:"laws",lawsSortCol:"state",lawsSortDir:1,eventsSortCol:"probability",eventsSortDir:-1,lawSelected:void 0,eventSelected:void 0,paramSelected:void 0}),methods:{sortLaws(e){e===this.lawsSortCol?this.lawsSortDir=this.lawsSortDir>0?-1:1:this.lawsSortDir=1,this.lawsSortCol=e},sortEvents(e){e===this.eventsSortCol?this.eventsSortDir=this.eventsSortDir>0?-1:1:this.eventsSortDir=1,this.eventsSortCol=e},selectLaw(e){this.unselect(),this.lawSelected=e},selectEvent(e){this.unselect(),this.eventSelected=e},selectParam(e){this.unselect(),this.paramSelected=e},unselect(){this.lawSelected=void 0,this.eventSelected=void 0,this.paramSelected=void 0}},computed:{startYearOfSelected(){if(!this.lawSelected||!this.game)return 2021;const e=this.game.acceptedLaws.find((e=>e.lawId===this.lawSelected));return e?e.effectiveSince:2021},selectedLaw(){return di.find((e=>e.id===this.lawSelected))},selectedEvent(){return zi.find((e=>e.id===this.eventSelected))},selectedParam(){return this.paramSelected?ut[this.paramSelected]:void 0},wParam(){const e=this.selectedParam;return e instanceof he?e:void 0},cParam(){const e=this.selectedParam;return e instanceof ge?e:void 0},citationsOfLaw(){return this.selectedLaw&&this.selectedLaw.citations?this.selectedLaw.citations:[]},effectsOfSelected(){if(!this.lawSelected||!this.game)return[];this.game;const e=this.selectedLaw;return e?e.effects(this.game,this.startYearOfSelected,this.game.currentYear):[]},sortedValues(){return this.game?mr(this.game,this.effectsOfSelected):[]},sortedLaws(){return this.game?function(e,t,i,n){const r=e.proposedLaws,a=e.acceptedLaws.map((e=>e.lawId)),s=e.rejectedLaws;return n.map((t=>{return{id:t.id,priority:t.priority(e),state:(i=t.id,a.includes(i)?"a":r.includes(i)?"p":s.includes(i)?"r":"x")};var i})).sort(((e,n)=>gr(e[t],n[t])*i)).map((e=>o(l({},e),{priority:e.priority.toFixed(2)})))}(this.game,this.lawsSortCol,this.lawsSortDir,di):[]},sortedEvents(){return this.game?(e=this.game,t=this.eventsSortCol,i=this.eventsSortDir,zi.map((t=>({id:t.id,probability:t.probability(e)}))).sort(((e,n)=>gr(e[t],n[t])*i)).map((e=>o(l({},e),{probability:(100*e.probability).toFixed(2)})))):[];var e,t,i}}});const Or=w("data-v-7bb3c05c");g("data-v-7bb3c05c");const Er={class:"peekData"},Br={key:0,class:"Details"},Mr={class:"Title"},Fr={class:"Description"},Ur=p("div",{class:"SectionHead"},"Details:",-1),Gr=p("div",{class:"SectionHead"},"Internes:",-1),xr=p("div",{class:"SectionHead"},"Referenzen:",-1),Ir={key:1,class:"Details"},_r={class:"Title"},Nr={class:"Description"},Kr=p("div",{class:"SectionHead"},"Details:",-1),jr=p("div",{class:"SectionHead"},"Internes:",-1),Hr=p("div",{class:"SectionHead"},"Referenzen:",-1),Jr={key:2,class:"Details"},Zr={class:"Title"},$r={key:0},Rr={key:1},Qr={key:2},qr=p("div",{class:"SectionHead"},"Details:",-1),Yr=p("div",{class:"SectionHead"},"Internes:",-1),Xr=p("div",{class:"SectionHead"},"Referenzen:",-1),ea={class:"paramsList"},ta={class:"numbercol"},ia={class:"effcol"},na={class:"buttonlist"},ra={class:"lawList"},aa={key:0},sa={class:"priocol"},la={class:"eventList"},oa={key:0},ua={class:"priocol"};m();const ca=Or(((e,t,i,n,r,a)=>{var s;const l=A("Citation");return y(),b("details",Er,[p("summary",{onClick:t[1]||(t[1]=t=>e.unselect()),class:"clickable"},"Peek"),e.selectedLaw?(y(),b("div",Br,[p("div",Mr,v(e.selectedLaw.title),1),p("div",Fr,v(e.selectedLaw.description),1),Ur,p("div",{class:"Section",innerHTML:e.selectedLaw.details},null,8,["innerHTML"]),Gr,p("div",{class:"Section",innerHTML:e.selectedLaw.internals},null,8,["innerHTML"]),xr,(y(!0),b(k,null,S(e.citationsOfLaw,((e,t)=>(y(),b(l,{class:"Section",key:t,citation:e},null,8,["citation"])))),128))])):f("",!0),e.selectedEvent?(y(),b("div",Ir,[p("div",_r,v(e.selectedEvent.title),1),p("div",Nr,v(e.selectedEvent.description),1),Kr,p("div",{class:"Section",innerHTML:e.selectedEvent.details},null,8,["innerHTML"]),jr,p("div",{class:"Section",innerHTML:e.selectedEvent.internals},null,8,["innerHTML"]),Hr,(y(!0),b(k,null,S(null==(s=e.selectedEvent)?void 0:s.citations,((e,t)=>(y(),b(l,{class:"Section",key:t,citation:e},null,8,["citation"])))),128))])):f("",!0),e.selectedParam?(y(),b("div",Jr,[p("div",Zr,v(e.paramSelected)+" ["+v(e.selectedParam.unit)+"]",1),e.wParam?(y(),b("div",$r,"Initial value: "+v(e.wParam.initialValue)+" "+v(e.wParam.unit),1)):f("",!0),e.cParam&&e.cParam.shouldInitiallyBe?(y(),b("div",Rr," Should initially be: "+v(e.cParam.shouldInitiallyBe)+" "+v(e.cParam.unit),1)):f("",!0),e.cParam?(y(),b("div",Qr," Calculation: "+v(e.cParam.valueGetter),1)):f("",!0),qr,p("div",{class:"Section",innerHTML:e.selectedParam.details},null,8,["innerHTML"]),Yr,p("div",{class:"Section",innerHTML:e.selectedParam.internals},null,8,["innerHTML"]),Xr,(y(!0),b(k,null,S(e.selectedParam.citations,((e,t)=>(y(),b(l,{class:"Section",key:t,citation:e},null,8,["citation"])))),128))])):f("",!0),p("div",ea,[p("table",null,[(y(!0),b(k,null,S(e.sortedValues,(t=>(y(),b("tr",{key:t.id,class:["clickable",t.class],onClick:i=>e.selectParam(t.id)},[p("td",null,v(t.id),1),p("td",ta,v(t.value),1),p("td",ia,v(t.effect),1),p("td",null,v(t.unit),1)],10,["onClick"])))),128))])]),p("div",null,[p("table",na,[p("tr",null,[p("td",{class:["clickable lawButton",e.selectedTable],onClick:t[2]||(t[2]=t=>e.selectedTable="laws")},"Laws",2),p("td",{class:["clickable eventButton",e.selectedTable],onClick:t[3]||(t[3]=t=>e.selectedTable="events")},"Events",2)])]),p("div",ra,["laws"===e.selectedTable?(y(),b("table",aa,[p("tr",null,[p("th",{onClick:t[4]||(t[4]=t=>e.sortLaws("state")),class:"clickable"},"S"),p("th",{onClick:t[5]||(t[5]=t=>e.sortLaws("id")),class:"clickable"},"ID"),p("th",{onClick:t[6]||(t[6]=t=>e.sortLaws("priority")),class:"clickable priocol"},"Priority")]),(y(!0),b(k,null,S(e.sortedLaws,(t=>(y(),b("tr",{key:t.id,class:["clickable",t.state],onClick:i=>e.selectLaw(t.id)},[p("td",null,v(t.state),1),p("td",null,v(t.id),1),p("td",sa,v(t.priority),1)],10,["onClick"])))),128))])):f("",!0)]),p("div",la,["events"===e.selectedTable?(y(),b("table",oa,[p("tr",null,[p("th",{onClick:t[7]||(t[7]=t=>e.sortEvents("id")),class:"clickable"},"ID"),p("th",{onClick:t[8]||(t[8]=t=>e.sortEvents("probability")),class:"clickable priocol"},"Probability")]),(y(!0),b(k,null,S(e.sortedEvents,(t=>(y(),b("tr",{key:t.id,class:"clickable",onClick:i=>e.selectEvent(t.id)},[p("td",null,v(t.id),1),p("td",ua,v(t.probability),1)],8,["onClick"])))),128))])):f("",!0)])])])}));Cr.render=ca,Cr.__scopeId="data-v-7bb3c05c";var da=d({components:{PeekInside:Cr},setup:()=>({store:dr(),devMode:"true"===localStorage.getItem("devMode")}),methods:{updateStyle(){const e=window.innerHeight,t=window.innerWidth,i=Math.min(e/800,t/1e3),n=(t-1e3*i)/2;document.documentElement.style.setProperty("--scale",`${i}`),document.documentElement.style.setProperty("--translateX",`${n}px`)}},mounted(){setTimeout(this.updateStyle,0),window.addEventListener("resize",this.updateStyle)}});const ha={class:"perspective"},ga={class:"peek"};da.render=function(e,t,i,n,r,a){const s=A("router-view"),l=A("PeekInside");return y(),b(k,null,[p("div",ha,[p(s)]),p("div",ga,[e.devMode?(y(),b(l,{key:0})):f("",!0)])],64)};const ma=O(da);ma.use(hr,cr),ma.use(nr),ma.mount("#app");
