var Gt=Object.defineProperty,Ut=Object.defineProperties;var Kt=Object.getOwnPropertyDescriptors;var Ze=Object.getOwnPropertySymbols;var Jt=Object.prototype.hasOwnProperty,Ht=Object.prototype.propertyIsEnumerable;var Ce=(e,t,n)=>t in e?Gt(e,t,{enumerable:!0,configurable:!0,writable:!0,value:n}):e[t]=n,x=(e,t)=>{for(var n in t||(t={}))Jt.call(t,n)&&Ce(e,n,t[n]);if(Ze)for(var n of Ze(t))Ht.call(t,n)&&Ce(e,n,t[n]);return e},G=(e,t)=>Ut(e,Kt(t));var W=(e,t,n)=>(Ce(e,typeof t!="symbol"?t+"":t,n),n);import{D as Ee,a as Re,s as Ye,b as jt,v as Zt,d as M,r as X,c as _,o as h,e as g,f as l,g as A,t as k,n as N,h as Le,u as C,p as fe,i as pe,F as J,j as R,k as ee,l as I,m as U,q as We,w as re,x as ye,y as Rt,z as Yt,A as Qt,B as qt,C as Xt,V as en,E as Qe,G as tn,H as nn,I as Q,J as rn}from"./vendor.5ac37eb4.js";const sn=function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))r(i);new MutationObserver(i=>{for(const a of i)if(a.type==="childList")for(const u of a.addedNodes)u.tagName==="LINK"&&u.rel==="modulepreload"&&r(u)}).observe(document,{childList:!0,subtree:!0});function n(i){const a={};return i.integrity&&(a.integrity=i.integrity),i.referrerpolicy&&(a.referrerPolicy=i.referrerpolicy),i.crossorigin==="use-credentials"?a.credentials="include":i.crossorigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function r(i){if(i.ep)return;i.ep=!0;const a=n(i);fetch(i.href,a)}};sn();const an={year:"numeric",month:"numeric",day:"numeric",hour:"numeric",minute:"numeric",second:"numeric",timeZoneName:"short"};class xe{constructor(t){W(this,"lux");t instanceof Re?this.lux=t.setLocale("de-DE").setZone("Europe/Berlin"):this.lux=Re.fromISO(t,{zone:"Europe/Berlin",locale:"de-DE"})}static durationBetween(t,n){return new Te(n.lux.diff(t.lux,["months"]))}plus(t){return new xe(this.lux.plus(t.lux))}getYear(){return this.lux.get("year")}toLocaleString(){return this.lux.toLocaleString(an)}toMonthString(){return this.lux.toLocaleString({month:"long",year:"numeric"})}toJSON(){return this.lux.toJSON()}}class Te{constructor(t){W(this,"lux");t instanceof Ee?this.lux=t:this.lux=Ee.fromISO(t,{locale:"de-DE"})}toMonthsString(){const t=this.lux.as("months");return t===1?"1 Monat":t+" Monate"}}function ke(e){return new xe(e)}function qe(e){return new Te(e)}function on(e){return new Te(Ee.fromDurationLike({month:e}))}const ue=2021,ln="2021-01-01",Xe=2050,et=qe("P3M"),un=qe("P3M"),tt=6,cn=.6;function V(e){return e}const be={newYear:2,timesUp:3,finanzKollaps:4,wahlVerloren:5,hitzehoelle:6};var dn=V({title:"Abstandsregeln f\xFCr Windkraft erneut im Fokus",description:"Anwohner wollen, dass der Abstand zu Windkraftanlagen erh\xF6ht wird. Das f\xFChrte zu einer Auseinandersetzung des Wirtschaftsministers mit der Umweltministerin.",laws:["AbstandsregelnFuerWindkraftVerschaerfen","AbstandsregelnFuerWindkraftWieBisher","AbstandsregelnFuerWindkraftLockern","AbstandsregelnFuerWindkraftAbschaffen"],apply(){return[]}});let Ve=Ye("",{state:!0}),nt=()=>Math.abs(Ve());function Oe(e){Ve=Ye(e.id,{state:e.prngState})}function hn(){return Ve.state()}const mn=e=>({time:et,text:`Braucht ${et.toMonthsString()}.`});function b(e,t="Braucht {months}."){const n=on(e),r=t.replace(/{months}/g,n.toMonthsString());return{time:n,text:r}}function y(e){return e}var gn=y({title:"Alles bleibt wie es ist",description:"Die vorhandenen Gesetze haben sich lange bew\xE4hrt. Wir lassen sie so, wie sie sind.",effort(e){return b(3,"Wie aussitzen: {months}.")},effects(){return[]},priority(e){return nt()}});const fn=new jt.exports.Converter;function rt(e){return e>0?[...Array(e)].map((t,n)=>n):[]}function it(e,t){const n=e-t-1;return[...rt(t),Math.max(t,n),...rt(n).reverse()]}function s(e,...t){let n=e.map((i,a)=>i+(t[a]||"")).join("").split(`
...
`))}function Ie(e){return t=>!e(t)}function st(e){return Object.entries(e).map(([t,n])=>G(x({},n),{id:t}))}function at(e,t){const n=e.value-t.value;return r=>{const i=e.result*(r-t.value)/n,a=t.result*(r-e.value)/n;return i-a}}const pn=new Intl.DateTimeFormat("de-DE");class F{constructor(t){W(this,"url");W(this,"title");W(this,"publisher");W(this,"authors");W(this,"date");W(this,"comment");W(this,"internalComment");W(this,"localCopy");W(this,"referringUrl");W(this,"archiveUrl");W(this,"archiveNotPossible");this.url=new URL(t.url),this.title=t.title,this.publisher=t.publisher,this.authors=t.authors,this.date=t.date?new Date(t.date):void 0,this.comment=t.comment,this.internalComment=t.internalComment,this.localCopy=t.localCopy,this.referringUrl=t.referringUrl?new URL(t.referringUrl):void 0,this.archiveUrl=t.archiveUrl?new URL(t.archiveUrl):void 0,this.archiveNotPossible=t.archiveNotPossible}dateString(){const t=this.date;return t?" ("+pn.format(t)+")":""}toString(){const t=this.authors?this.authors+this.dateString():void 0,n=this.title?'"'+this.title+'"':void 0;return[t,n,this.url,this.publisher].filter(r=>r).join(", ")}}function L(e){const t=e.publisher||e.authors,n=t!=null?t+": ":"",r=e.title||e.url.toString(),i=e.url.toString();return`[[${n}${r}](${i})]`}const bn=e=>e.map(t=>t.toString()).join("; "),vn=new F({url:"https://www.umweltrat.de/SharedDocs/Downloads/DE/01_Umweltgutachten/2016_2020/2020_Umweltgutachten_Kap_02_Pariser_Klimaziele.pdf?__blob=publicationFile&v=31",title:"Umweltgutachten 2020 Kapitel 2 Pariser Klimaziele",publisher:"Umweltrat",archiveUrl:"https://web.archive.org/web/20210828201134/https://www.umweltrat.de/SharedDocs/Downloads/DE/01_Umweltgutachten/2016_2020/2020_Umweltgutachten_Kap_02_Pariser_Klimaziele.pdf?__blob=publicationFile&v=31"}),te=new F({url:"https://energy-charts.info/charts/energy/chart.htm?l=en&c=DE&interval=year&year=2020",title:"Energy-Charts: Annual electricity generation in Germany in 2020",publisher:"Fraunhofer ISE",archiveNotPossible:!0,localCopy:"Bar Charts Electricity Generation Energy-Charts.pdf"}),ot=new F({url:"https://energy-charts.info/charts/installed_power/chart.htm?l=en&c=DE&stacking=grouped&year=2020",title:"Net installed electricity generation capacity in Germany in 2020",publisher:"Fraunhofer ISE",archiveNotPossible:!0,localCopy:"Installed Power _ Energy-Charts.pdf"}),lt=new F({url:"https://www.welt.de/wirtschaft/article173181909/Mineraloelsteuer-Einnahmen-auf-hoechstem-Stand-seit-14-Jahren.html",title:"Bund kassiert so viel Mineral\xF6lsteuer wie seit Jahren nicht",publisher:"welt.de",authors:"Birger Nicolai",date:"2018-02-04",archiveUrl:"https://web.archive.org/web/20201113072050/https://www.welt.de/wirtschaft/article173181909/Mineraloelsteuer-Einnahmen-auf-hoechstem-Stand-seit-14-Jahren.html"}),ut=new F({url:"https://www.welt.de/wirtschaft/article156562013/Steuervorteile-fuer-wenige-kosten-18-Milliarden-Euro.html",title:"Steuervorteile f\xFCr wenige kosten 18 Milliarden Euro",publisher:"welt.de",authors:"Martin Greive",date:"2016-06-26",archiveUrl:"https://web.archive.org/web/20201201122658/https://www.welt.de/wirtschaft/article156562013/Steuervorteile-fuer-wenige-kosten-18-Milliarden-Euro.html",comment:"",internalComment:""}),Se=new F({url:"https://epub.wupperinst.org/frontdoor/deliver/index/docId/7606/file/7606_CO2-neutral_2035.pdf",title:"CO2-neutral bis 2035: Eckpunkte eines deutschen Beitrags zur Einhaltung der 1,5-\xB0C-Grenze",publisher:"Wuppertal Institut",date:"2020-10",archiveUrl:"https://web.archive.org/web/20210916070821/https://epub.wupperinst.org/frontdoor/deliver/index/docId/7606/file/7606_CO2-neutral_2035.pdf"}),wn=new F({url:"https://wupperinst.org/fa/redaktion/downloads/projects/CO2-neutral_2035_Factsheet.pdf",title:"Schl\xFCsselergebnisse der Studie des Wuppertal Instituts f\xFCr Klima, Umwelt, Energie zu einem Beitrag Deutschlands zur Einhaltung der 1,5-\xB0C-Grenze",publisher:"Wuppertal Institut",date:"2020-10-13",archiveUrl:"https://web.archive.org/web/20210726125101/https://wupperinst.org/fa/redaktion/downloads/projects/CO2-neutral_2035_Factsheet.pdf",comment:`Summary of ${L(Se)}.`});Se.comment=s`Zusammengefasst in ${L(wn)}.`;const H=new F({url:"https://www.umweltbundesamt.de/sites/default/files/medien/361/dokumente/2021_03_10_trendtabellen_thg_nach_sektoren_v1.0.xlsx",referringUrl:"https://www.umweltbundesamt.de/daten/klima/treibhausgas-emissionen-in-deutschland#nationale-und-europaische-klimaziele",title:"Vorjahresch\xE4tzung der deutschen Treibhausgas-Emissionen f\xFCr das Jahr 2020",publisher:"Umweltbundesamt",date:"2021-03-15",archiveUrl:"https://web.archive.org/web/20210712115357/https://www.umweltbundesamt.de/sites/default/files/medien/361/dokumente/2021_03_10_trendtabellen_thg_nach_sektoren_v1.0.xlsx",comment:'Soweit nicht anders angegeben, werden die Werte aus Blatt "THG" Spalte 2019 verwendet'}),yn=new F({url:"https://cdr.eionet.europa.eu/de/eu/mmr/art07_inventory/ghg_inventory/envx7gqa/DEU_2021_2019_14012021_224203_started.xlsx/manage_document",referringUrl:"https://www.umweltbundesamt.de/daten/klima/treibhausgas-emissionen-in-deutschland?listpart=1#nationale-und-europaische-klimaziele",title:"Detaillierte Berichtstabellen CRF 2021 der deutschen Treibhausgas-Emissionen f\xFCr das Jahr 2019",publisher:"Umweltbundesamt",date:"2021-01-15",archiveUrl:"https://web.archive.org/web/20210830100630/https://cdr.eionet.europa.eu/de/eu/mmr/art07_inventory/ghg_inventory/envx7gqa/DEU_2021_2019_14012021_224203_started.xlsx",comment:""}),De=new F({url:"https://www.vdv.de/vdv-statistik-2019.pdfx",title:"2019 Statistik",publisher:"VDV",date:"2020-10-01",archiveUrl:"https://web.archive.org/web/20210714151304/https://www.vdv.de/vdv-statistik-2019.pdfx",comment:"Seite 11 enth\xE4lt CO2e-Emissions-Werte pro Personenkilometer [g/Pkm] f\xFCr mehrere Verkehrsmittel"}),Pe=new F({url:"https://www.vdv.de/daten-fakten.aspx",title:"2019 Statistik",publisher:"VDV",date:"2021-01-01",archiveUrl:"https://web.archive.org/web/20210526133828/https://www.vdv.de/daten-fakten.aspx",comment:"",internalComment:""}),ct=new F({url:"https://www.umweltbundesamt.de/daten/verkehr/emissionen-des-verkehrs#strassenguterverkehr",title:"Emissionen des Verkehrs - Stra\xDFeng\xFCterverkehr",publisher:"Umweltbundesamt",archiveUrl:"https://web.archive.org/web/20210712110744if_/https://www.umweltbundesamt.de/daten/verkehr/emissionen-des-verkehrs#strassenguterverkehr"}),ie=new F({url:"https://www.bmvi.de/SharedDocs/DE/Publikationen/G/verkehr-in-zahlen-2020-pdf.pdf?__blob=publicationFile",title:"Verkehr in Zahlen 2020/2021",publisher:"BMVI",date:"2021-04-13",archiveUrl:"https://web.archive.org/web/20210520124742/https://www.bmvi.de/SharedDocs/DE/Publikationen/G/verkehr-in-zahlen-2020-pdf.pdf?__blob=publicationFile",comment:"Seite 219 enth\xE4lt Personenkilometer-Jahreswerte f\xFCr mehrere Verkehrsmittel. Soweit nicht anders angegeben, werden die Werte aus Spalte 2019 verwendet"}),dt=new F({url:"https://bmvi.de/SharedDocs/DE/Dossier/OEPNV/oepnv-foerderung-des-bundes.html",title:"Finanzierung \xD6PNV",publisher:"BMVI",date:"2020-12-09",archiveUrl:"https://web.archive.org/web/20210605120822/https://www.bmvi.de/SharedDocs/DE/Dossier/OEPNV/oepnv-foerderung-des-bundes.html",comment:""}),Be=new F({url:"https://www.polarstern-energie.de/magazin/artikel/heizen-co2-vergleich-von-brennstoffen/#c7085",title:"Heizung: Wie viel CO2 dein Brennstoff verursacht",publisher:"Polarstern Magazin",date:"2021-07-26",archiveUrl:"https://web.archive.org/web/20210803113328/https://www.polarstern-energie.de/magazin/artikel/heizen-co2-vergleich-von-brennstoffen/#c7085",comment:"",internalComment:""}),kn=new F({url:"https://www.klimaneutral-handeln.de/php/kompens-berechnen.php#rechner",title:"CO2-Rechner",authors:"Horst Emse",date:"2021-08-03",archiveUrl:"https://web.archive.org/web/20210803121340/https://www.klimaneutral-handeln.de/php/kompens-berechnen.php",comment:"Quelle f\xFCr 160g CO2 pro kWh Fernw\xE4rme.",internalComment:"TODO #91: Direkte Quelle finden. Siehe auch [uba2008Fernwaerme]"});new F({url:"https://www.umweltbundesamt.de/sites/default/files/medien/publikation/long/3476.pdf",title:"Bestimmung spezifischer Treibhausgas-Emissionsfaktoren f\xFCr Fernw\xE4rme",authors:"Uwe R. Fritsche, Lothar Rausch",publisher:"Umweltbundesamt",date:"2008-05-01",archiveUrl:"https://web.archive.org/web/20210717204537/https://www.umweltbundesamt.de/sites/default/files/medien/publikation/long/3476.pdf",comment:"",internalComment:"Angebliche Quelle f\xFCr 160g CO2 pro kWh Fernw\xE4rme. TODO #91: Zahl nicht gefunden. Quelle recht alt."});const ht=new F({url:"https://www.rensmart.com/Calculators/KWH-to-CO2",title:"CO2(eq) emissions due to electricity generation (by source)",publisher:"RenSMART",date:"2021-01-01",archiveNotPossible:!0,localCopy:"Rensmart-KWH-to-CO2.pdf",comment:"",internalComment:"Refers to [ukgov2018kWhtoCO2]."}),Sn=new F({url:"https://assets.publishing.service.gov.uk/government/uploads/system/uploads/attachment_data/file/715425/Conversion_Factors_2018_-_Condensed_set__for_most_users__v01-01.xls",referringUrl:"https://www.gov.uk/government/publications/greenhouse-gas-reporting-conversion-factors-2018",title:"CO2(eq) emissions due to electricity generation (by source)",publisher:"UK Departments for Business, Energy & Industrial Strategy and for Envirnoment, Food & Rural Affairs",date:"2018-06-08",archiveUrl:"https://web.archive.org/web/20210521093351/https://assets.publishing.service.gov.uk/government/uploads/system/uploads/attachment_data/file/715425/Conversion_Factors_2018_-_Condensed_set__for_most_users__v01-01.xls",comment:"",internalComment:""}),mt=new F({url:"https://de.motor1.com/news/401639/autos-in-deutschland-zahlen-und-fakten/",title:"Autos in Deutschland: Zahlen und Fakten",authors:"Roland Hildebrandt",publisher:"motor1.com",date:"2020-03-02",archiveUrl:"https://web.archive.org/web/20210307063954/https://de.motor1.com/news/401639/autos-in-deutschland-zahlen-und-fakten/",comment:"",internalComment:"TODO #91: KBA als direkte Quelle w\xE4re besser."}),Dn=new F({url:"https://www.destatis.de/DE/Themen/Gesellschaft-Umwelt/Bevoelkerung/Bevoelkerungsstand/Tabellen/zensus-geschlecht-staatsangehoerigkeit-2020.html",title:"Bev\xF6lkerung nach Nationalit\xE4t und Geschlecht 2020",publisher:"Statistisches Bundesamt",date:"2021-07-21",archiveUrl:"https://web.archive.org/web/20210803151453/https://www.destatis.de/DE/Themen/Gesellschaft-Umwelt/Bevoelkerung/Bevoelkerungsstand/Tabellen/zensus-geschlecht-staatsangehoerigkeit-2020.html",comment:"",internalComment:""}),Pn=new F({url:"https://www.arbeitsagentur.de/news/arbeitsmarkt-vorjahre",title:"Entwicklung des Arbeitsmarkts 2020 in Deutschland",publisher:"Bundesagentur f\xFCr Arbeit",date:"2021-01-05",archiveUrl:"https://web.archive.org/web/20210803152007/https://www.arbeitsagentur.de/news/arbeitsmarkt-vorjahre",comment:"",internalComment:""}),_n=new F({url:"https://www.statistikportal.de/de/bruttoinlandsprodukt-vgr",title:"Bruttoinlandsprodukt (VGR)",publisher:"Statistische \xC4mter des Bundes und der L\xE4nder",date:"2021-03-30",archiveUrl:"https://web.archive.org/web/20210713024739/https://www.statistikportal.de/de/bruttoinlandsprodukt-vgr",comment:"",internalComment:""});new F({url:"https://de.wikipedia.org/wiki/Staatsverschuldung_Deutschlands",title:"Staatsverschuldung Deutschlands",publisher:"Wikipedia",date:"2021-06-30",archiveUrl:"https://web.archive.org/web/20210630204805/https://de.wikipedia.org/wiki/Staatsverschuldung_Deutschlands",comment:"",internalComment:""});const gt=new F({url:"https://www.duh.de/presse/pressemitteilungen/pressemitteilung/in-zeiten-des-klimawandels-sind-subventionsformen-wie-das-dienstwagenprivileg-einfach-nicht-mehr-ze/",title:"In Zeiten des Klimawandels sind Subventionsformen wie das Dienstwagenprivileg einfach nicht mehr zeitgem\xE4\xDF - Interview mit Prof. Stefan G\xF6ssling",publisher:"Deutsche Umwelthilfe",date:"2020-08-24",archiveUrl:"https://web.archive.org/web/20210410185937/https://www.duh.de/presse/pressemitteilungen/pressemitteilung/in-zeiten-des-klimawandels-sind-subventionsformen-wie-das-dienstwagenprivileg-einfach-nicht-mehr-ze/",comment:"",internalComment:""}),zn=new F({url:"https://phys.org/news/2021-09-economic-climate-higher-previously-thought.html",title:"Economic cost of climate change could be six times higher than previously thought",publisher:"University College London",date:"2021-09-06",archiveUrl:"https://web.archive.org/web/20210915122616/https://phys.org/news/2021-09-economic-climate-higher-previously-thought.html",comment:"Corresponding publication: Jarmo S Kikstra et al, The social cost of carbon dioxide under climate-economy feedbacks and temperature variability, Environmental Research Letters (2021). DOI: 10.1088/1748-9326/ac1d0b",internalComment:""}),ft=new F({url:"https://www1.wdr.de/nachrichten/benzinpreis-klima-kohlendioxid-steuern-100.html",title:"",publisher:"WDR",date:"2021-09-06",archiveUrl:"https://web.archive.org/web/20210909151034/https://www1.wdr.de/nachrichten/benzinpreis-klima-kohlendioxid-steuern-100.html",comment:"",internalComment:""}),An=new F({url:"https://de.wikipedia.org/wiki/Betzsches_Gesetz",title:"Betzsches Gesetz",publisher:"Wikipedia"}),pt=new F({url:"https://ag-energiebilanzen.de/index.php?article_id=29&fileName=awt_2020_d.pdf",title:"Auswertungstabellen zur Energiebilanz Deutschland - Daten f\xFCr die Jahre von 1990 bis 2020",publisher:"AG Energiebilanzen e.V.",date:"2021-09",archiveUrl:"https://web.archive.org/web/20211008095222/https://ag-energiebilanzen.de/index.php?article_id=29&fileName=awt_2020_d.pdf",comment:"",internalComment:""});class bt{constructor(t){W(this,"unit");W(this,"citations");W(this,"details");W(this,"internals");this.unit=t.unit,this.citations=t.citations?t.citations:[],this.details=t.details?t.details:"",this.internals=t.internals?t.internals:""}citationsDesc(){return bn(this.citations)}}const Fn={MioTons:e=>e<0?0:e,TWh:e=>e<0?0:e,MrdEuro:e=>e,TsdPeople:e=>e<0?0:e,Percent:e=>e>100?100:e<0?0:e,GramPerPsgrKm:e=>e<0?0:e,MioPsgrKm:e=>e<0?0:e};class P extends bt{constructor(t){super(t);W(this,"writable",!0);W(this,"initialValue");W(this,"applyBounds");this.initialValue=t.initialValue,this.applyBounds=t.applyBounds||Fn[t.unit]}}class Z extends bt{constructor(t){super(t);W(this,"writable",!1);W(this,"valueGetter");W(this,"shouldInitiallyBe");this.valueGetter=t.valueGetter,this.shouldInitiallyBe=t.shouldInitiallyBe}}const Cn=new P({unit:"MioTons",initialValue:6700,citations:[vn],details:s`
  ...
  `}),Ln=new Z({unit:"MioTons",valueGetter(e){return e.carUsage*(1-e.carRenewablePercentage/100)*e.carEmissionFactor/1e6+14.4},shouldInitiallyBe:159.696,citations:[H,ct],details:s`

  `,internals:s`
    ${L(H)}: 159.696 as MioTons

    ${L(ct)}: 47.4 MioTons CO2e pro Jahr durch LKW in 2019.

    TODO: #72 Hier wird 14.4 MioTons verwendet, um die korrekten Gesamtemissionen zu erhalten.
  `}),Wn=new Z({unit:"MioTons",valueGetter(e){return e.co2emissionsStreetVehicles+e.publicLocalCapacity*65/1e6+e.publicNationalCapacity*32/1e6+e.airDomesticUsage*222/1e6+1.641},citations:[De,H],details:s`
  ...
  `}),xn=new Z({unit:"MioTons",valueGetter(e){return e.buildingsSourceBio*0+e.buildingsSourceGas*.247+e.buildingsSourceOil*.318+e.buildingsSourceTele*.16},citations:[H,Be],details:s`

  `,internals:s`
    TODO: #91 Gibt es hier bessere Quellen?

    ${L(Be)}: 247g CO2 pro kWh Erdgas.

    ${L(Be)}: 318g CO2 pro kWh Erdöl.
  ...
  `}),On=new Z({unit:"MioTons",valueGetter(e){return e.electricityGas*.399+e.electricitySolar*.058+e.electricityWind*.005+e.electricityWater*.02+e.electricityHardCoal*.835+e.electricityBrownCoal*1.137+e.electricityBiomass*.03+e.electricityNuclear*.005},citations:[ht,H],details:s`
  ...
  `}),In=new Z({unit:"MioTons",valueGetter(e){return e.co2emissionsEnergy+e.co2emissionsIndustry+e.co2emissionsMobility+e.co2emissionsBuildings+e.co2emissionsAgriculture+e.co2emissionsOthers},details:s`
...
Relative efficiency of wind turbines in percent of the current efficiency (about 40%).
  ...
  `}),Rn=new Z({unit:"TWh",valueGetter(e){return e.electricityHardCoal+e.electricityBrownCoal},details:s`

  `,internals:s`

  `}),Yn=new Z({unit:"TWh",valueGetter(e){return e.electricityDemand-e.electricitySolar-e.electricityWind-e.electricityWater-e.electricityHardCoal-e.electricityBrownCoal-e.electricityBiomass-e.electricityNuclear},details:s`

  `,internals:s`
    Mit Gaskraftwerken wird derzeit der benötigte Strom produziert,
    der nicht über andere Wege erzeugt wird.
  `}),Qn=new P({unit:"GramPerPsgrKm",initialValue:160,citations:[De],details:s`

  `,internals:s`
    ${L(De)} Seite 11 ergibt ca. 160 g/Pkm.
  `}),qn=new P({unit:"MioPsgrKm",initialValue:917e3,citations:[ie],details:s`

  `,internals:s`

  `}),Xn=new P({unit:"Percent",initialValue:.5,citations:[mt],details:s`

  `,internals:s`
    Die verschiedenen Zahlen in ${L(mt)}
...
Siehe \`publicLocalCapacity\`.
  ...
  `}),ar=new Z({unit:"MioPsgrKm",valueGetter(e){return e.carUsage+e.publicLocalUsage+e.publicNationalUsage+e.airDomesticUsage+e.airIntlUsage},shouldInitiallyBe:1168700,citations:[ie],details:s`
...
TODO: #78 Quelle für Anfangswert 544 TWh.
  `}),ur=new Z({unit:"TWh",valueGetter(e){return e.buildingsPrivateDemand+e.buildingsIndustryDemand},shouldInitiallyBe:770,citations:[],details:s`

  `,internals:s`
    TODO: #78 Quelle ${L(pt)} gibt diese Zahlen nicht her.
...
TODO: #78 Quelle für Anfangswert 58 TWh.
  `}),mr=new Z({unit:"TWh",valueGetter(e){return e.buildingsDemand-(e.buildingsSourceBio+e.buildingsSourceOil+e.buildingsSourceTele)},citations:[],details:s`
...
`}),gr=new P({unit:"Percent",initialValue:50,citations:[],details:s`
Prozentsatz der Bevölkerung, der Dich als Kanzler akzeptiert.
  `,internals:s`

  `}),fr=new P({unit:"TsdPeople",initialValue:83155.031,citations:[Dn],details:s`
...
Anfangswert ist die deutsche Staatsverschuldung 2019.
  ...
  `,internals:s`
    ...
    - Der Staatshaushalt wird jährlich mit 3 Mrd € mehr belastet. (${L(dt)})
  ...
  `,internals:s`
    ...
    - Der Staatshaushalt wird jährlich mit 10 Mrd € stärker belastet.
        - 13.3 Mrd € Ticketeinnahmen pro Jahr (${L(Pe)})
  ...
  `,internals:s`
    ...
    - 50%
  `}),ui=y({title:"Wirksamer CO2 Preis",description:"Eine Tonne CO2 kostet ab jetzt 150 Euro.",labels:["CO2Preis"],removeLawsWithLabels:["CO2Preis"],effort(e){return b(8)},effects(e,t,n){return[...Ne(e,150,-2,$e({value:80,result:0},{value:50,result:-3}))]},priority(e){return w(e,"CO2PreisErhoehen")?50:0},citations:[ft],details:s`
  ...
  `,apply(){return[se("gameOver")]},probability(e){return e.values.stateDebt>ce.stateDebt*2?be.finanzKollaps:0}}),Wi=V({title:"Hitzeh\xF6lle",description:`Die CO2-Werte sind soweit gestiegen, dass die Erde nur noch an wenigen Orten bewohnbar ist. Die ehemaligen K\xFCstenregionen
  ...
  `,apply(){return[se("gameOver")]},probability(e){return e.values.co2budget<=0?be.hitzehoelle:0}}),xi=V({title:"Happy New Year!",description:`Mal wieder geht ein ereignisreiches Jahr zuende. Die Regierung hat eine Bilanz ihrer bisherigen T\xE4tigkeit aufgestellt
  ...
  `,apply(){return[se("advanceYear")]},probability(e){return ke(e.currentDate).getYear()>e.currentYear?be.newYear:0}}),Ti=V({title:"Social Media Alarm!",description:`Deine Wahlkampfberaterin ruft dich v\xF6llig aufgel\xF6st an. Ob denn an den Geschichten was dran sein, die da im
  ...
  `,apply(){return[se("gameOver")]},probability(e){return e.currentYear===2050?be.timesUp:0}}),Ii=V({title:"Wahl verloren",description:`Deine Beliebtheit in der Bev\xF6lkerung ist katastrophal, lieber w\xFCrde man Mao Zedong w\xE4hlen als dich.
  ...
  `,apply(){return[se("gameOver")]},probability(e){return e.values.popularity<=0?be.wahlVerloren:0}}),Bi=V({title:"Abstimmung zur Ausschreibung von Windkraftanlagen",description:"Heute findet die Abstimmung im Bundestag zur weiteren Ausschreibung von Windkraftanlagen statt. Die Meinungen der Parteien sind sehr unterschiedlich.",laws:["AusschreibungsverfahrenfuerWindkraftWieBisher","AusschreibungsverfahrenfuerWindkraftVerdoppeln","AusschreibungsverfahrenfuerWindkraftVervierfachen","AusschreibungsverfahrenfuerWindkraftVerachtfachen"],apply(){return[]},citations:[],details:s`
    # Bauarbeiten
  ...
  `}),Ni=V({title:"Staatsoberhaupt verstorben",description:"Du stirbst an der neuen BSE Variante. Tja, h\xE4ttest du dich mal besser um das Tierwohl gek\xFCmmert...",apply(){return[se("gameOver")]},probability(e){return _e(e.acceptedLaws.map(n=>n.lawId)).find(n=>n.title.match(/tierwohl/i))?0:.5},laws:[],citations:[],details:s`
  ...
  `}),ji=V({title:"Debatte \xFCber CO2-Preise",description:"Eine marktliberale Kampagne ist sehr erfolgreich darin, Dich als Verbots-Kanzler hinzustellen. Aus allen Richtungen prasseln Forderungen nach einem ad\xE4quaten CO2-Preis auf Dich ein. Nur leider gehen die Vorstellungen \xFCber den genauen Preis sehr weit auseinander.",laws:["CO2PreisErhoehen","WirksamerCO2Preis","VollerCO2Preis"],apply(){return[]},probability(e){const t=(w(e,"AutosInInnenstaedtenVerbieten")?1:0)+(w(e,"KohleverstromungEinstellen")?1:0)+(w(e,"SolarAufAllenDaechernVerpflichtend")?1:0)+(w(e,"Tempolimit130AufAutobahnen")?1:0)+(w(e,"Tempolimit120AufAutobahnen")?1:0)+(w(e,"Tempolimit100AufAutobahnen")?1:0);return v(1,3,t)/100}});const Zi={AbstandsregelnWindkraft:dn,Altbausanierung:Fi,Bestechung:Ci,EnergieStrategie:Ei,FinanzKollaps:Li,Hitzehoelle:Wi,NewYear:xi,SocialMedia:Ti,TempolimitAufAutobahnen:Vi,TimesUp:Oi,WahlVerloren:Ii,WindkraftAusschreibung:Bi,SolarstromFoerderung:Mi,AtomKatastrophe:$i,BSE:Ni,Duerrewelle:Gi,PRKohleindustrie:Ui,PRInnenminister:Ki,Klimafluechtlinge:Ji,Plagiatsaffaere:Hi,CO2PreisDebatte:ji},Ri=()=>.5,Ae=st(Zi).map(e=>G(x({},e),{probability:e.probability||Ri})),At={currentDate:ln,currentYear:ue,values:ce,acceptedLaws:[],proposedLaws:[],rejectedLaws:[],events:[],over:!1,prngState:{}};function Ge(e=At,t=Zt()){return{id:t,currentDate:e.currentDate,currentYear:e.currentYear,acceptedLaws:e.acceptedLaws,proposedLaws:e.proposedLaws,rejectedLaws:e.rejectedLaws,values:de(e.values),events:e.events,over:e.over,prngState:{}}}function Ft(e=ae,t=At){const n=Ge(t);return n.acceptedLaws=e.filter(r=>{var i;return(i=r.labels)==null?void 0:i.includes("initial")}).map(r=>({lawId:r.id,effectiveSince:n.currentYear})),n}const he=[...Array(Xe-ue+1).keys()].map(e=>e+ue);function Yi(e,t){const n={lawId:e,effectiveSince:t.currentYear+1},r=ve(n),i=r.effort(t);t.currentDate=ke(t.currentDate).plus(i.time).toJSON();const a=r.removeLawsWithLabels,u=t.acceptedLaws.map(ve).filter(m=>!(a==null?void 0:a.some(c=>{var f;return(f=m.labels)==null?void 0:f.includes(c)}))).map(m=>({lawId:m.id,effectiveSince:m.effectiveSince}));return t.acceptedLaws=[...u,n],Ue(t)}function Qi(e){return e.currentDate=ke(e.currentDate).plus(un).toJSON(),Ue(e)}function Ue(e,t=ae,n=Ae,r=nt){const i=qi(e,n,r);if(i){const u={id:i.id,occuredIn:e.currentYear,acknowledged:!1};e.events.unshift(u)}const a=rs(e,t,(i==null?void 0:i.laws)?i.laws:[]);return e.proposedLaws=is(e.proposedLaws,a),i}function qi(e,t,n){const r=Xi(e,t),i=es(r);if(i)return i;const a=ts(r);return ns(a,n())}function Xi(e,t){return t.map(n=>G(x({},n),{prob:n.probability(e)})).filter(n=>n.prob>0)}function es(e){return e.filter(t=>t.prob>1).reduce((t,n)=>n.prob>((t==null?void 0:t.prob)||0)?n:t,void 0)}function ts(e){const t=e.map(r=>r.prob).reduce((r,i)=>r+i,0),n=cn/t;return e.map(r=>G(x({},r),{prob:r.prob*n}))}function ns(e,t){for(const n of e)if(t-=n.prob,t<0)return n}function rs(e,t,n){const r=c=>{var f;return(f=e.acceptedLaws)==null?void 0:f.some(S=>S.lawId===c.id)},i=c=>{var f;return(f=e.rejectedLaws)==null?void 0:f.includes(c.id)},a=c=>{var f;return((f=c.labels)==null?void 0:f.includes("hidden"))||!1},u=c=>({law:c,priority:c.priority(e)}),m=c=>({law:c.law,priority:c.priority+(n.includes(c.law.id)?100:0)});return t.filter(Ie(r)).filter(Ie(i)).filter(Ie(a)).map(u).filter(c=>c.priority>0).map(m).sort((c,f)=>f.priority-c.priority).map(c=>c.law.id).slice(0,tt)}function is(e,t){const n=[...e],r=t.filter(u=>n.includes(u)),i=t.filter(u=>!r.includes(u));for(var a=0;a<n.length;){if(r.includes(n[a])){a++;continue}if(i.length===0){n.splice(a,1);continue}n[a]=i.shift(),a++}return n.push(...i.slice(0,tt-n.length)),n}function ss(e,t,n){return Ct(e,t,n).values}function Ct(e,t,n){const r=de(e.values),i=t.sort((u,m)=>{var c,f;return((c=u.treatAfterLabels)==null?void 0:c.some(S=>{var p;return(p=m.labels)==null?void 0:p.includes(S)}))?1:((f=m.treatAfterLabels)==null?void 0:f.some(S=>{var p;return(p=u.labels)==null?void 0:p.includes(S)}))?-1:0}).filter(u=>u.effectiveSince<=n),a=_i(i,u=>{const m=kr(r),c=u.effects(G(x({},e),{values:r}),u.effectiveSince,n);return Me({dispatch:()=>{},values:r},c),m},(u,m,c)=>r[c]-m[c]);return r.co2budget-=r.co2emissions,{values:r,effectsOfLaws:a}}function Et(e){return Math.max(0,Math.min(100,e))}function as(e){if(e.values.co2emissions===0)return 100;const n=e.values.co2budget*de(ce).co2emissions/ce.co2budget/e.values.co2emissions;return Et(n*50)}function os(e){const t=e.values.stateDebt/ce.stateDebt;return Et(100-t*50)}const me=[{id:"start",title:"Stell dir vor...",text:s`
      ### ... du bist Politiker.
    ...
    `},{id:"room",title:"Dein Arbeitszimmer",text:"Dies ist das Zimmer, in dem Du arbeitest und Entscheidungen triffst."},{id:"desk",title:"Dein Schreibtisch",text:"Du sitzt an Deinem Schreibtisch und findest dort immer wieder Gesetzesvorhaben, unter denen du ausw\xE4hlen musst.",highlight:"table"},{id:"finances",title:"Die Staatsfinanzen",text:"Auf Deinem Schreibtisch siehst Du, wie viel Geld der Staat noch hat, um Deine Entscheidungen umzusetzen.",highlight:"finances"},{id:"popularity",title:"Die W\xE4hler",text:"Wenn Du aus dem Fenster schaust, siehst Du, in welcher Stimmung Deine W\xE4hler sind.",highlight:"popularity"},{id:"climate",title:"Das Klima",text:"Die Pflanze in der Ecke zeigt Dir, wie sich das Klima entwickelt.",highlight:"plant"}];function ls(e,t){return{startGame(n){const r=Ft(),i=Ue(r);t.createGame(r),n.commit("setGameState",{game:r}),n.dispatch("applyEvent",{event:i}),e.push("/games/"+r.id)},async loadGame(n,r){var i;if(((i=n.state.game)==null?void 0:i.id)!==r.gameId)try{const a=await t.loadGame(r.gameId);t.saveGame(a),e.push("/games/"+a.id+(a.over?"/over":"")),n.commit("setGameState",{game:a})}catch(a){n.dispatch("error",{error:a})}},gameOver(n){var r;n.commit("gameOver",void 0),e.push("/games/"+((r=n.state.game)==null?void 0:r.id)+"/over")},acceptLaw(n,r){const i=x({},n.state.game),a=Yi(r.lawId,i);t.saveGame(i),n.commit("setGameState",{game:i}),n.dispatch("applyEvent",{event:a}),t.decisionMade(i,r.lawId,!0)},rejectLaw(n,r){const i=x({},n.state.game);i.rejectedLaws=[...i.rejectedLaws,r.lawId],t.decisionMade(i,r.lawId,!1),t.saveGame(i),n.commit("setGameState",{game:i})},sitOut(n){const r=x({},n.state.game);t.decisionMade(r,"sitOut",!0);const i=Qi(r);t.saveGame(r),n.commit("setGameState",{game:r}),n.dispatch("applyEvent",{event:i})},advanceYear(n){const r=x({},n.state.game),i=r.acceptedLaws.map(ve);r.currentYear++,r.values=ss(r,i,r.currentYear),t.saveGame(r),n.commit("setGameState",{game:r})},applyEvent(n,r){if(!r.event)return;const i=x({},n.state.game);t.eventOccurred(i,r.event);const a=r.event.apply(i);n.dispatch("applyEffects",{changes:a})},acknowledgeEvent(n,r){const i=x({},n.state.game);i.events.find(a=>a.id===r.id).acknowledged=!0,t.saveGame(i),n.commit("setGameState",{game:i})},applyEffects(n,r){const i={dispatch:n.dispatch,values:de(n.state.game.values)};Me(i,r.changes);const a=G(x({},n.state.game),{values:i.values});t.saveGame(a),n.commit("setGameState",{game:a})},setupTour(n){const r=localStorage.getItem("tour")||me[0].id,i=me.find(a=>r===a.id);i?n.commit("setTour",{step:i.id,active:!0}):n.dispatch("stopTour")},nextTourStep(n){const r=me.findIndex(i=>n.state.tour.step===i.id);if(r<0||r==me.length-1)n.dispatch("stopTour");else{const i=me[r+1];n.commit("setTour",{step:i.id,active:!0}),localStorage.setItem("tour",i.id)}},stopTour(n){n.commit("setTour",{step:"",active:!1}),localStorage.setItem("tour","completed")},error(n,r){n.commit("error",r)}}}const us={setGameState(e,t){e.game=t.game},gameOver(e){e.game=G(x({},e.game),{over:!0})},setTour(e,t){e.tour=t},error(e,t){console.error(t.error),alert(t.error.message)}},cs={proposedLaws(e){return!e.game||!e.game.proposedLaws?[]:_e(e.game.proposedLaws)}},ds={game:void 0,tour:{active:!0,step:"start"}};var $=(e,t)=>{const n=e.__vccOpts||e;for(const[r,i]of t)n[r]=i;return n};const hs=e=>(fe("data-v-1017d1c6"),e=e(),pe(),e),ms={key:0,type:"radio"},gs=hs(()=>l("br",null,null,-1)),fs={key:0,class:"button-bar"},ps=M({props:{law:null,selectable:{type:Boolean},numCards:null},emits:["selected","accepted"],setup(e,{emit:t}){const n=e,r=X(!1),i=_(()=>n.law.zIndex);function a(){t("selected")}function u(){r.value=!0}function m(c){c.animationName.match(/^twistOut-/)&&t("accepted",n.law.id)}return(c,f)=>(h(),g("div",{class:N(["Law",{accepted:r.value}]),style:Le({zIndex:C(i)}),onClick:a,onAnimationend:m},[l("label",null,[e.selectable?(h(),g("input",ms)):A("",!0),l("div",null,[l("h3",null,k(e.law.title),1),l("div",null,k(e.law.description),1),gs,l("div",null,k(e.law.effortComment),1),e.selectable?(h(),g("div",fs,[l("button",{class:"accept",onClick:u},"\u2713")])):A("",!0)])])],38))}});var bs=$(ps,[["__scopeId","data-v-1017d1c6"]]);const vs=M({setup(e){const t=oe(),n=X([]),r=X(!1),i=_(()=>t.getters.proposedLaws),a=_(()=>t.state.game),u=_(()=>(n.value.length||(n.value=it(i.value.length,0)),a.value===void 0?[]:i.value.map((S,p)=>G(x({},S),{zIndex:n.value[p],pos:p,effortComment:S.effort(a.value).text}))));function m(S){t.dispatch("acceptLaw",{lawId:S})}function c(S){n.value=it(i.value.length,S)}function f(){t.dispatch("sitOut")}return(S,p)=>(h(),g(J,null,[l("div",{class:N(["ProposedLaws",{poppedUp:r.value}]),onClick:p[0]||(p[0]=d=>r.value=!0)},[(h(!0),g(J,null,R(C(u),(d,z)=>(h(),ee(bs,{key:d.id,law:d,selectable:r.value,numCards:C(u).length,onAccepted:()=>m(d.id),onSelected:()=>c(z)},null,8,["law","selectable","numCards","onAccepted","onSelected"]))),128))],2),l("div",{class:"sitOutButton",onClick:p[1]||(p[1]=()=>f())},"Aussitzen")],64))}});var ws=$(vs,[["__scopeId","data-v-7616326e"]]);const ys={key:0},ks=M({props:{title:null,text:null},emits:["acknowledge"],setup(e,{emit:t}){function n(){t("acknowledge")}return(r,i)=>e.text?(h(),g("div",{key:0,onClick:n},[e.title?(h(),g("h2",ys,k(e.title),1)):A("",!0),l("p",null,k(e.text),1)])):A("",!0)}});var Ss=$(ks,[["__scopeId","data-v-089babdc"]]),Ds="/assets/money-short.7ce9dbed.png",Ps="/assets/money-less.184321f3.png",_s="/assets/money-more.44dccbaa.png",zs="/assets/money-much.d486dae1.png";const As={class:"container"},Fs={class:"title"},Cs={class:"progress-bar"},Es=M({props:{title:null,value:null},setup(e){const t=e,n=_(()=>{const r=t.value>40?"green":t.value>20?"goldenrod":"red";return{width:t.value+"%",backgroundColor:r}});return(r,i)=>(h(),g("div",As,[l("div",Fs,k(e.title),1),l("div",Cs,[l("div",{class:"indicator",style:Le(C(n))},null,4)])]))}});var Ke=$(Es,[["__scopeId","data-v-9856b0a2"]]);const Ls={id:"finances"},Ws={key:0,src:Ds,id:"short"},xs={key:1,src:Ps,id:"less"},Ts={key:2,src:_s,id:"more"},Vs={key:3,src:zs,id:"much"},Os=M({props:{value:null},setup(e){const t=e,n=_(()=>t.value),r=_(()=>t.value<20),i=_(()=>t.value>=20&&t.value<50),a=_(()=>t.value>=50&&t.value<80),u=_(()=>t.value>=80);return(m,c)=>(h(),g("div",Ls,[I(Ke,{id:"indicator",title:"Finanzen",value:C(n)},null,8,["value"]),C(r)?(h(),g("img",Ws)):A("",!0),C(i)?(h(),g("img",xs)):A("",!0),C(a)?(h(),g("img",Ts)):A("",!0),C(u)?(h(),g("img",Vs)):A("",!0)]))}});var Is=$(Os,[["__scopeId","data-v-0b2fb0e8"]]),Bs="/assets/people-happy.acaffc0b.png",Ms="/assets/people-angry.54c1d60c.png";const $s={id:"popularity"},Ns={key:0,src:Bs,id:"happy"},Gs={key:1,src:Ms,id:"angry"},Us=M({props:{value:null},setup(e){const t=e,n=_(()=>t.value>=50),r=_(()=>t.value<50);return(i,a)=>(h(),g("div",$s,[I(Ke,{id:"indicator",title:"Beliebtheit",value:e.value},null,8,["value"]),C(n)?(h(),g("img",Ns)):A("",!0),C(r)?(h(),g("img",Gs)):A("",!0)]))}});var Ks=$(Us,[["__scopeId","data-v-4cf2dbec"]]),Js="/assets/plant-healthy.97772624.png",Hs="/assets/plant-sick.5a0f1b46.png",js="/assets/plant-withered.b50106c7.png";const Zs={id:"plant"},Rs=["src","id"],Ys=M({props:{value:null},setup(e){const t=e,n={healthy:Js,sick:Hs,withered:js},r=_(()=>t.value>66?"healthy":t.value>33?"sick":"withered"),i=_(()=>n[r.value]);return(a,u)=>(h(),g("div",Zs,[I(Ke,{id:"indicator",title:"CO2-Budget",value:e.value},null,8,["value"]),l("img",{src:C(i),id:C(r)},null,8,Rs)]))}});var Qs=$(Ys,[["__scopeId","data-v-2db3389a"]]);const qs={id:"calendar"},Xs=M({props:{year:null,month:null},setup(e){const t=e,n=_(()=>{const r=Math.floor((t.month-1)/4)*18+27+"%",i=(t.month-1)%4*21+12+"%";return{top:r,left:i}});return(r,i)=>(h(),g("div",qs,[U(k(e.year)+" ",1),l("span",{id:"month-indicator",style:Le(C(n))},null,4)]))}});var ea=$(Xs,[["__scopeId","data-v-78901c78"]]),ta="/assets/heater.43006232.png";const na={},ra=e=>(fe("data-v-c9039a0c"),e=e(),pe(),e),ia={id:"heater"},sa=ra(()=>l("img",{src:ta},null,-1)),aa=[sa];function oa(e,t){return h(),g("div",ia,aa)}var la=$(na,[["render",oa],["__scopeId","data-v-c9039a0c"]]),ua="/assets/table-top.c87bd2fd.png",Lt="/assets/table-front.78c0f8c6.png",Wt="/assets/table-side.49774a53.png";const ca={},we=e=>(fe("data-v-1ef8d93c"),e=e(),pe(),e),da={id:"table"},ha=we(()=>l("img",{src:ua,id:"table-top"},null,-1)),ma=we(()=>l("img",{src:Lt,id:"table-front"},null,-1)),ga=we(()=>l("img",{src:Lt,id:"table-back"},null,-1)),fa=we(()=>l("img",{src:Wt,id:"table-left-side"},null,-1)),pa=we(()=>l("img",{src:Wt,id:"table-right-side"},null,-1)),ba=[ha,ma,ga,fa,pa];function va(e,t){return h(),g("div",da,ba)}var wa=$(ca,[["render",va],["__scopeId","data-v-1ef8d93c"]]),ya="/assets/board-front.41330f02.png",xt="/assets/board-side.d7181ded.png",ka="/assets/tv-front.82df5c0c.png",Sa="/assets/news.c4bbc2d0.png",Tt="/assets/tvset-legs.78b387df.png";const Da=M({props:{withNews:Boolean}}),Je=e=>(fe("data-v-118e7bdf"),e=e(),pe(),e),Pa={id:"tvset"},_a=Je(()=>l("div",{id:"board"},[l("img",{id:"board-front",src:ya}),l("img",{id:"board-left",src:xt}),l("img",{id:"board-right",src:xt}),l("div",{id:"board-top"})],-1)),za={id:"tv"},Aa=Je(()=>l("img",{id:"tv-front",src:ka},null,-1)),Fa={key:0,id:"news",src:Sa},Ca=Je(()=>l("div",{id:"legs"},[l("img",{id:"legs-front",src:Tt}),l("img",{id:"legs-back",src:Tt})],-1));function Ea(e,t,n,r,i,a){return h(),g("div",Pa,[_a,l("div",za,[Aa,e.withNews?(h(),g("img",Fa)):A("",!0)]),Ca])}var La=$(Da,[["render",Ea],["__scopeId","data-v-118e7bdf"]]);const Wa={},xa={class:"dialog"},Ta={class:"buttons"};function Va(e,t){return h(),g("div",xa,[We(e.$slots,"default",{},void 0,!0),l("div",Ta,[We(e.$slots,"buttons",{},void 0,!0)])])}var Vt=$(Wa,[["render",Va],["__scopeId","data-v-620b183d"]]);const Oa=M({setup(){const e=oe();return e.dispatch("setupTour"),{store:e}},components:{Dialog:Vt},mounted(){this.setHighlight(this.currentStep)},computed:{currentStep(){return me.find(e=>e.id===this.$store.state.tour.step)},title(){var e;return(e=this.currentStep)==null?void 0:e.title},text(){var e;return(e=this.currentStep)==null?void 0:e.text}},watch:{currentStep(e){this.setHighlight(e)}},methods:{setHighlight(e){var n;const t=document.querySelector(".highlighted");t&&t.classList.remove("highlighted"),e&&e.highlight&&((n=document.querySelector(`#${e.highlight}`))==null||n.classList.add("highlighted"))},next(){this.$store.dispatch("nextTourStep")},stop(){this.$store.dispatch("stopTour")}}}),Ia=["innerHTML"];function Ba(e,t,n,r,i,a){const u=re("Dialog");return e.title&&e.text?(h(),ee(u,{key:0},{buttons:ye(()=>[l("button",{onClick:t[0]||(t[0]=(...m)=>e.stop&&e.stop(...m))},"Tour beenden"),l("button",{onClick:t[1]||(t[1]=(...m)=>e.next&&e.next(...m))},"Weiter")]),default:ye(()=>[l("h2",null,k(e.title),1),l("div",{innerHTML:e.text},null,8,Ia)]),_:1})):A("",!0)}var Ma=$(Oa,[["render",Ba]]);const $a={class:"game-setup"},Na=l("h1",null,"#ich-kann-klima",-1),Ga=l("div",{id:"walls"},[l("div",{id:"wall-back"}),l("div",{id:"wall-left"}),l("div",{id:"wall-right"})],-1),Ua=M({setup(e){const t=oe(),n=_(()=>{var z;const p=((z=t.state.game)==null?void 0:z.events)||[];if(p.length===0)return;const d=p[0];if(!d.acknowledged)return Ae.find(T=>T.id===d.id)}),r=_(()=>{var p;return((p=n.value)==null?void 0:p.title)||""}),i=_(()=>{var p;return((p=n.value)==null?void 0:p.description)||""}),a=_(()=>{var p;return((p=t.state.game)==null?void 0:p.currentYear)||2021}),u=_(()=>{var p;return ke((p=t.state.game)==null?void 0:p.currentDate).lux.month}),m=_(()=>{const p=t.state.game;return p?os(p):0}),c=_(()=>{var p;return((p=t.state.game)==null?void 0:p.values.popularity)||100}),f=_(()=>{const p=t.state.game;return p?as(p):0});function S(){t.dispatch("acknowledgeEvent",n.value)}return(p,d)=>(h(),g("div",$a,[Na,Ga,I(ea,{year:C(a),month:C(u)},null,8,["year","month"]),I(la),I(Ks,{value:C(c)},null,8,["value"]),I(La,{"with-news":!!C(i)},null,8,["with-news"]),I(Qs,{value:C(f)},null,8,["value"]),I(wa),I(Is,{value:C(m)},null,8,["value"]),I(ws),I(Ss,{title:C(r),text:C(i),onAcknowledge:S},null,8,["title","text"]),I(Ma)]))}});const Ka=["onClick"],Ja=M({setup(e){const t=oe(),n=_(()=>{var u;return(u=t.state.game)==null?void 0:u.acceptedLaws}),r=X(void 0),i=_(()=>ae.filter(u=>{var m,c;return((m=n.value)==null?void 0:m.some(f=>f.lawId===u.id))&&!((c=u.labels)==null?void 0:c.includes("hidden"))}));function a(u){r.value=r.value===u?void 0:u}return(u,m)=>(h(!0),g(J,null,R(C(i),(c,f)=>(h(),g("div",{key:f,class:N(["Law",{opened:f===r.value}]),onClick:S=>a(f)},[l("h3",null,k(c.title),1),l("div",null,k(c.description),1)],10,Ka))),128))}});var Ha=$(Ja,[["__scopeId","data-v-7efa2df1"]]);const ja=M({components:{GameSetup:Ua,AcceptedLaws:Ha},setup(){return{store:oe()}},methods:{startGame(e){e?this.store.dispatch("loadGame",{gameId:e}):this.store.dispatch("startGame",void 0)}},beforeRouteEnter(e,t,n){n(r=>r.startGame(e.params.id))}});function Za(e,t,n,r,i,a){const u=re("GameSetup");return h(),ee(u)}var Ot=$(ja,[["render",Za],["__scopeId","data-v-3637ce73"]]);const Ra=M({components:{Dialog:Vt},setup(){return{store:oe()}},computed:{co2(){var n,r;const e=(n=this.store.state.game)==null?void 0:n.values.co2budget;return((r=this.store.state.game)==null?void 0:r.values.co2emissions)>0?e>0?"sind weiterhin vorhanden, aber zumindest ist das Budget noch nicht aufgebraucht, dein:e Nachfolger:in hat vielleicht noch eine Chance.":"sind explodiert, das Budget ist aufgebraucht. H\xE4tte die AfD nicht besser hinbekommen.":e>0?"hast du im Griff! Es verbleibt sogar noch ein Rest-CO2-Budget, Gratulation!":"hast du gerade noch rechtzeitig ausreichend senken k\xF6nnen. Punktlandung."},debt(){var t;return((t=this.store.state.game)==null?void 0:t.values.stateDebt)<1e3?"sind ausgeglichen. Die Stabilit\xE4tskriterien werden eingehalten.":"sind dir leider aus dem Ruder gelaufen."},popularity(){var t;const e=(t=this.store.state.game)==null?void 0:t.values.popularity;return e<20?"entspricht dem, was man von einem langh\xE4hrigen Diktator erwarten kann.":e<50?"ist nicht berauschend, wiedergew\xE4hlt w\xFCrdest du wohl eher nicht.":e<80?"reicht aus, dass du noch l\xE4nger am Ruder bleiben k\xF6nntest. Gratulation!":"ist v\xF6llig unglaubw\xFCrdig - war das wirklich eine freie Wahl?"}},methods:{loadGame(e){this.store.dispatch("loadGame",{gameId:e})},newGame(){this.$router.push("/games")}},beforeRouteEnter(e,t,n){n(r=>{r.loadGame(e.params.id)})}}),Ya=l("h2",null,"Das Spiel ist leider zu Ende",-1),Qa=l("p",null,"Deine Entscheidungen haben etwas ver\xE4ndert - soviel kann man sagen.",-1),qa=l("p",null,"Gar nicht so einfach, Politiker zu sein, oder?",-1),Xa={class:"button-bar"};function eo(e,t,n,r,i,a){const u=re("Dialog");return h(),ee(u,null,{default:ye(()=>[Ya,Qa,l("ul",null,[l("li",null,"Die CO2-Emmissionen "+k(e.co2),1),l("li",null,"Die Staatsfinanzen "+k(e.debt),1),l("li",null,"Deine Beliebtheit "+k(e.popularity),1)]),qa,l("div",Xa,[l("button",{onClick:t[0]||(t[0]=(...m)=>e.newGame&&e.newGame(...m))},"Neuer Versuch")])]),_:1})}var to=$(Ra,[["render",eo]]);const no=[{path:"/",redirect:"/games"},{path:"/games",component:Ot},{path:"/games/:id",component:Ot},{path:"/games/:id/over",component:to}],It=Rt({history:Yt(),routes:no});function ro(e){return{createGame(t){return e.add("post","/games",t)},loadGame(t){return e.add("get","/games/"+t,void 0,0)},saveGame(t){return e.remove("put","/games/"+t.id),e.add("put","/games/"+t.id,t)},decisionMade(t,n,r){return e.add("post","/games/"+t+"/decisions/"+n,{accepted:r})},eventOccurred(t,n){return e.add("post","/games/"+t+"/events/"+n)}}}function io(e,t){let n=[],r;async function i(){if(r&&(clearTimeout(r),r=void 0),n.length){const a=n[0],{method:u,path:m,data:c,retry:f,resolve:S,reject:p}=a;try{if((t==null?void 0:t.navigator)&&!(t==null?void 0:t.navigator.onLine))throw Error("Browser is offline");const d=await e(u,m,c);n.shift(),S(d)}catch(d){f?a.retry=Math.max(-1,f-1):(n.shift(),p(d))}n.length&&(r=setTimeout(i,(t==null?void 0:t.timeout)||1e4))}}return{add(a,u,m,c=-1){return new Promise((f,S)=>{n.push({method:a,path:u,data:m,retry:c,resolve:f,reject:S}),r||i()})},remove(a,u){n=n.filter(m=>m.method.toLowerCase()!==a.toLowerCase()||m.path!==u)},callsPending(){return n.length>0}}}function so(e,t,n=console){return async function(r,i,a){var u;try{const m={method:r};["post","put","patch"].includes(r)&&(m.body=JSON.stringify(a),m.headers={["content-type"]:"application/json"});const c=await t(e+i,m),f=((u=c.headers.get("Content-Type"))==null?void 0:u.match(/json/))?await c.json():await c.text();if(c.ok)return f;throw Error(f.message||f)}catch(m){throw n.error(m),m}}}function ao({api:e,logger:t=console,storage:n=localStorage}){return{createGame(r){Oe(r),n.setItem("game",JSON.stringify(r)),e.createGame(r).catch(i=>{t.warn("Cannot save new game - trying again later",i)})},async loadGame(r){const i=n.getItem("game");if(i){const u=JSON.parse(i);if(u.id===r)return Oe(u),Ge(u,r)}const a=await e.loadGame(r);return Oe(a),Ge(a,r)},saveGame(r){r.prngState=hn(),n.setItem("game",JSON.stringify(r)),e.saveGame(r).catch(i=>{t.warn("save on server failed - at least the game is saved in localStorage, so you can save it maybe next time",i)})},decisionMade(r,i,a){e.decisionMade(r.id,i,a)},eventOccurred(r,i){e.eventOccurred(r.id,i.id)}}}const oo=localStorage.getItem("backendURL")||"https://api.ich-kann-klima.de/api",lo=so(oo,fetch),uo=io(lo),co=ro(uo),ho=ao({api:co}),mo=ls(It,ho),Bt=Symbol();function oe(){return Qt(Bt)}const go=qt({state:ds,mutations:us,actions:mo,getters:cs});function Mt(e,t,...n){for(const r of n){if(e[r]<t[r])return-1;if(e[r]>t[r])return 1}return 0}function fo(e,t,n){function r(c){return e[c].toFixed(2)}function i(c){return(c>0?"+":"")+c.toFixed(2)}function a(c){const f=n.find(S=>S.type==="modify"&&S.name===c);return f&&f.condition?f.value:0}function u(c){const f=a(c),S=t?t[c]:0;return f&&Math.abs(f-S)<.001?i(f):f?i(f)+" / "+i(S):S!=0?i(S):""}return St.map(c=>({id:c.name,unit:c.unit,value:r(c.name),effect:u(c.name),class:c.writable?"writable":"calculated"}))}function po(e,t,n,r){const i=e.proposedLaws,a=e.acceptedLaws.map(c=>c.lawId),u=e.rejectedLaws;function m(c){return a.includes(c)?"a":i.includes(c)?"p":u.includes(c)?"r":"x"}return r.map(c=>({id:c.id,priority:c.priority(e),state:m(c.id)})).sort((c,f)=>Mt(c,f,t,"id")*n).map(c=>G(x({},c),{priority:c.priority.toFixed(2)}))}function bo(e,t,n,r){return r.map(i=>({id:i.id,probability:i.probability(e)})).sort((i,a)=>Mt(i,a,t,"id")*n).map(i=>G(x({},i),{probability:(i.probability*100).toFixed(2)}))}const vo={key:0},wo=["href"],yo=U(". "),ko={key:1},So={key:2},Do=U("Bemerkung: "),Po=["innerHTML"],_o=U(". "),zo={key:3},Ao=U("Internes: "),Fo=["innerHTML"],Co=U(". "),Eo={key:4},Lo=["href"],Wo=U(". "),xo={key:5},To=["href"],Vo=U(". "),Oo={key:6},Io=["href"],Bo=U(". "),Mo=M({props:{citation:null,showInternals:{type:Boolean}},setup(e){const t=e,n=_(()=>t.citation.url.toString()),r=_(()=>t.citation.title||t.citation.url.toString());return(i,a)=>(h(),g("p",null,[e.citation.authors?(h(),g("span",vo,k(e.citation.authors+e.citation.dateString())+". ",1)):A("",!0),l("a",{target:"_blank",rel:"noreferrer noopener",href:C(n)},'"'+k(C(r))+'"',9,wo),yo,e.citation.publisher?(h(),g("span",ko,k(e.citation.publisher)+". ",1)):A("",!0),e.citation.comment?(h(),g("span",So,[Do,l("span",{innerHTML:e.citation.comment},null,8,Po),_o])):A("",!0),e.showInternals&&e.citation.internalComment?(h(),g("span",zo,[Ao,l("span",{innerHTML:e.citation.internalComment},null,8,Fo),Co])):A("",!0),e.citation.referringUrl?(h(),g("span",Eo,[l("a",{target:"_blank",rel:"noreferrer noopener",href:e.citation.referringUrl.toString()},"Hier gefunden",8,Lo),Wo])):A("",!0),e.citation.archiveUrl?(h(),g("span",xo,[l("a",{target:"_blank",rel:"noreferrer noopener",href:e.citation.archiveUrl.toString()},"Web Archiv Kopie",8,To),Vo])):A("",!0),e.citation.localCopy?(h(),g("span",Oo,[l("a",{target:"_blank",rel:"noreferrer noopener",href:"/sources/"+e.citation.localCopy},"Kopie",8,Io),Bo])):A("",!0)]))}}),$o=M({props:{chartData:null,paramId:null,selectedYear:null},emits:["update:selectedYear"],setup(e,{emit:t}){const n=e,r="#9c6d00",i="#ce900070",a="#644600",u=_(()=>({xaxis:{categories:he,labels:{rotate:-90}},chart:{id:n.paramId+"-withLawEffects",animations:{enabled:!1},stacked:!0},colors:[r,a,i],legend:{show:!1},markers:{size:0},dataLabels:{enabled:!1}})),m=_(()=>n.chartData.values.map((D,E)=>({value:D[n.paramId],change:n.chartData.changes[E][n.paramId]}))),c=_(()=>m.value.map(D=>{const E=D.value-D.change;return D.change*D.value>0?E*D.value>0?{value:E,gain:D.change,loss:0}:{value:0,gain:D.value,loss:E}:{value:D.value,gain:0,loss:-D.change}})),f=_(()=>[{name:"Simulated "+n.paramId,data:c.value.map(D=>Math.round(D.value))},{name:"Gains of "+n.paramId+" by selected law",data:c.value.map(D=>Math.round(D.gain))},{name:"Losses of "+n.paramId+" by selected law",data:c.value.map(D=>Math.round(D.loss))}]),S=X();let p;function d(){var D,E;((D=S.value)==null?void 0:D.chart)!=null&&p!=null&&((E=S.value)==null||E.toggleDataPointSelection(0,p)),p=void 0}function z(D){var E,B;if(((E=S.value)==null?void 0:E.chart)!=null&&D){const j=D-he[0];p!=j&&(d(),p=j,(B=S.value)==null||B.toggleDataPointSelection(0,j))}else d()}Xt(()=>z(n.selectedYear),{flush:"post"});function T(D,E,B){const j=B.dataPointIndex;j<0||(j===p?(p=void 0,t("update:selectedYear",void 0)):(p=j,t("update:selectedYear",j+he[0])))}return(D,E)=>(h(),g("div",null,[l("div",null,k(e.paramId),1),I(C(en),{ref:(B,j)=>{j.chart=B,S.value=B},type:"bar",options:C(u),series:C(f),onClick:T},null,8,["options","series"])]))}}),No=[{name:"Clear",laws:[]},{name:"Happy Path",laws:[{lawId:"NetzausbauErleichtern",effectiveSince:2021},{lawId:"WindkraftVereinfachen",effectiveSince:2021},{lawId:"StromspeicherungErleichtern",effectiveSince:2021},{lawId:"AbstandsregelnFuerWindkraftLockern",effectiveSince:2021},{lawId:"AusschreibungsverfahrenfuerWindkraftVervierfachen",effectiveSince:2021},{lawId:"ForschungUndEntwicklungStromspeicherung",effectiveSince:2022},{lawId:"ForschungDezentraleStromerzeugung",effectiveSince:2022},{lawId:"KohleverstromungEinstellen",effectiveSince:2022},{lawId:"WirksamerCO2Preis",effectiveSince:2022},{lawId:"DaemmungAltbau4Percent",effectiveSince:2022},{lawId:"ForschungEmissionsfreieZementproduktion",effectiveSince:2023},{lawId:"NetzausbauFoerdern",effectiveSince:2023},{lawId:"StromspeicherungFoerdern",effectiveSince:2023},{lawId:"WasserstofftechnologieFoerdern",effectiveSince:2023},{lawId:"SolarstromFoerdernx4",effectiveSince:2024},{lawId:"SolarAufAllenDaechernVerpflichtend",effectiveSince:2024},{lawId:"ForschungEmissionsfreieStahlproduktion",effectiveSince:2024},{lawId:"FernverkehrModernisieren",effectiveSince:2025},{lawId:"NahverkehrModernisieren",effectiveSince:2026},{lawId:"FernverkehrVerbindungenAusbauen",effectiveSince:2026},{lawId:"NahverkehrAusbauen",effectiveSince:2026},{lawId:"LadeinfrastrukturAusbauen",effectiveSince:2026},{lawId:"NahverkehrKostenlos",effectiveSince:2027},{lawId:"DienstwagenPrivilegAbgeschaffen",effectiveSince:2027},{lawId:"ElektromobilitaetFoerdern",effectiveSince:2027},{lawId:"WasserstoffmobilitaetFoerdern",effectiveSince:2027}]}],Fe=(e,t)=>e.lawId===t.lawId&&e.effectiveSince===t.effectiveSince,Go=e=>e.map((t,n)=>G(x({},t),{sortId:n}));function Uo(...e){const t=e.map(n=>n.length===0?0:n[n.length-1].sortId+1);return t.length===0?0:Math.max.apply(Math,t)}function Ko(e){const t=X([]),n=X([]),r=X(!1);function i(T,D){var je;const E=t.value,B={lawId:T,effectiveSince:D,sortId:0},j=(je=n.value.find(ge=>Fe(B,ge)))==null?void 0:je.sortId;B.sortId=j!=null?j:Uo(E,n.value),t.value=E.filter(ge=>ge.lawId!=T).concat(B).sort((ge,Nt)=>ge.sortId-Nt.sortId)}function a(T){t.value=t.value.filter(D=>D.lawId!=T)}function u(T,D){const E={lawId:T,effectiveSince:D,sortId:0};t.value.some(B=>Fe(B,E))?a(T):i(T,D)}function m(T){t.value=Go(T.laws)}function c(){r.value=!r.value,r.value?n.value=t.value:n.value=[]}const f=_(()=>{var T;return{name:"Current Game",laws:((T=e.value)==null?void 0:T.acceptedLaws)||[]}}),S=_(()=>[f.value,...No]),p=_(()=>{const T=t.value.map(E=>G(x({},E),{cls:n.value.some(B=>Fe(E,B))?"both":"new"})),D=n.value.filter(E=>!t.value.some(B=>Fe(B,E))).map(E=>G(x({},E),{cls:"saved"}));return[...T,...D].sort((E,B)=>E.sortId-B.sortId)}),d=$t(t),z=$t(n);return{addToSimulation:i,removeFromSimulation:a,toggleInSimulation:u,loadPreset:m,compareActive:r,toggleCompare:c,presets:S,simulatedLaws:p,simulation:d,secondSimulation:z}}function $t(e){return _(()=>{const t=Ft();return t.acceptedLaws=[...e.value],he.map(r=>{for(;r>t.currentYear;){t.currentYear++,t.acceptedLaws=Jo(t.acceptedLaws,t.currentYear);const i=t.acceptedLaws.map(m=>ve(m)),{values:a,effectsOfLaws:u}=Ct(t,i,t.currentYear);if(t.values=a,r===t.currentYear)return{values:a,effectsOfLaws:u}}return{values:t.values,effectsOfLaws:{}}})})}function Jo(e,t){const n=e.map(i=>ve(i)),r=n.filter(i=>i.effectiveSince===t).flatMap(i=>i.removeLawsWithLabels||[]);return n.filter(i=>i.effectiveSince>=t||!r.some(a=>{var u;return(u=i.labels)==null?void 0:u.includes(a)})).map(i=>({lawId:i.id,effectiveSince:i.effectiveSince}))}const Ho=M({directives:{clickaway:Qe},setup(e,t){const n=X(!1);return{menuIsOpen:n,toggle:()=>n.value=!n.value,close:()=>n.value=!1}}});function jo(e,t,n,r,i,a){const u=tn("clickaway");return nn((h(),g("span",{onClick:t[0]||(t[0]=(...m)=>e.toggle&&e.toggle(...m)),class:N(["menu",{menuIsOpen:e.menuIsOpen}])},[We(e.$slots,"default",{},void 0,!0)],2)),[[u,e.close]])}var Zo=$(Ho,[["render",jo],["__scopeId","data-v-06206e01"]]);const Ro=M({directives:{clickaway:Qe},components:{Citation:Mo,PeekChart:$o,Menu:Zo},setup(){const e=oe(),t=_(()=>e.state.game),n=Ko(t);return x({store:e,game:t,gameYears:he},n)},data(){return{lawsSortCol:"state",lawsSortDir:1,eventsSortCol:"probability",eventsSortDir:-1,lastSelected:void 0,lawSelected:void 0,eventSelected:void 0,paramSelected:void 0,yearSelected:void 0,showDetails:!0,showCharts:!1,showParams:!0,showLaws:!0,showEvents:!1,showYears:!1}},methods:{sortLaws(e){e===this.lawsSortCol?this.lawsSortDir=this.lawsSortDir>0?-1:1:this.lawsSortDir=1,this.lawsSortCol=e},sortEvents(e){e===this.eventsSortCol?this.eventsSortDir=this.eventsSortDir>0?-1:1:this.eventsSortDir=1,this.eventsSortCol=e},toggleLawList(){this.showLaws=!this.showLaws,this.showLaws&&(this.showEvents=!1)},toggleEventList(){this.showEvents=!this.showEvents,this.showEvents&&(this.showLaws=!1)},selectLaw(e){e===this.lawSelected?this.lawSelected=void 0:(this.lastSelected="law",this.lawSelected=e)},selectEvent(e){e===this.eventSelected?this.eventSelected=void 0:(this.lastSelected="event",this.eventSelected=e)},selectParam(e){e===this.paramSelected?this.paramSelected=void 0:(this.lastSelected="param",this.paramSelected=e)},selectYear(e){e===this.yearSelected?this.yearSelected=void 0:(this.lastSelected="year",this.yearSelected=e)},unselect(){this.lawSelected=void 0,this.eventSelected=void 0,this.paramSelected=void 0,this.yearSelected=void 0},dragStart(e,t){const{lawId:n,year:r}=t;!e.dataTransfer||(e.dataTransfer.dropEffect="link",n&&e.dataTransfer.setData("lawId",n),r&&e.dataTransfer.setData("year",r.toString()))},getDropped(e,t,n){if(!e.dataTransfer)return;const r=e.dataTransfer.getData(t);return n.find(i=>i==r)},onDrop(e,t){const{lawId:n,year:r}=t,i=this.getDropped(e,"lawId",Si),a=this.getDropped(e,"year",this.gameYears);r&&i?this.addToSimulation(i,r):n&&a?this.addToSimulation(n,a):n&&i&&this.removeFromSimulation(i)},rightClick(e,t){this.toggleInSimulation(e,t)}},computed:{startYearOfSelected(){if(!this.lawSelected)return;if(!this.game)return ue;const e=this.simulatedLaws.find(t=>t.lawId===this.lawSelected);return e?e.effectiveSince:this.game.currentYear},selectedLaw(){return ae.find(e=>e.id===this.lawSelected)},lawEffort(){var e;if(!!this.game)return(e=this.selectedLaw)==null?void 0:e.effort(this.game)},selectedEvent(){return Ae.find(e=>e.id===this.eventSelected)},selectedParam(){return this.paramSelected?Y[this.paramSelected]:void 0},wParam(){const e=this.selectedParam;return e instanceof P?e:void 0},cParam(){const e=this.selectedParam;return e instanceof Z?e:void 0},citationsOfLaw(){return this.selectedLaw&&this.selectedLaw.citations?this.selectedLaw.citations:[]},currentYear(){return this.yearSelected?this.yearSelected:this.game?this.game.currentYear:ue},effectsOfSelected(){return!this.selectedLaw||!this.startYearOfSelected||!this.game?[]:this.selectedLaw.effects(this.game,this.startYearOfSelected,this.currentYear)},sortedValues(){return this.game?fo(this.simOfYear.values,this.effectsOfLawInYear,this.effectsOfSelected):[]},sortedLaws(){return this.game?po(this.game,this.lawsSortCol,this.lawsSortDir,ae):[]},sortedEvents(){return this.game?bo(this.game,this.eventsSortCol,this.eventsSortDir,Ae):[]},effectsOfLawInYear(){if(this.lawSelected)return this.simOfYear.effectsOfLaws[this.lawSelected];if(this.yearSelected)return this.simEffectOfLaw[this.yearSelected-this.gameYears[0]]},simOfYear(){if(this.yearSelected===void 0&&this.game){const e=this.effectsOfSelected,t=this.game.values;if(this.lawSelected===void 0||e.length===0)return{values:t,effectsOfLaws:{}};const n=de(t);Me({dispatch:()=>{},values:n},e);const i=Object.fromEntries(wt.map(a=>[a,n[a]-t[a]]));return{values:t,effectsOfLaws:{[this.lawSelected]:i}}}else{const e=this.yearSelected?this.yearSelected-this.gameYears[0]:0;return this.simulation[e]}},simulatedValues(){return this.simulation.map(e=>e.values)},simEffectOfLaw(){if(this.lawSelected){const e=this.lawSelected;return this.simulation.map(t=>{const n=t.effectsOfLaws[e];return n||Dt})}return this.compareActive?this.secondSimulation.map((e,t)=>Object.fromEntries(Object.entries(e.values).map(([n,r])=>[n,this.simulation[t].values[n]-r]))):he.map(e=>Dt)},chartData(){return{values:this.simulatedValues,changes:this.simEffectOfLaw}},lawsInYear(){return e=>this.simulatedLaws.filter(t=>t.effectiveSince===e)}}}),q=e=>(fe("data-v-85b0da02"),e=e(),pe(),e),Yo={class:"peekData"},Qo={class:"Menu"},qo=U("\xA0 "),Xo=U("\xA0 "),el=U("\xA0 "),tl=U("\xA0 "),nl=U("\xA0 "),rl=U("\xA0 "),il={key:1,class:"Details sidebyside"},sl={class:"Title"},al={class:"Description"},ol={class:"SectionHead"},ll={class:"Section"},ul=q(()=>l("div",{class:"SectionHead"},"Details:",-1)),cl=["innerHTML"],dl=q(()=>l("div",{class:"SectionHead"},"Internes:",-1)),hl=["innerHTML"],ml=q(()=>l("div",{class:"SectionHead"},"Referenzen:",-1)),gl={key:2,class:"Details sidebyside"},fl={class:"Title"},pl={class:"Description"},bl=q(()=>l("div",{class:"SectionHead"},"Details:",-1)),vl=["innerHTML"],wl=q(()=>l("div",{class:"SectionHead"},"Internes:",-1)),yl=["innerHTML"],kl=q(()=>l("div",{class:"SectionHead"},"Referenzen:",-1)),Sl={key:3,class:"Details sidebyside"},Dl={class:"Title"},Pl={key:0},_l={key:1},zl={key:2},Al=q(()=>l("div",{class:"SectionHead"},"Details:",-1)),Fl=["innerHTML"],Cl=q(()=>l("div",{class:"SectionHead"},"Internes:",-1)),El=["innerHTML"],Ll=q(()=>l("div",{class:"SectionHead"},"Referenzen:",-1)),Wl={class:"paramsHeader"},xl=["onClick"],Tl={class:"numbercol"},Vl={class:"effcol"},Ol={key:5,class:"lawList sidebyside"},Il=["onClick","onDragstart","onDrop"],Bl={class:"priocol"},Ml={key:6,class:"eventList sidebyside"},$l=["onClick"],Nl={class:"priocol"},Gl={key:7,class:"yearList sidebyside"},Ul=q(()=>l("a",{class:"clickable"},"Presets",-1)),Kl={class:"dropdown"},Jl=["onClick"],Hl=U("\xA0 "),jl=["onClick","onDragstart","onDrop"],Zl=["onClick","onContextmenu","onDragstart","onDrop"];function Rl(e,t,n,r,i,a){var f,S,p;const u=re("PeekChart"),m=re("Citation"),c=re("Menu");return h(),g("details",Yo,[l("summary",{onClick:t[0]||(t[0]=d=>e.unselect()),class:"clickable"},"Peek"),l("div",Qo,[l("a",{onClick:t[1]||(t[1]=d=>e.showCharts=!e.showCharts),class:N(["clickable",e.showCharts?"selected":""])},"Charts",2),qo,l("a",{onClick:t[2]||(t[2]=d=>e.showDetails=!e.showDetails),class:N(["clickable",e.showDetails?"selected":""])},"Details",2),Xo,l("a",{onClick:t[3]||(t[3]=d=>e.showParams=!e.showParams),class:N(["clickable",e.showParams?"selected":""])},"Params",2),el,l("a",{onClick:t[4]||(t[4]=d=>e.toggleLawList()),class:N(["clickable",e.showLaws?"selected":""])},"Laws",2),tl,l("a",{onClick:t[5]||(t[5]=d=>e.toggleEventList()),class:N(["clickable",e.showEvents?"selected":""])},"Events",2),nl,l("a",{onClick:t[6]||(t[6]=d=>e.showYears=!e.showYears),class:N(["clickable",e.showYears?"selected":""])},"Years",2),rl]),e.showCharts?(h(),g("div",{key:0,class:N(["Details sidebyside",{lawSelected:e.lawSelected!=null}])},[e.paramSelected?(h(),ee(u,{key:0,selectedYear:e.yearSelected,"onUpdate:selectedYear":t[7]||(t[7]=d=>e.yearSelected=d),chartData:e.chartData,paramId:e.paramSelected},null,8,["selectedYear","chartData","paramId"])):A("",!0),I(u,{selectedYear:e.yearSelected,"onUpdate:selectedYear":t[8]||(t[8]=d=>e.yearSelected=d),chartData:e.chartData,paramId:"co2emissions"},null,8,["selectedYear","chartData"]),I(u,{selectedYear:e.yearSelected,"onUpdate:selectedYear":t[9]||(t[9]=d=>e.yearSelected=d),chartData:e.chartData,paramId:"popularity"},null,8,["selectedYear","chartData"]),I(u,{selectedYear:e.yearSelected,"onUpdate:selectedYear":t[10]||(t[10]=d=>e.yearSelected=d),chartData:e.chartData,paramId:"stateDebt"},null,8,["selectedYear","chartData"]),I(u,{selectedYear:e.yearSelected,"onUpdate:selectedYear":t[11]||(t[11]=d=>e.yearSelected=d),chartData:e.chartData,paramId:"co2budget"},null,8,["selectedYear","chartData"])],2)):A("",!0),e.lastSelected==="law"&&e.selectedLaw&&e.showDetails?(h(),g("div",il,[l("div",sl,k(e.selectedLaw.title),1),l("div",al,k(e.selectedLaw.description),1),l("div",ol,"Aufwand: "+k((f=e.lawEffort)==null?void 0:f.time.toMonthsString()),1),l("div",ll,k((S=e.lawEffort)==null?void 0:S.text),1),ul,l("div",{class:"Section",innerHTML:e.selectedLaw.details},null,8,cl),dl,l("div",{class:"Section",innerHTML:e.selectedLaw.internals},null,8,hl),ml,(h(!0),g(J,null,R(e.citationsOfLaw,(d,z)=>(h(),ee(m,{class:"Section",key:z,citation:d},null,8,["citation"]))),128))])):A("",!0),e.lastSelected==="event"&&e.selectedEvent&&e.showDetails?(h(),g("div",gl,[l("div",fl,k(e.selectedEvent.title),1),l("div",pl,k(e.selectedEvent.description),1),bl,l("div",{class:"Section",innerHTML:e.selectedEvent.details},null,8,vl),wl,l("div",{class:"Section",innerHTML:e.selectedEvent.internals},null,8,yl),kl,(h(!0),g(J,null,R((p=e.selectedEvent)==null?void 0:p.citations,(d,z)=>(h(),ee(m,{class:"Section",key:z,citation:d},null,8,["citation"]))),128))])):A("",!0),e.lastSelected==="param"&&e.selectedParam&&e.showDetails?(h(),g("div",Sl,[l("div",Dl,k(e.paramSelected)+" ["+k(e.selectedParam.unit)+"]",1),e.wParam?(h(),g("div",Pl,"Initial value: "+k(e.wParam.initialValue)+" "+k(e.wParam.unit),1)):A("",!0),e.cParam&&e.cParam.shouldInitiallyBe?(h(),g("div",_l," Should initially be: "+k(e.cParam.shouldInitiallyBe)+" "+k(e.cParam.unit),1)):A("",!0),e.cParam?(h(),g("div",zl," Calculation: "+k(e.cParam.valueGetter),1)):A("",!0),Al,l("div",{class:"Section",innerHTML:e.selectedParam.details},null,8,Fl),Cl,l("div",{class:"Section",innerHTML:e.selectedParam.internals},null,8,El),Ll,(h(!0),g(J,null,R(e.selectedParam.citations,(d,z)=>(h(),ee(m,{class:"Section",key:z,citation:d},null,8,["citation"]))),128))])):A("",!0),e.showParams?(h(),g("div",{key:4,class:N(["paramsList sidebyside",{lawSelected:e.lawSelected!=null}])},[l("div",Wl,[l("div",null,"Start of law: "+k(e.startYearOfSelected),1),l("div",null,"Current year: "+k(e.currentYear),1)]),l("table",null,[(h(!0),g(J,null,R(e.sortedValues,d=>(h(),g("tr",{key:d.id,class:N({clickable:!0,selected:e.paramSelected===d.id,[d.class]:!0}),onClick:z=>e.selectParam(d.id)},[l("td",null,k(d.id),1),l("td",Tl,k(d.value),1),l("td",Vl,k(d.effect),1),l("td",null,k(d.unit),1)],10,xl))),128))])],2)):A("",!0),e.showLaws?(h(),g("div",Ol,[l("table",null,[l("tr",null,[l("th",{onClick:t[12]||(t[12]=d=>e.sortLaws("state")),class:"clickable"},"S"),l("th",{onClick:t[13]||(t[13]=d=>e.sortLaws("id")),class:"clickable"},"ID"),l("th",{onClick:t[14]||(t[14]=d=>e.sortLaws("priority")),class:"clickable priocol"},"Priority")]),(h(!0),g(J,null,R(e.sortedLaws,d=>(h(),g("tr",{key:d.id,class:N({clickable:!0,selected:e.lawSelected===d.id,[d.state]:!0}),onClick:z=>e.selectLaw(d.id),draggable:"true",onDragstart:z=>e.dragStart(z,{lawId:d.id}),onDrop:Q(z=>e.onDrop(z,{lawId:d.id}),["prevent"]),onDragover:t[15]||(t[15]=Q(()=>{},["prevent"])),onDragenter:t[16]||(t[16]=Q(()=>{},["prevent"]))},[l("td",null,k(d.state),1),l("td",null,k(d.id),1),l("td",Bl,k(d.priority),1)],42,Il))),128))])])):A("",!0),e.showEvents?(h(),g("div",Ml,[l("table",null,[l("tr",null,[l("th",{onClick:t[17]||(t[17]=d=>e.sortEvents("id")),class:"clickable"},"ID"),l("th",{onClick:t[18]||(t[18]=d=>e.sortEvents("probability")),class:"clickable priocol"},"Probability")]),(h(!0),g(J,null,R(e.sortedEvents,d=>(h(),g("tr",{key:d.id,class:N({clickable:!0,selected:e.eventSelected===d.id}),onClick:z=>e.selectEvent(d.id)},[l("td",null,k(d.id),1),l("td",Nl,k(d.probability),1)],10,$l))),128))])])):A("",!0),e.showYears?(h(),g("div",Gl,[l("div",null,[I(c,null,{default:ye(()=>[Ul,l("ul",Kl,[(h(!0),g(J,null,R(e.presets,d=>(h(),g("li",{key:d.name,class:"clickable",onClick:z=>e.loadPreset(d)},k(d.name),9,Jl))),128))])]),_:1}),Hl,l("a",{class:N(["clickable",e.compareActive?"selected":""]),onClick:t[19]||(t[19]=d=>e.toggleCompare())},"Compare",2)]),l("table",null,[(h(!0),g(J,null,R(e.gameYears,d=>(h(),g(J,{key:d},[l("tr",{class:N({clickable:!0,selected:e.yearSelected===d}),onClick:z=>e.selectYear(d),draggable:"true",onDragstart:z=>e.dragStart(z,{year:d}),onDrop:Q(z=>e.onDrop(z,{year:d}),["prevent"]),onDragover:t[20]||(t[20]=Q(()=>{},["prevent"])),onDragenter:t[21]||(t[21]=Q(()=>{},["prevent"]))},[l("th",null,k(d),1)],42,jl),(h(!0),g(J,null,R(e.lawsInYear(d),({lawId:z,cls:T})=>(h(),g("tr",{key:z,class:N({clickable:!0,selected:e.lawSelected===z,[T]:!0}),onClick:D=>e.selectLaw(z),onContextmenu:Q(D=>e.rightClick(z,d),["right","prevent"]),draggable:"true",onDragstart:D=>e.dragStart(D,{lawId:z}),onDrop:Q(D=>e.onDrop(D,{year:d}),["prevent"]),onDragover:t[22]||(t[22]=Q(()=>{},["prevent"])),onDragenter:t[23]||(t[23]=Q(()=>{},["prevent"]))},[l("td",null,k(z),1)],42,Zl))),128))],64))),128))])])):A("",!0)])}var Yl=$(Ro,[["render",Rl],["__scopeId","data-v-85b0da02"]]);const Ql=M({components:{PeekInside:Yl},setup(){return{store:oe(),devMode:localStorage.getItem("devMode")==="true"}},methods:{updateStyle(){const e=window.innerHeight,t=window.innerWidth,n=Math.min(e/800,t/1e3),r=(t-1e3*n)/2;document.documentElement.style.setProperty("--scale",`${n}`),document.documentElement.style.setProperty("--translateX",`${r}px`)}},mounted(){setTimeout(this.updateStyle,0),window.addEventListener("resize",this.updateStyle)}}),ql={class:"perspective"},Xl={class:"peek"};function eu(e,t,n,r,i,a){const u=re("router-view"),m=re("PeekInside");return h(),g(J,null,[l("div",ql,[I(u)]),l("div",Xl,[e.devMode?(h(),ee(m,{key:0})):A("",!0)])],64)}var tu=$(Ql,[["render",eu]]);const He=rn(tu);He.use(go,Bt);He.use(It);He.mount("#app");
