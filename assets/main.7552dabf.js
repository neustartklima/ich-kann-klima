...
Anfangswert ist die deutsche Staatsverschuldung 2019.
  ...
  `,internals:x`
    ...
    - linear interpoliert
  `},Tt={title:"Stromspeicherung erleichtern",description:"Bürokratische Hürden für den Bau von Speicheranlagen und Einspeisung von gespeichertem Strom werden abgeschafft.",effects:(e,t,i)=>[wt("electricityGridQuality").byValue(.2)],priority:e=>yi(70,30,e.values.electricityGridQuality),citations:[],details:x`
  ...
  `,internals:x`
    ...
    - 100 bei 10% Anteil
    - linear interpoliert
  `},Nt={title:"Wasserstofftechnologie fördern",description:"Forschung und Entwicklung von wasserstoffbasierter Antriebs- und Produktionstechnologie wird stark gefördert.",effects:(e,t,i)=>[wt("stateDebt").byValue(3),wt("carRenewablePercentage").byValue(1).if(t+5<=i)],priority(e){const t=e.values;return yi(40,90,t.carUsage*(1-t.carRenewablePercentage/100)/t.passengerTransportUsage*100)}},_t={title:"Wasserstoffmobilität fördern",description:"Wasserstoffbasierte Fahrzeuge werden gefördert.",effects:(e,t,i)=>Si(e,"WasserstofftechnologieFoerdern")?[wt("stateDebt").byValue(3),wt("carRenewablePercentage").byValue(1),wt("popularity").byValue(1).if(t===i)]:[],priority:e=>yi(0,10,e.values.co2emissionsMobility/e.values.co2emissions*100),citations:[],details:x`
  ...
  `},Kt={title:"Abschaffung der Mineralölsteuer",description:"Die Steuer auf sämtliche erdölbasierten Treibstoffe wird abgeschafft.",effects:(e,t,i)=>[wt("stateDebt").byValue(41),wt("popularity").byValue(5).if(t===i),wt("popularity").byValue(-3).if(t<i),yt("publicLocalUsage","carUsage").byPercent(-20).if(t===i),yt("publicNationalUsage","carUsage").byPercent(-20).if(t===i)],priority(e){const t=e.values;return yi(60,100,t.carUsage*(1-t.carRenewablePercentage/100)/t.passengerTransportUsage*100)},citations:[Z],details:"",internals:x`
    ...
    - linear interpoliert
  `},jt={title:"Ausbau von Straßen",description:"Autobahnen und Straßen werden intensiver ausgebaut.",effects:e=>[wt("stateDebt").byValue(5),wt("popularity").byValue(.5),yt("publicLocalUsage","carUsage").byPercent(-1),yt("publicNationalUsage","carUsage").byPercent(-1)],priority(e){const t=e.values;return yi(60,100,t.carUsage/t.passengerTransportUsage*100)}},Ht={title:"Diesel Privileg abgeschaffen",description:"Diesel wird jetzt genauso besteuert wie Benzin.",effects:(e,t,i)=>[wt("stateDebt").byValue(-7.35),wt("popularity").byValue(-1).if(t===i)],priority(e){const t=e.values;return yi(10,100,t.carUsage*(1-t.carRenewablePercentage/100)/t.passengerTransportUsage*100)}},Jt={title:"Dienstwagen Privileg abgeschaffen",description:"Steuererleichterungen für Dienstwagen werden abgeschafft.",effects:(e,t,i)=>[wt("stateDebt").byValue(-18),wt("popularity").byValue(-1).if(t===i),yt("carUsage","publicLocalUsage").byPercent(-.05)],priority(e){const t=e.values;return yi(50,100,t.carUsage*(1-t.carRenewablePercentage/100)/t.passengerTransportUsage*100)},citations:[R,he],details:x`
  ...
  `,internals:x`
    ...
    - 100 bei 10% Anteil
    - linear interpoliert
  `},Xt={title:"Windkraft vereinfachen",description:"Genehmigungen für Windkraftanlagen werden vereinfacht und beschleunigt.",labels:[],removeLawsWithLabels:[],effects:(e,t,i)=>[],priority:e=>yi(80,40,Ai(e)),citations:[],details:x`
  ...
  `,internals:x`
    ...
    - linear interpoliert
  `},ei={title:"Abstandsregeln für Windkraft wie zu Beginn",description:"Das Land / Die Kommune bestimmem über Abstände zwischen den Windkraftanlagen und Wohngebäuden.",labels:["initial","WindkraftAbstandsregel"],removeLawsWithLabels:["WindkraftAbstandsregel"],effects(e,t,i){const n=Si(e,"WindkraftVereinfachen")?0:5;return[wt("electricityWindOnshoreMaxNew").setValue(6).if(i>=t+n)]},priority:e=>Si(e,"AbstandsregelnFuerWindkraftLockern")?yi(30,100,Ai(e)):Si(e,"AbstandsregelnFuerWindkraftVerschaerfen")?yi(70,30,Ai(e)):0},ti={title:"Abstandsregeln für Windkraft lockern",description:"Bundesweite gelockerte Abstandsregeln für Windkraftanlagen sowie Bauerlaubniss in Wäldern. Ja auch Bayern wird jetzt gezwungen Windkraftanlagen zuzulassen, sowie andere nicht bauwillige Kommunen.",labels:["WindkraftAbstandsregel"],removeLawsWithLabels:["WindkraftAbstandsregel"],effects(e,t,i){const n=Si(e,"WindkraftVereinfachen")?0:5;return[wt("popularity").byValue(-3).if(t===i),wt("electricityWindOnshoreMaxNew").setValue(30).if(i>=t+n)]},priority:e=>Si(e,"AbstandsregelnFuerWindkraftWieBisher")?yi(70,30,Ai(e)):Si(e,"AbstandsregelnFuerWindkraftAbschaffen")?yi(30,100,Ai(e)):0,citations:[],details:x`
  ...
  `,internals:x`
    ...
    - 100%
  `},di={title:"Solarstrom Förderung einstellen",description:"Mittlere bis große Solaranlagen sollten sich selbst tragen. Die Förderung wird abgeschafft.",labels:["SolarFoerderung"],removeLawsWithLabels:["SolarFoerderung"],treatAfterLabels:[],effects:()=>[wt("electricitySolar").byValue(2)],priority:e=>Si(e,"SolarstromFoerderungBeibehalten")?yi(0,100,Pi(e)):0,details:x`

  `},hi={title:"Solarstrom Förderung beibehalten",description:"Subventionierung für mittlere bis große Solaranlagen wie bisher",labels:["initial","SolarFoerderung"],removeLawsWithLabels:["SolarFoerderung"],treatAfterLabels:[],effects:()=>[wt("electricitySolar").byValue(5)],priority:e=>yi(70,100,Pi(e)),details:x`
  ...
  `},BSE:{title:"Staatsoberhaupt verstorben",description:"Du stirbst an der neuen BSE Variante. Tja, hättest du dich mal besser um das Tierwohl gekümmert...",apply:()=>[vt("gameOver")],probability:e=>wi(e.acceptedLaws.map((e=>e.lawId))).find((e=>e.title.match(/tierwohl/i)))?0:Math.random(),laws:[],citations:[],details:x`
  ...
  `}}),Ci={currentYear:2021,values:pt,acceptedLaws:[],proposedLaws:[],rejectedLaws:[],actionCount:0};function Fi(e=Ci,t=c()){return{id:t,currentYear:e.currentYear,acceptedLaws:e.acceptedLaws,proposedLaws:e.proposedLaws,rejectedLaws:e.rejectedLaws,values:ft(e.values),events:[],actionCount:e.actionCount,over:!1}}function Ei(e,t=fi,i=Oi,n=Math.random){const r=function(e,t,i){const n=function(e,t){return t.map((t=>o(l({},t),{prob:t.probability(e)}))).filter((e=>e.prob>0))}(e,t),r=function(e){return e.filter((e=>e.prob>1)).reduce(((e,t)=>t.prob>((null==e?void 0:e.prob)||0)?t:e),void 0)}(n);if(r)return r;return function(e,t){for(const i of e)if((t-=i.prob)<0)return i;return}(function(e){const t=e.map((e=>e.prob)).reduce(((e,t)=>e+t),0),i=.6/t;return e.map((e=>o(l({},e),{prob:e.prob*i})))}(n),i())}(e,i,n);r&&e.events.unshift(r);const a=function(e,t,i){const n=t=>{var i;return null==(i=e.acceptedLaws)?void 0:i.some((e=>e.lawId===t.id))},r=t=>{var i;return null==(i=e.rejectedLaws)?void 0:i.includes(t.id)},a=e=>{var t;return(null==(t=e.labels)?void 0:t.includes("hidden"))||!1},s=t=>({law:t,priority:t.priority(e)}),l=e=>({law:e.law,priority:e.priority+(i.includes(e.law.id)?100:0)});return t.filter(I(n)).filter(I(r)).filter(I(a)).map(s).filter((e=>e.priority>0)).map(l).sort(((e,t)=>t.priority-e.priority)).map((e=>e.law.id)).slice(0,6)}(e,t,(null==r?void 0:r.laws)?r.laws:[]);return e.proposedLaws=function(e,t){const i=[...e],n=t.filter((e=>i.includes(e))),r=t.filter((e=>!n.includes(e)));var a=0;for(;a<i.length;)n.includes(i[a])?a++:0!==r.length?(i[a]=r.shift(),a++):i.splice(a,1);return i.push(...r.slice(0,6-i.length)),i}(e.proposedLaws,a),e.actionCount++,r}function Mi(e){return Math.max(0,Math.min(100,e))}var Bi=d({props:{law:{type:Object,required:!0},selectable:{type:Boolean,required:!0},numCards:{type:Number,required:!0}},setup:()=>({store:pr()}),data:()=>({accepted:!1}),computed:o(l({},h(["proposedLaws"])),{zIndex(){return this.law.zIndex},transform(){return`rotate(${2*(this.law.pos-this.numCards/2)}deg) translate(${20*Math.abs(this.numCards/2-this.law.pos)}px, -50%)`}}),methods:{select(){this.$emit("selected")},accept(){this.accepted=!0},sendAccept(e){e.animationName.match(/^twistOut-/)&&this.$emit("accepted",this.law.id)}}});const Ui=w("data-v-c57832f8");g("data-v-c57832f8");const Gi={key:0,type:"radio"},xi={key:0,class:"button-bar"};m();const Ii=Ui(((e,t,i,n,r,a)=>(y(),b("div",{class:["Law",{accepted:e.accepted}],style:{zIndex:e.zIndex},onClick:t[2]||(t[2]=(...t)=>e.select&&e.select(...t)),onAnimationend:t[3]||(t[3]=(...t)=>e.sendAccept&&e.sendAccept(...t))},[p("label",null,[e.selectable?(y(),b("input",Gi)):f("",!0),p("div",null,[p("h3",null,v(e.law.title),1),p("div",null,v(e.law.description),1),e.selectable?(y(),b("div",xi,[p("button",{class:"accept",onClick:t[1]||(t[1]=(...t)=>e.accept&&e.accept(...t))},"✓")])):f("",!0)])])],38))));Bi.render=Ii,Bi.__scopeId="data-v-c57832f8";var Ni=d({components:{LawCard:Bi},setup:()=>({store:pr()}),data:()=>({zIndexes:[],poppedUp:!1}),computed:o(l({},h(["proposedLaws"])),{lawsToShow(){return this.zIndexes.length||(this.zIndexes=G(this.proposedLaws.length,0)),this.proposedLaws.map(((e,t)=>o(l({},e),{zIndex:this.zIndexes[t],pos:t})))}}),methods:{accept(e){this.store.dispatch("acceptLaw",{lawId:e})},select(e){this.zIndexes=G(this.proposedLaws.length,e)},sitOut(){this.store.dispatch("sitOut")}}});const _i=w("data-v-290d8620")(((e,t,i,n,r,a)=>{const s=A("LawCard");return y(),b(k,null,[p("div",{class:["ProposedLaws",{poppedUp:e.poppedUp}],onClick:t[1]||(t[1]=t=>e.poppedUp=!0)},[(y(!0),b(k,null,S(e.lawsToShow,((t,i)=>(y(),b(s,{key:t.id,law:t,selectable:e.poppedUp,numCards:e.lawsToShow.length,onAccepted:()=>e.accept(t.id),onSelected:()=>e.select(i)},null,8,["law","selectable","numCards","onAccepted","onSelected"])))),128))],2),p("div",{class:"sitOutButton",onClick:t[2]||(t[2]=()=>e.sitOut())},"Aussitzen")],64)}));Ni.render=_i,Ni.__scopeId="data-v-290d8620";var Ki=d({props:{title:String,text:String},methods:{acknowledge(){this.$emit("acknowledge")}}});const ji=w("data-v-2df6be4d");g("data-v-2df6be4d");const Hi={key:0};m();const Ji=ji(((e,t,i,n,r,a)=>e.text?(y(),b("div",{key:0,onClick:t[1]||(t[1]=(...t)=>e.acknowledge&&e.acknowledge(...t))},[e.title?(y(),b("h2",Hi,v(e.title),1)):f("",!0),p("p",null,v(e.text),1)])):f("",!0)));Ki.render=Ji,Ki.__scopeId="data-v-2df6be4d";var Zi=d({props:{value:{type:Number,required:!0}},computed:{isShort(){return this.value<20},isLess(){return this.value>=20&&this.value<50},isMore(){return this.value>=50&&this.value<80},isMuch(){return this.value>=80}}});const Ri=w("data-v-df0e905e");g("data-v-df0e905e");const $i={id:"finances"},Qi={key:0,src:"/assets/money-short.7ce9dbed.png",id:"short"},qi={key:1,src:"/assets/money-less.c10d45f8.png",id:"less"},Yi={key:2,src:"/assets/money-more.a1c17d8d.png",id:"more"},Xi={key:3,src:"/assets/money-much.ad651475.png",id:"much"};m();const en=Ri(((e,t,i,n,r,a)=>(y(),b("div",$i,[e.isShort?(y(),b("img",Qi)):f("",!0),e.isLess?(y(),b("img",qi)):f("",!0),e.isMore?(y(),b("img",Yi)):f("",!0),e.isMuch?(y(),b("img",Xi)):f("",!0)]))));Zi.render=en,Zi.__scopeId="data-v-df0e905e";var tn=d({props:{value:{type:Number,required:!0}},computed:{areHappy(){return this.value>=50},areAngry(){return this.value<50}}});const nn=w("data-v-a375dc26");g("data-v-a375dc26");const rn={id:"popularity"},an={key:0,src:"/assets/people-happy.1e9e529c.png",id:"happy"},sn={key:1,src:"/assets/people-angry.495e0425.png",id:"angry"};m();const ln=nn(((e,t,i,n,r,a)=>(y(),b("div",rn,[e.areHappy?(y(),b("img",an)):f("",!0),e.areAngry?(y(),b("img",sn)):f("",!0)]))));tn.render=ln,tn.__scopeId="data-v-a375dc26";var on=d({data:()=>({levels:{healthy:"/assets/plant-healthy.1c912fd2.png",sick:"/assets/plant-sick.05726ebf.png",withered:"/assets/plant-withered.2d8ffb21.png"}}),props:{value:{type:Number,required:!0}},computed:{status(){return this.value>66?"healthy":this.value>33?"sick":"withered"},imgSrc(){return this.levels[this.status]}}});const un=w("data-v-c0f87ac2");g("data-v-c0f87ac2");const cn={id:"plant"};m();const dn=un(((e,t,i,n,r,a)=>(y(),b("div",cn,[p("img",{src:e.imgSrc,id:e.status},null,8,["src","id"])]))));on.render=dn,on.__scopeId="data-v-c0f87ac2";var hn=d({props:{year:Number}});const gn=w("data-v-38fe5c52");g("data-v-38fe5c52");const mn={id:"calendar"};m();const bn=gn(((e,t,i,n,r,a)=>(y(),b("div",mn,v(e.year),1))));hn.render=bn,hn.__scopeId="data-v-38fe5c52";var pn=d({});const fn=w("data-v-5952ab5a");g("data-v-5952ab5a");const vn={id:"heater"},wn=p("img",{src:"/assets/heater.5a77e425.png"},null,-1);m();const yn=fn(((e,t,i,n,r,a)=>(y(),b("div",vn,[wn]))));pn.render=yn,pn.__scopeId="data-v-5952ab5a";var kn=d({});const Sn=w("data-v-3902beeb");g("data-v-3902beeb");const An={id:"table"},Pn=p("img",{src:"/assets/table-top.c87bd2fd.png",id:"table-top"},null,-1),Dn=p("img",{src:"/assets/table-front.78c0f8c6.png",id:"table-front"},null,-1),zn=p("img",{src:"/assets/table-front.78c0f8c6.png",id:"table-back"},null,-1),Wn=p("img",{src:"/assets/table-side.49774a53.png",id:"table-left-side"},null,-1),Tn=p("img",{src:"/assets/table-side.49774a53.png",id:"table-right-side"},null,-1);m();const Vn=Sn(((e,t,i,n,r,a)=>(y(),b("div",An,[Pn,Dn,zn,Wn,Tn]))));kn.render=Vn,kn.__scopeId="data-v-3902beeb";var Ln=d({props:{withNews:Boolean}}),On="/assets/board-side.d7181ded.png",Cn="/assets/tvset-legs.78b387df.png";const Fn=w("data-v-118e7bdf");g("data-v-118e7bdf");const En={id:"tvset"},Mn=p("div",{id:"board"},[p("img",{id:"board-front",src:"/assets/board-front.41330f02.png"}),p("img",{id:"board-left",src:On}),p("img",{id:"board-right",src:On}),p("div",{id:"board-top"})],-1),Bn={id:"tv"},Un=p("img",{id:"tv-front",src:"/assets/tv-front.82df5c0c.png"},null,-1),Gn={key:0,id:"news",src:"/assets/news.c4bbc2d0.png"},xn=p("div",{id:"legs"},[p("img",{id:"legs-front",src:Cn}),p("img",{id:"legs-back",src:Cn})],-1);m();const In=Fn(((e,t,i,n,r,a)=>(y(),b("div",En,[Mn,p("div",Bn,[Un,e.withNews?(y(),b("img",Gn)):f("",!0)]),xn]))));Ln.render=In,Ln.__scopeId="data-v-118e7bdf";const Nn=[{id:"start",title:"Stell dir vor...",text:x`
      ### ... du bist Politiker.
