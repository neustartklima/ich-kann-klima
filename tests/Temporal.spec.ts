...
describe("Temporal", () => {
  ...
  it("should check if two dates signify the same instant.", () => {
    const a = date("2021-07-01T00:00:00.000+02:00")
    const b = date("2021-06-30T23:00:00.000+01:00")
    const c = date("2021-07-01")
    a.sameInstant(b).should.be.true()
    a.sameInstant(c).should.be.true()
    b.sameInstant(a).should.be.true()
    b.sameInstant(c).should.be.true()
    c.sameInstant(a).should.be.true()
    c.sameInstant(b).should.be.true()
  })
})
